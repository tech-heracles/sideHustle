...
{
    public partial class Rap_KartelaPermbledheseArtikullit_SipasNdermarrjeve : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KartelaPermbledheseArtikullit_SipasNdermarrjeve(){InitializeComponent();}
        
        private int counter = 0;
        CultureInfo ci;
        public Rap_KartelaPermbledheseArtikullit_SipasNdermarrjeve(ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_KartelaPermbledheseArtikullit_SipasNdermarrjeve(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel17.Text = rm.GetString("labelKartelaPermbledheseArttNdermarrjeTitull", ci);
            FiltratLabel.Text = rm.GetString("FiltratEmertimi", ci);
            xrLabel37.Text = rm.GetString("labelRaportiNr", ci);
            xrLabel27.Text = rm.GetString("labelDateFillimiAmortizimi", ci);
            xrLabel23.Text = rm.GetString("koloneLoginNdermarrjeNdermarrja", ci);
        ...
        private void Rap_KartelaPermbledheseArtikullit_SipasNdermarrjeve_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
