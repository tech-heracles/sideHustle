...
{
    public partial class Rap_PermbledhesePerAsetet_Raportuese : DevExpress.XtraReports.UI.XtraReport, IUpdateDetail
    {
		public Rap_PermbledhesePerAsetet_Raportuese(){InitializeComponent();}
        ...
        public Rap_PermbledhesePerAsetet_Raportuese(ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_PermbledhesePerAsetet_Raportuese(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        {
            xrLabel17.Text = rm.GetString("lblRaportPermbledhesAseteRaportues", ci);
        ...
        private void xrTableCell1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                string kodPrind = GetCurrentColumnValue("kodPrind").ToString();
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + kodPrind + ";Detail;permbledhesAseteNivelRaportues')";
                if (!SkippedDetailBands.ContainsKey(kodPrind))
                    if (hapurgjitha)
                        label.Text = "-";
                    else label.Text = "+";
        ...
        private void Rap_PermbledhesePerAsetet_Raportuese_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
