...
{
    public partial class Rap_AseteJashtePerdorimit : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_AseteJashtePerdorimit(){InitializeComponent();} 
        CultureInfo ci;
        
        public Rap_AseteJashtePerdorimit(ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_AseteJashtePerdorimit(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        {
            ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
            xrLabel17.Text = rm.GetString("lblRaportTitullAseteTeDaleJashtePerdorimit", ci);
        ...
        {
            ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
            xrLabel20.Text = rm.GetString("labelRaportTotaliPer", ci) + " " + GetCurrentColumnValue("Grupi1") + ":";
        }
        ...
        private void Rap_AseteJashtePerdorimit_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
