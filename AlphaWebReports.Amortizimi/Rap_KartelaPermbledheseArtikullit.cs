...
{
    public partial class Rap_KartelaPermbledheseArtikullit : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KartelaPermbledheseArtikullit(){InitializeComponent();}
        
        private int counter = 0;
        CultureInfo ci;

        public Rap_KartelaPermbledheseArtikullit(ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_KartelaPermbledheseArtikullit(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        private void Rap_KartelaPermbledheseArtikullit_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
