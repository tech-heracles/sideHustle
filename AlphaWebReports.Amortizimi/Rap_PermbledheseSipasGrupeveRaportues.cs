...
{
    public partial class Rap_PermbledheseSipasGrupeveRaportues : DevExpress.XtraReports.UI.XtraReport, IUpdateDetail
    {
		public Rap_PermbledheseSipasGrupeveRaportues(){InitializeComponent();}
        ...
        public Rap_PermbledheseSipasGrupeveRaportues(ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }

        public Rap_PermbledheseSipasGrupeveRaportues(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        {
            xrLabel17.Text = rm.GetString("labelRaportTitullPermbledheseSipasGrupeveRaportues", ci);
        ...
        private void xrLabel6_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (GetCurrentColumnValue("kodPrind") != System.DBNull.Value && GetCurrentColumnValue("kodPrind") != null)
            {
                ...
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + kodPrind + ";Detail;permbledheseGrupetNivelRaportues')";
        ...
        private void Rap_PermbledheseSipasGrupeveRaportues_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
