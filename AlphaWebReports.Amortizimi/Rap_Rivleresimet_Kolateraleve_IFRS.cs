...
{
    public partial class Rap_Rivleresimet_Kolateraleve_IFRS : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Rivleresimet_Kolateraleve_IFRS(){InitializeComponent();} 

       CultureInfo ci;
        public Rap_Rivleresimet_Kolateraleve_IFRS(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) : this(param.Ci, param.IdNdermarrje, param.IdViti, report) { }
        public Rap_Rivleresimet_Kolateraleve_IFRS(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel17.Text = rm.GetString("labelRivleresimetKolateraleveIFRS", ci);
