...
{
    public partial class Rap_PasqyraSigurimeveTatimeveStandart : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_PasqyraSigurimeveTatimeveStandart(){InitializeComponent();} 
        private CultureInfo ci;
        int shifraPasPresjes = 0;
        private ResourceManager rm = new ResourceManager("Resources.Strings",
                          System.Reflection.Assembly.Load("App_GlobalResources"));
        public Rap_PasqyraSigurimeveTatimeveStandart(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_PasqyraSigurimeveTatimeveStandart(CultureInfo ci, int idNdermarrje, int idViti, XtraReport report)
        {
            this.ci = ci;
        ...
        private void Rap_PasqyraSigurimeveTatimeveStandart_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
