...
{
    public partial class Rap_KartelaPunonjesve_A5 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KartelaPunonjesve_A5(){InitializeComponent();} 
      
     
        public Rap_KartelaPunonjesve_A5(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaPunonjesve_A5(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
