...
{
    public partial class Rap_PasqyraSigSuplementare_SePDeFn_131330920275641538 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_PasqyraSigSuplementare_SePDeFn_131330920275641538() { InitializeComponent(); }
        int shifraPasPresjes = 0;
      
        public Rap_PasqyraSigSuplementare_SePDeFn_131330920275641538(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_PasqyraSigSuplementare_SePDeFn_131330920275641538(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, XtraReport report)
        {
