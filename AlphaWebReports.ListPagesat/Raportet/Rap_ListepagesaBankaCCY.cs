...
{
    public partial class Rap_ListepagesaBankaCCY : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ListepagesaBankaCCY(){InitializeComponent();}
        
        int shifraPasPresjes = 0;
        public Rap_ListepagesaBankaCCY(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ListepagesaBankaCCY(CultureInfo ci, int idNdermarrje, int idViti, XtraReport report)
        {
            InitializeComponent();
            EmrateLabelave(ci);           
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel14.Text = rm.GetString("lblCCY", ci);
        ...
        private void Rap_ListepagesaBankaCCY_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
