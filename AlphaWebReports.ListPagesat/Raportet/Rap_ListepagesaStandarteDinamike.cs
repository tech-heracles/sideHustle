...
{
    public partial class Rap_ListepagesaStandarteDinamike : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ListepagesaStandarteDinamike(){InitializeComponent();}

        
        public Rap_ListepagesaStandarteDinamike(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ListepagesaStandarteDinamike(CultureInfo ci,int idNdermarrje, int idViti, XtraReport raport)
        {
            ...
            fieldNrPunonjesi.SortMode = PivotSortMode.Custom;
            ...
            xrPivotGrid2.Fields.AddRange(new DevExpress.XtraReports.UI.PivotGrid.XRPivotGridField[] {fieldNrPunonjesi, fieldEmerPunonjesi, fieldMbiemerPunonjesi,
                fieldTipiKomponentes, fieldKomponente, fieldVleraKompon, fieldIDKokaListepagese, fieldNrTipiKomponentes, fieldPagaNeto});
        }
        ...
        private void xrLabel9_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (GetCurrentColumnValue("MUAJI") != null)
            {
                ...
                xrLabel9.Text = ktheMuajin(muaji);
            }
        ...
        private void Rap_ListepagesaStandarteDinamike_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
