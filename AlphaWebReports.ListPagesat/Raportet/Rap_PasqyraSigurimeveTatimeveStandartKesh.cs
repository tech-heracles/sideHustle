...
{
    public partial class Rap_PasqyraSigurimeveTatimeveStandartKesh : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_PasqyraSigurimeveTatimeveStandartKesh(){InitializeComponent();} 
        private CultureInfo ci;
        int shifraPasPresjes = 0;
        private ResourceManager rm = new ResourceManager("Resources.Strings",
                          System.Reflection.Assembly.Load("App_GlobalResources"));
        public Rap_PasqyraSigurimeveTatimeveStandartKesh(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_PasqyraSigurimeveTatimeveStandartKesh(CultureInfo ci, int idNdermarrje, int idViti, XtraReport report)
        {
            this.ci = ci;
        ...
        private void Rap_PasqyraSigurimeveTatimeveStandartKesh_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
