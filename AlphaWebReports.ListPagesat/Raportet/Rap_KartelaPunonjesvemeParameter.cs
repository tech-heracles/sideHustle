...
{
    public partial class Rap_KartelaPunonjesvemeParameter : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KartelaPunonjesvemeParameter(){InitializeComponent();} 
        
        public Rap_KartelaPunonjesvemeParameter(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, param.ScopeID, report)
        {

        }
        public Rap_KartelaPunonjesvemeParameter(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, string scopeID, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel44.Text = rm.GetString("labelRaportParametri", ci);
            xrLabel48.Text = rm.GetString("labelRaportParametri", ci);
        ...
        private void Rap_KartelaPunonjesvemeParameter_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
