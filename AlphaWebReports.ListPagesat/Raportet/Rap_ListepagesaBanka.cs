...
{
    public partial class Rap_ListepagesaBanka : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ListepagesaBanka(){InitializeComponent();} 
        int shifraPasPresjes = 0;

        public Rap_ListepagesaBanka(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ListepagesaBanka(CultureInfo ci, int idNdermarrje, int idViti, XtraReport report)
        {
            InitializeComponent();
            EmrateLabelave(ci);
