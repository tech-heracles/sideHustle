...
{
    public partial class Rap_ListepagesaBanka_Cobalt : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_ListepagesaBanka_Cobalt() { InitializeComponent(); }
        int shifraPasPresjes = 0;
        public Rap_ListepagesaBanka_Cobalt(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ListepagesaBanka_Cobalt(CultureInfo ci, int idNdermarrje, int idViti, XtraReport report)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel14.Text = rm.GetString("labelEmriMbiemri", ci);
            ...
            xrLabel9.Text = rm.GetString("labelSumPagaNeto",ci);
