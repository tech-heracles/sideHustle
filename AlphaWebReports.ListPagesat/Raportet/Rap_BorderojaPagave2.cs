...
{
    public partial class Rap_BorderojaPagave2 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_BorderojaPagave2(){InitializeComponent();} 

        int shifraPasPresjes = 0;

        public Rap_BorderojaPagave2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_BorderojaPagave2(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel2.Text = rm.GetString("cmbCmimeArtikulliVlere", ci);
            xrLabel3.Text = rm.GetString("cmbItemBlerjeShitjeperqindje", ci);
            ...
            xrLabel4.Text = rm.GetString("lblShtesaTeTjera", ci);
        ...
        private void caktoFormatinENumrave()
        {
            ...
            xrTableCell7.XlsxFormatString = 0.ToString("N" + shifraPasPresjes);
