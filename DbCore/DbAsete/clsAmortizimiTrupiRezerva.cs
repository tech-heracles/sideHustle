...
{
    public class clsAmortizimiTrupiRezerva : clsAmortizimiTrupiAbstract
    {
        ...
        /// </summary>
        public clsAmortizimiTrupiRezerva() : base()
        {
        }

        public clsAmortizimiTrupiRezerva(DataRow dbDataRowAmortizimTrupi) : base(dbDataRowAmortizimTrupi)
        {
        ...
        public clsAmortizimiTrupiRezerva(int idNdermarrje, int idPerdorues, bool kontrolloserial, Dictionary<string, object> rreshtDokuKlient, string lloj, List<double> amortizimfillestar) : base(idNdermarrje, idPerdorues, kontrolloserial, rreshtDokuKlient, lloj, amortizimfillestar)
        {
            if(Artikull!=null &&!Artikull.MeRezerveRivleresimi)
                IdArtikulli = -1;
        ...
        public clsAmortizimiTrupiRezerva(int nrRreshti, int idArtikulli, string emertim, int llojAmortizimi, DateTime dataMePareAmortizimi, DateTime dataAmortizimi, DateTime dateNdryshimiMagazine, int idNjesiAdministrative, int idAQTSerial, string serial, DbInventari.clsArtikulli elem, double vleftaShteseRivleresim) : 
        ...
        internal override bool mbushAmortizimTrupiObjekt(DataRow dbDataRowAmortizimTrupi)
        {
            ...
            try
            {
                ...
                int.TryParse(dbDataRowAmortizimTrupi["ID_AMORTIZIMI_REZERVA_TRUPI"].ToString(), out idAmortizimiTrupi);
        ...
        public static double ktheGjendjeRezervaMagazine(int idartikull, int idNdermarrja, int idmagazine, DateTime data)
        {
            using (clsDatabazeAsete moduliAsete = new clsDatabazeAsete())
            {
                double pergjigje = moduliAsete.ktheGjendjeRezervaMagazine(idartikull, idNdermarrja, idmagazine, data);

                return pergjigje;
            }
        }
        public static double ktheSerialetMagazineRezervaSipasIDSerialDheDates(int idSerial, int idNdermarrja, DateTime data)
        {
            using (clsDatabazeAsete moduliAsete = new clsDatabazeAsete())
            {
                double pergjigje = moduliAsete.ktheSerialetMagazineRezervaSipasIDSerialDheDates(idSerial, idNdermarrja, data);
