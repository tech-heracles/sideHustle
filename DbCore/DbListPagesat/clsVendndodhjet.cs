...
namespace DbCore.DbListPagesat
{
    public class clsVendndodhjet
    {
        ...
        /// </summary>
        private const string STR_EkzistonNjeBurimMeKeteKodJuLutemShenoniNjeKodTje = "Ekziston nje vendndodhje me kete kod. Ju lutem shenoni nje kod tjeter!";
        ...
        /// </summary>
        public static string mbushjeSukses = "Vendndodhja u mbush me sukses";
        /// <summary>
        ...
        public clsVendndodhjet(int id, string kodi, string pershkrimi, int idkrijuesi, bool aktiv, int idPerdoruesi, int idNdermarje, int idKonfig, int idStatusDok)
        {
            this.id = id;
            this.kodi = kodi;
        ...
        public clsVendndodhjet(int id, string kodi, string pershkrimi, int idkrijuesi, bool aktiv, int idPerdoruesi, int idNdermarje, int idKonfig, int idStatusDok, bool shtim)
        {
            try
            {
                this.id = id;
                ...
                clsMesazh mesazh = kontrolloVendndodhjet(shtim);
                if (!mesazh.Status)
        ...
        public clsVendndodhjet(string kodi, int idNderm)
        {
            clsDatabazeListPagesa db = new clsDatabazeListPagesa();
            if (!mbushVendndodhjet(db.ktheVendndodhjetSipasKodit(kodi, idNderm)).Status)
                id = -1;
            db.Dispose();
        }
        public clsVendndodhjet(string kodi, int idNderm, clsDatabazeListPagesa db)
        {
            if (!mbushVendndodhjet(db.ktheVendndodhjetSipasKodit(kodi, idNderm)).Status)
                id = -1;
        ...
        /// </summary>
        /// <param name="id">id e burimit</param>
        public clsVendndodhjet(int id)
        {
            clsDatabazeListPagesa db = new clsDatabazeListPagesa();
            mbushVendndodhjet(db.ktheVendndodhjet(id));
            db.Dispose();
        }
        public clsVendndodhjet(int id, clsDatabazeListPagesa db)
        {
            mbushVendndodhjet(db.ktheVendndodhjet(id));

        }

        public clsVendndodhjet(DataRow rreshti)
        {
            
            mbushVendndodhjet(rreshti);
        }
        #endregion
        ...
        private clsMesazh kontrolloVendndodhjet(bool shtim)
        {
            if (kodi == "")
            ...
            if (shtim && ekzistonVendndodhjet(kodi, idNdermarje))
        ...
        private clsMesazh kontrolloArtikull(out bool kaNdryshimNrAuto, clsDatabazeListPagesa db, IDictionary<string, object> hfNrAutoKF, bool modifikim)
        {
            ...
            if (!modifikim)
            {
                ...
                if (db.ekzistonVendndodhjet(kodi, idNdermarje))
                    return new clsMesazh(false, STR_EkzistonNjeBurimMeKeteKodJuLutemShenoniNjeKodTje);
        ...
        public clsMesazh ruaj(clsDatabazeListPagesa db)
        {
            ...
            int id = 0;
            mesazh = db.ruajVendndodhjet(out id, kodi, pershkrimi, idKrijuesi, aktiv, idKonfig, idPerdoruesi, idNdermarje, idStatusDok);
            this.id = id;
            return mesazh;
        }
        ...
        public clsMesazh modifiko()
        {
            clsMesazh mesazh = new clsMesazh();
            clsDatabazeListPagesa db = new clsDatabazeListPagesa();
            mesazh = db.modifikoVendndodhjet(id, kodi, pershkrimi, aktiv, idKonfig, idPerdoruesi, idNdermarje, idStatusDok);
            db.Dispose();
            return mesazh;
        }
        ...
        public clsMesazh fshi(clsDatabazeListPagesa db)
        {
            //if (db == null)
            //    db = new clsDatabazeListPagesa();
            clsMesazh u_fshi = db.fshiVendndodhjetStatus(id, idPerdoruesi);
            return u_fshi;
        }
        ...
        public bool merrVendndodhjetSipasKodit(string kodi, int idndermarje)
        {
            using (clsDatabazeListPagesa db = new clsDatabazeListPagesa())
            {
                bool sukses = mbushVendndodhjet(db.ktheVendndodhjetSipasKodit(kodi, idndermarje)).Status;
                return sukses;
            }
        }
        public bool ktheVendndodhjetSipasPershkrimi(string pershkrim, int idndermarje)
        {
            using (clsDatabazeListPagesa db = new clsDatabazeListPagesa())
            {
                bool sukses = mbushVendndodhjet(db.ktheVendndodhjetSipasPershkrimi(pershkrim, idndermarje)).Status;
                return sukses;
            }
        }
        ...
        {
            clsDatabazeListPagesa db = new clsDatabazeListPagesa();
            DataTable dt = db.ktheGjitheVendndodhjetSipasNdermarjes(IdNdermarje);
            db.Dispose();
            return dt;
        }
        ...
        public static bool ekzistonVendndodhjet(string kodi, int idndermarje)
        {
            clsDatabazeListPagesa db = new clsDatabazeListPagesa();
            bool ekziston = db.ekzistonVendndodhjet(kodi, idndermarje);
            db.Dispose();
            return ekziston;
        }
        public static bool kaVeprimeVendndodhjet(int id)
        {
            clsDatabazeListPagesa db = new clsDatabazeListPagesa();
            return db.kaVeprimeVendndodhjet(id);
        }
        #endregion
        ...
        internal clsMesazh mbushVendndodhjet(DataRow dbDataRow)
        {
            if (dbDataRow != null)
            {
                try
                {
                    ...
                    return new clsMesazh(true, clsVendndodhjet.mbushjeSukses);
                }
                catch (InvalidCastException)
                {
                    throw new Exception(clsVendndodhjet.gabimNeTeDhena);
                }
            }
            else
                return new clsMesazh(false, clsVendndodhjet.drbosh);
        }
