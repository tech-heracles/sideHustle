...
namespace DbCore.DbTollona
{
    ...
    ///  (Te dhenat  merren nga tabela : t_tollonaleter tek dbtollonat)
    /// </summary>
    public class clsTollonaLeter
    {
        ...
        /// fillim seriali
        /// </summary>
        private string fillimSeriali;
        /// <summary>
        /// mbarim seriali
        /// </summary>
        private string mbarimSeriali;
        /// <summary>
        /// id e artikullit
        /// </summary>
        ...
        /// 
        public clsTollonaLeter(int id, string fillimseriali,string mbarimSeriali,string kodKlienti,string pershkrimKlienti, int idartikulli, int idtrupishitje, double totallitra, bool status)
        {
            this.id = id;
            this.fillimSeriali = fillimseriali;
            this.mbarimSeriali = mbarimSeriali;
        ...
        public clsTollonaLeter(DataRow rreshti)
        {
        ...
        /// mbarim seriali
        /// </summary>
        public string MbarimSeriali
        {
            get
            {
                return mbarimSeriali;
            }
            set
            {
                mbarimSeriali = value;
        ...
        /// seriali
        /// </summary>
        public string FillimSeriali
        {
            get
            {
                return fillimSeriali;
            }
            set
            {
                fillimSeriali = value;
      ...
      /// </summary>
        ...
        public clsMesazh ruaj(clsDatabazeTollona db)
        {
            clsMesazh mesazh = new clsMesazh();
                     int id = 0;
                     mesazh = db.ruajTollonaLeter(out id, fillimSeriali, totaliLitra, mbarimSeriali, idTrupiShitje, kodKlienti,pershkrimKlienti, idArtikulli, status);
            this.id = id;
            return mesazh;
        }
        ...
        public static bool kaTollonaShitja(int idshitjekoka)
        {
            using (clsDatabazeTollona db = new clsDatabazeTollona())
            {
               return db.kaTollonaShitjaKastrati(idshitjekoka);
            }
        }
        public static bool ekzistonSeriali(string fillseriali, string mbarimseriali)
        {
            using (clsDatabazeTollona db = new clsDatabazeTollona())
            {
                return db.ekzistonSerialiKastrati(fillseriali, mbarimseriali);
            }
        }
        #endregion
        ...
        internal clsMesazh mbushShitje(DataRow dbDataRow)
        {
            if (dbDataRow != null)
            {
                try
                {
                    ...
                    fillimSeriali = dbDataRow["FILLIMSERIALI"].ToString();
                    mbarimSeriali = dbDataRow["MbarimSERIALI"].ToString();
                    ...
                    return new clsMesazh(true, clsTollonaLeter.mbushjeSukses);
                }
                catch (InvalidCastException)
                {
                    throw new Exception(clsTollonaLeter.gabimNeTeDhena);
                }
            }
            else
                return new clsMesazh(false, clsTollonaLeter.drbosh);
        }
