...
{
    public partial class Rap_ShitjeSipasGrupimeArtikujve : DevExpress.XtraReports.UI.XtraReport
    {

        ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));

        public Rap_ShitjeSipasGrupimeArtikujve()
        {
             InitializeComponent();
        }
        
        public Rap_ShitjeSipasGrupimeArtikujve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) : this(param.Ci, report)
        { }

        public Rap_ShitjeSipasGrupimeArtikujve(CultureInfo ci, DevExpress.XtraReports.UI.XtraReport report)
        {
            InitializeComponent();
            EmrateLabelave(ci);
            ...
            fieldAgjenti.Options.ShowGrandTotal = true;

            //Klienti
            XRPivotGridField fieldKlienti = new XRPivotGridField("Klienti", PivotArea.RowArea);
            fieldKlienti.FieldName = "KLIENTI";
            fieldKlienti.Appearance.FieldValue.TextHorizontalAlignment = DevExpress.Utils.HorzAlignment.Default;
            fieldKlienti.Caption = rm.GetString("RptShitjeSipasGrupArtikulliKlienetet", ci);
            ...
            fieldShitjetipi.Options.ShowGrandTotal = false;
            ...
            xrPivotGrid1.Fields.AddRange(new DevExpress.XtraReports.UI.PivotGrid.XRPivotGridField[] { fieldAgjenti, fieldKlienti, fieldgrupimshitje, fieldGrup, fieldShitje, fieldShitjetipi, fieldShitjev1, fieldShitjev2 });
        ...
        {
            xrLabel1.Text = rm.GetString("RptShitjeSipasGrupArtikulliTitulli", ci);
        }
