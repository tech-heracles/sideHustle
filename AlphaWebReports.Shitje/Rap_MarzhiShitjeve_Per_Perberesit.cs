...
{
    public partial class Rap_MarzhiShitjeve_Per_Perberesit : DevExpress.XtraReports.UI.XtraReport
        {
		public Rap_MarzhiShitjeve_Per_Perberesit(){InitializeComponent();} 
       
        double vleraMeZbritjeTot = 0.00;
        double sasiaTot = 0.00;

        public Rap_MarzhiShitjeve_Per_Perberesit(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):this(param.Ci, param.IdNdermarrje, param.IdViti, report){}

        public Rap_MarzhiShitjeve_Per_Perberesit(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            MarzhiShitjeveLabel.Text = rm.GetString("lblRaportTitulliMarzhiShitjevePerPerb", ci)  ;
