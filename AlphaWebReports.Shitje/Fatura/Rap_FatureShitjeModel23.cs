...
{
    public partial class Rap_FatureShitjeModel23 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeModel23(){InitializeComponent();} 
public Rap_FatureShitjeModel23(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):this(param.Ci,param.IdNdermarrje,param.IdPerdoruesi){}
        public Rap_FatureShitjeModel23(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel1.Text = rm.GetString("labelTitulliOferteShitje", ci);
            ...
            xrTableCell10.Text = rm.GetString("labelRaportCmimiMeTVSH", ci);
            xrTableCell8.Text = rm.GetString("labelFoto", ci);
            ...
            xrLabel17.Text = rm.GetString("labelBrand", ci);
        }
    }      
}
