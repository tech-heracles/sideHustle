...
{
    public partial class Rap_FormatShitjeAlpetrolA5 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatShitjeAlpetrolA5(){InitializeComponent();} 
        public Rap_FormatShitjeAlpetrolA5(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitjeAlpetrolA5(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel64.Text = rm.GetString("labelRaportiTABELAT", ci) + ":";
