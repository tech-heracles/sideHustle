...
{
    public partial class Rap_FatureShitjeSunPetroliumKOPJE : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeSunPetroliumKOPJE(){InitializeComponent();} 
        public Rap_FatureShitjeSunPetroliumKOPJE(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeSunPetroliumKOPJE(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
