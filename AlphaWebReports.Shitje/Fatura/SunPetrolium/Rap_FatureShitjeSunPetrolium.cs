...
{
    public partial class Rap_FatureShitjeSunPetrolium : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeSunPetrolium(){InitializeComponent();} 

        public Rap_FatureShitjeSunPetrolium(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeSunPetrolium(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
