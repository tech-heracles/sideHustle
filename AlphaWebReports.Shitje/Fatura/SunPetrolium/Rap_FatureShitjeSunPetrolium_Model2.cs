...
{
    public partial class Rap_FatureShitjeSunPetrolium_Model2 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FatureShitjeSunPetrolium_Model2() { InitializeComponent(); }

        public Rap_FatureShitjeSunPetrolium_Model2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeSunPetrolium_Model2(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel73.Text = rm.GetString("footerRaportPerdorimiFaturesLejuarNgaDPTatimeveDy", ci);
        }
