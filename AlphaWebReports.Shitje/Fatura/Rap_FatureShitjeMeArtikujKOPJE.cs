...
{
    public partial class Rap_FatureShitjeMeArtikujKOPJE : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikujKOPJE(){InitializeComponent();} 
        public Rap_FatureShitjeMeArtikujKOPJE(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikujKOPJE(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
