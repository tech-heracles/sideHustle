...
{
    public partial class Rap_FormatShitjeArton2011 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatShitjeArton2011(){InitializeComponent();} 
        private ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
        public Rap_FormatShitjeArton2011(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitjeArton2011(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel24.Text = rm.GetString("TitullRaportiFatureTatimoreShitje", ci);
            ...
            xrLabel49.Text = rm.GetString("footerRaportPerdorimiFaturesLejuarNgaDPTatimeveArton",ci);
        }
