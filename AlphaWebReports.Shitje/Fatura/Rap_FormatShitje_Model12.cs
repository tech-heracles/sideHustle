...
{
    public partial class Rap_FormatShitje_Model12 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatShitje_Model12(){InitializeComponent();} 
 

        public Rap_FormatShitje_Model12(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_Model12(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
