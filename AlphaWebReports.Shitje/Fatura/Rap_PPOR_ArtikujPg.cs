...
{
    public partial class Rap_PPOR_ArtikujPg : DevExpress.XtraReports.UI.XtraReport
    {
       
        public Rap_PPOR_ArtikujPg()
        {
            InitializeComponent();
        }
        public Rap_PPOR_ArtikujPg(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_PPOR_ArtikujPg(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }  
