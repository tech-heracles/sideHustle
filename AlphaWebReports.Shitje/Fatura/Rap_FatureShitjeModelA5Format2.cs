...
{
    public partial class Rap_FatureShitjeModelA5Format2 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeModelA5Format2(){InitializeComponent();} 

  
        public Rap_FatureShitjeModelA5Format2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeModelA5Format2(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
