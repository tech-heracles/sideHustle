...
{
    public partial class Rap_FormatShitjeModel14 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatShitjeModel14(){InitializeComponent();} 
        private ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
        public Rap_FormatShitjeModel14(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitjeModel14(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
