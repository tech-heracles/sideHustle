...
{
    public partial class Rap_FormatShitje_Medfau : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatShitje_Medfau(){InitializeComponent();} 
 
        public Rap_FormatShitje_Medfau(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_Medfau(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell17.Text = rm.GetString("lblRaportiDTATESKADENCE", ci);
        }
