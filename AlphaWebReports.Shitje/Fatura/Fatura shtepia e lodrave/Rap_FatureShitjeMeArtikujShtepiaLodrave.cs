...
{
    public partial class Rap_FatureShitjeMeArtikujShtepiaLodrave : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikujShtepiaLodrave(){InitializeComponent();} 
        public Rap_FatureShitjeMeArtikujShtepiaLodrave(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikujShtepiaLodrave(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
