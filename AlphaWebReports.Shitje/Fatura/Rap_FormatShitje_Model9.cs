...
{
    public partial class Rap_FormatShitje_Model9 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatShitje_Model9(){InitializeComponent();}
        public Rap_FormatShitje_Model9(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_Model9(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel68.Text = rm.GetString("labelDetyrimParaUpperCase", ci);
