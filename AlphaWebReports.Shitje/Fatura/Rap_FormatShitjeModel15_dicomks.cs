...
namespace AlphaWebReports.RaportetDs.RAP_SHITJE.Fatura
{
    ...
    public partial class Rap_FormatShitjeModel15_dicomks : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FormatShitjeModel15_dicomks() { InitializeComponent(); }
        private ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
        public Rap_FormatShitjeModel15_dicomks(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitjeModel15_dicomks(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
