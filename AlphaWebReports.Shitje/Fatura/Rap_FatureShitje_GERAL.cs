...
{
    public partial class Rap_FatureShitje_GERAL : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitje_GERAL(){InitializeComponent();} 
        ...
        public Rap_FatureShitje_GERAL(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitje_GERAL(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
