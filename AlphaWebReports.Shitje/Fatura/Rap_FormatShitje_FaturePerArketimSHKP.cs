...
{
    public partial class Rap_FormatShitje_FaturePerArketimSHKP : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FormatShitje_FaturePerArketimSHKP() { InitializeComponent(); }
  
        public Rap_FormatShitje_FaturePerArketimSHKP(AlphaWebReports.Common.ParametraRaporti param, XtraReport raport):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
                {

                }
        public Rap_FormatShitje_FaturePerArketimSHKP(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel24.Text = rm.GetString("labelRaportKontakti", ci);
