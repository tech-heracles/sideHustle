...
{
    public partial class Rap_FatureShitjeMeduza : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeduza(){InitializeComponent();}

        public Rap_FatureShitjeMeduza(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeduza(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
