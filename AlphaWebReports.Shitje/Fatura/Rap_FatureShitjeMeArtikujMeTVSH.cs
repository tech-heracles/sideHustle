...
{
    public partial class Rap_FatureShitjeMeArtikujMeTVSH : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikujMeTVSH(){InitializeComponent();} 
        
        double totalipatvsh = 0;
        double totalimetvsh = 0;
        double totalipatvshkursi = 0;
        double totalimetvshkursi = 0;
        public Rap_FatureShitjeMeArtikujMeTVSH(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikujMeTVSH(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
