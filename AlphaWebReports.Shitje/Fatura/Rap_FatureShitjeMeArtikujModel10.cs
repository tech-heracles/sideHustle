...
{
    public partial class Rap_FatureShitjeMeArtikujModel10 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikujModel10(){InitializeComponent();} 

        public Rap_FatureShitjeMeArtikujModel10(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikujModel10(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
      }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel44.Text = rm.GetString("labelRaportNrSerial", ci);
