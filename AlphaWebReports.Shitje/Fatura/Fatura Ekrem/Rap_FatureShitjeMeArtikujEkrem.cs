...
{
    public partial class Rap_FatureShitjeMeArtikujEkrem : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikujEkrem(){InitializeComponent();} 
          
        public Rap_FatureShitjeMeArtikujEkrem(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikujEkrem(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
