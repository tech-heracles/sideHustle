...
{
    public partial class Rap_FatureShitje_Electron : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitje_Electron(){InitializeComponent();} 
        public Rap_FatureShitje_Electron(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitje_Electron(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
