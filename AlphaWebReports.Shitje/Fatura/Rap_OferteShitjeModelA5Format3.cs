...
{
    public partial class Rap_OferteShitjeModelA5Format3 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_OferteShitjeModelA5Format3(){InitializeComponent();} 

       
public Rap_OferteShitjeModelA5Format3(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):this(param.Ci, param.IdNdermarrje,param.IdPerdoruesi){}
        public Rap_OferteShitjeModelA5Format3(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel1.Text = rm.GetString("labelTitulliOferteShitje", ci).ToUpper();
            ...
            xrLabel8.Text = rm.GetString("lblRaportTotaliFatures", ci);
          }
