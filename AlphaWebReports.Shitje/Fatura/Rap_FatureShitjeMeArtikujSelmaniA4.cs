...
{
    public partial class Rap_FatureShitjeMeArtikujSelmaniA4 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikujSelmaniA4(){InitializeComponent();} 
   

        public Rap_FatureShitjeMeArtikujSelmaniA4(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikujSelmaniA4(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
            switch (ci.ToString())
