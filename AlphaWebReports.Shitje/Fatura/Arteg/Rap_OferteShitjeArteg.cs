...
{
    public partial class Rap_OferteShitjeArteg : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_OferteShitjeArteg(){InitializeComponent();} 

       
        public Rap_OferteShitjeArteg(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_OferteShitjeArteg(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
