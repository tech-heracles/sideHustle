...
{
    public partial class Rap_FatureShitjeMeArtikujModel11 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikujModel11(){InitializeComponent();} 
 
        public Rap_FatureShitjeMeArtikujModel11(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikujModel11(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
        }
