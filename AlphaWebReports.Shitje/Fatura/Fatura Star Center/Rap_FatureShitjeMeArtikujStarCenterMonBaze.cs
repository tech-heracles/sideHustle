...
{
    public partial class Rap_FatureShitjeMeArtikujStarCenterMonBaze : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikujStarCenterMonBaze(){InitializeComponent();} 

     
        public Rap_FatureShitjeMeArtikujStarCenterMonBaze(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikujStarCenterMonBaze(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel48.Text = xrLabel7.Text = rm.GetString("labelRaportNrSerial", ci);
            xrLabel35.Text = rm.GetString("labelEmriShitesit", ci) + ":";
            xrLabel13.Text = rm.GetString("labelRaportAdresa", ci) + ":";
            xrLabel14.Text = xrLabel54.Text = rm.GetString("labelRaportTel", ci) + ":";
            xrLabel48.Text = xrLabel57.Text = rm.GetString("labelRaportEmail", ci) + ":";
            ...
            xrLabel37.Text = rm.GetString("lblRaportTotaliNe", ci);
            xrLabel39.Text = rm.GetString("labelKursi", ci);
            ...
            xrLabel4.Text = xrLabel8.Text = xrLabel5.Text = rm.GetString("labelEmerMbiemerFirma", ci);
