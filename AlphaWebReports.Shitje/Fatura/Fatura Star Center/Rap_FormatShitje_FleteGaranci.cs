...
{
    public partial class Rap_FormatShitje_FleteGaranci : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatShitje_FleteGaranci(){InitializeComponent();} 

 
        public Rap_FormatShitje_FleteGaranci(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_FleteGaranci(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
