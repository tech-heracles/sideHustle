...
{
    public partial class Rap_FormatPreventiv_1_Sinani : DevExpress.XtraReports.UI.XtraReport
    { 
        public Rap_FormatPreventiv_1_Sinani() { InitializeComponent(); }
        public Rap_FormatPreventiv_1_Sinani(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }

        public Rap_FormatPreventiv_1_Sinani(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
           InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel14.Text = rm.GetString("labelRaportTelShitjet", ci);
