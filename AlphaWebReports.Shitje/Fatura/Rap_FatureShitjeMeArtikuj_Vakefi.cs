...
{
    public partial class Rap_FatureShitjeMeArtikuj_Vakefi : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FatureShitjeMeArtikuj_Vakefi() { InitializeComponent(); }


        public Rap_FatureShitjeMeArtikuj_Vakefi(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikuj_Vakefi(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);        
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel1.Text = rm.GetString("labelTitullProFature", ci);
