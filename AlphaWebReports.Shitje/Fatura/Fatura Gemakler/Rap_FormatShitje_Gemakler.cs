...
{
    public partial class Rap_FormatShitje_Gemakler : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatShitje_Gemakler(){InitializeComponent();} 


        public Rap_FormatShitje_Gemakler(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_Gemakler(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
