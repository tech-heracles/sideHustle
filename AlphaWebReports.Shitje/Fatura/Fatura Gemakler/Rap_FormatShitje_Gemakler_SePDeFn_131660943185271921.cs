...
{
    public partial class Rap_FormatShitje_Gemakler_SePDeFn_131660943185271921 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatShitje_Gemakler_SePDeFn_131660943185271921()
        {
            InitializeComponent();
        } 


        public Rap_FormatShitje_Gemakler_SePDeFn_131660943185271921(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_Gemakler_SePDeFn_131660943185271921(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell3.Text = rm.GetString("labelBarkodi", ci).ToUpper();
            xrTableCell6.Text = rm.GetString("labelZbritjaUpperCase", ci);
