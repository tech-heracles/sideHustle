...
{
    public partial class Rap_FatureShitjeMeArtikujGemakler : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikujGemakler(){InitializeComponent();} 

        public Rap_FatureShitjeMeArtikujGemakler(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikujGemakler(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
