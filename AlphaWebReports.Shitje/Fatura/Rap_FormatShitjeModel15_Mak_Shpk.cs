...
{
    public partial class Rap_FormatShitjeModel15_Mak_Shpk : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FormatShitjeModel15_Mak_Shpk() { InitializeComponent(); }
        private ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
        public Rap_FormatShitjeModel15_Mak_Shpk(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitjeModel15_Mak_Shpk(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = xrLabel13.Text = rm.GetString("labelRaportAdresa", ci) + ":";
            xrLabel15.Text = rm.GetString("labelRaportNrFiskal", ci) + ":";
            xrLabel50.Text = xrLabel16.Text =  rm.GetString("labelQyteti", ci) + ":";
            xrTableCell20.Text = xrLabel14.Text = rm.GetString("labelRaportTel", ci) + ":";
            ...
            tableCell1.Text = rm.GetString("lblRaportKT", ci);
            ...
            xrLabel34.Text = rm.GetString("labelBleresi", ci);
