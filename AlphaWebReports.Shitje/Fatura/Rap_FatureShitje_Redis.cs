...
{
    public partial class Rap_FatureShitje_Redis : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FatureShitje_Redis() { InitializeComponent(); }

        public Rap_FatureShitje_Redis(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitje_Redis(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel56.Text = rm.GetString("labelKursi", ci);
