...
{
    public partial class Rap_FatureShitje_FormatTB_KlimaTeknika_AIR_KOMPONENT : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitje_FormatTB_KlimaTeknika_AIR_KOMPONENT(){InitializeComponent();} 
 
        public Rap_FatureShitje_FormatTB_KlimaTeknika_AIR_KOMPONENT(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitje_FormatTB_KlimaTeknika_AIR_KOMPONENT(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel20.Text = rm.GetString("labelRaportiTotali", ci);
            xrLabel25.Text = rm.GetString("lblRaportTotaliNe", ci);
            xrLabel28.Text = rm.GetString("labelKursi", ci);
