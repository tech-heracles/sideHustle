...
{
    public partial class Rap_FaturShitjeModelA5Format3 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FaturShitjeModelA5Format3(){InitializeComponent();} 
        
     
        public Rap_FaturShitjeModelA5Format3(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FaturShitjeModelA5Format3(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
