...
{
    public partial class Rap_FatureShitjeMeArtikujITBM : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikujITBM(){InitializeComponent();} 
        public Rap_FatureShitjeMeArtikujITBM(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikujITBM(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
