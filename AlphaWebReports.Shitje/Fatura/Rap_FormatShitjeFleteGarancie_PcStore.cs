...
{
    public partial class Rap_FormatShitjeFleteGarancie_PcStore : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FormatShitjeFleteGarancie_PcStore() { InitializeComponent(); }
        public Rap_FormatShitjeFleteGarancie_PcStore(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {
        }
        public Rap_FormatShitjeFleteGarancie_PcStore(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
