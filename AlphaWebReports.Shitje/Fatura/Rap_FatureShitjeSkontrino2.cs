...
{
    public partial class Rap_FatureShitjeSkontrino2 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeSkontrino2(){InitializeComponent();}
        public Rap_FatureShitjeSkontrino2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeSkontrino2(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel26.Text = rm.GetString("labelVleftapaTVSH", ci) + ":";
