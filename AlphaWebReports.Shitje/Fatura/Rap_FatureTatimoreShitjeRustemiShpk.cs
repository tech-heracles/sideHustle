...
{
    public partial class Rap_FatureTatimoreShitjeRustemiShpk : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureTatimoreShitjeRustemiShpk(){InitializeComponent();} 
        public Rap_FatureTatimoreShitjeRustemiShpk(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureTatimoreShitjeRustemiShpk(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel43.Text = rm.GetString("lblTotaliUpperCase", ci);
            xrLabel42.Text = rm.GetString("lblFurnizimeTÎTatueshme", ci);
            xrLabel41.Text = rm.GetString("lblFurnizimeTÎPaTatueshme", ci);
            xrLabel48.Text = rm.GetString("lblNgaTeCilat", ci);
            xrLabel56.Text = rm.GetString("ShenimFatureTatimoreRustemi", ci);
            xrLabel53.Text = rm.GetString("labelBleresiUpperCase", ci);
            xrLabel52.Text = rm.GetString("labelTransportuesiUpperCase", ci);
            xrLabel51.Text = rm.GetString("labelShitesiUpperCase", ci);
            xrLabel55.Text = rm.GetString("lblEmMbNenshk", ci);
            xrLabel54.Text = rm.GetString("lblEmMbNenshk", ci);
            xrLabel50.Text = rm.GetString("lblEmMbNenshkVula", ci);
