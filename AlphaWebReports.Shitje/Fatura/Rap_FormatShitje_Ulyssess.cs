...
{
    public partial class Rap_FormatShitje_Ulyssess : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FormatShitje_Ulyssess() { InitializeComponent(); }
        public Rap_FormatShitje_Ulyssess(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_Ulyssess(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
           ...
           xrLabel26.Text = rm.GetString("lblShitesKrijues", ci);
            ...
            xrLabel29.Text = rm.GetString("lblTitullSituacion", ci);
