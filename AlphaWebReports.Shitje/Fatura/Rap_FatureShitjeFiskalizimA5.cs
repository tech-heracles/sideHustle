...
{
    public partial class Rap_FatureShitjeFiskalizimA5 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeFiskalizimA5(){InitializeComponent();} 
            
        public Rap_FatureShitjeFiskalizimA5(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeFiskalizimA5(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
