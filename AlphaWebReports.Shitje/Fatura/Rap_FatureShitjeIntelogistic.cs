...
{
    public partial class Rap_FatureShitjeIntelogistic : DevExpress.XtraReports.UI.XtraReport
    {
     
        public Rap_FatureShitjeIntelogistic() { InitializeComponent(); }

        public Rap_FatureShitjeIntelogistic(ParametraRaporti param, XtraReport report) :
        this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi){}
        public Rap_FatureShitjeIntelogistic(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
