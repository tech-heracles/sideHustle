...
{
    public partial class Rap_FormatShitje_Usluga : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FormatShitje_Usluga() { InitializeComponent(); }
        public Rap_FormatShitje_Usluga(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_Usluga(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
