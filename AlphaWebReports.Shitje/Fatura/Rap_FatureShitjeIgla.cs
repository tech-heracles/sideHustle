...
{
    public partial class Rap_FatureShitjeIgla : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeIgla(){InitializeComponent();} 
    
        public Rap_FatureShitjeIgla(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeIgla(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel44.Text = rm.GetString("labelRaportNrFiskal", ci);
            xrLabel45.Text = rm.GetString("labelRaportNumerTVSH", ci);
            xrLabel19.Text = rm.GetString("labelRaportLlogBankareIgla", ci);
