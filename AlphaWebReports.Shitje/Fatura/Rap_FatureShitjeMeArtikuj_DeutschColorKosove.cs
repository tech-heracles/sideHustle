...
{
    public partial class Rap_FatureShitjeMeArtikuj_DeutschColorKosove : DevExpress.XtraReports.UI.XtraReport
    { 
		public Rap_FatureShitjeMeArtikuj_DeutschColorKosove(){InitializeComponent();} 

        public Rap_FatureShitjeMeArtikuj_DeutschColorKosove(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikuj_DeutschColorKosove(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
