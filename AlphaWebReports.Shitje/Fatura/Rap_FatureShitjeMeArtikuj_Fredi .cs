...
{
    public partial class Rap_FatureShitjeMeArtikuj_Fredi : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikuj_Fredi(){InitializeComponent();} 
      
        public Rap_FatureShitjeMeArtikuj_Fredi(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikuj_Fredi(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
