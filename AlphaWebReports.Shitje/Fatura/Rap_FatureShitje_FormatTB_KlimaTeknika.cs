...
{
    public partial class Rap_FatureShitje_FormatTB_KlimaTeknika : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitje_FormatTB_KlimaTeknika(){InitializeComponent();} 

        public Rap_FatureShitje_FormatTB_KlimaTeknika(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {
        }
        public Rap_FatureShitje_FormatTB_KlimaTeknika(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel25.Text = rm.GetString("labelRaportiTotali", ci);
            xrLabel79.Text = rm.GetString("lblRaportTotaliNe", ci);
            xrLabel81.Text = rm.GetString("labelKursi", ci);
            ...
            xrLabel39.Text = rm.GetString("lblRaportNrLlogarie", ci);
            xrLabel51.Text = rm.GetString("lblRaportNrLlogarie", ci);
            xrLabel60.Text = rm.GetString("lblRaportNrLlogarie", ci);
          }
    }
}
