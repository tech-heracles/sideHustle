...
{
    public partial class Rap_FatureShitjePaArtikuj : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjePaArtikuj(){InitializeComponent();} 
        public Rap_FatureShitjePaArtikuj(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje)
        {

        }
        public Rap_FatureShitjePaArtikuj(CultureInfo ci, int idNdermarrje)
        {            
            InitializeComponent();
            EmrateLabelave(ci);
        }
