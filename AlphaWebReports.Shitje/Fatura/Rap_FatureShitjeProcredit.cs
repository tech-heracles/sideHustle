...
{
    public partial class Rap_FatureShitjeProcredit : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeProcredit(){InitializeComponent();} 


        public Rap_FatureShitjeProcredit(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeProcredit(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell17.Text = rm.GetString("labelRaportiNr", ci);
            xrLabel73.Text = rm.GetString("footerRaportPerdorimiFaturesLejuarNgaDPTatimeveProcredit", ci);
