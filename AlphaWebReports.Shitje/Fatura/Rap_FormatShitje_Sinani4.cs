...
{
    public partial class Rap_FormatShitje_Sinani4 : DevExpress.XtraReports.UI.XtraReport
    {
         public Rap_FormatShitje_Sinani4() { InitializeComponent(); }
        public Rap_FormatShitje_Sinani4(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_Sinani4(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
