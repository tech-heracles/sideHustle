...
{
    public partial class Rap_FormatShitje_Cobalt_1 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FormatShitje_Cobalt_1() { InitializeComponent(); }
        public Rap_FormatShitje_Cobalt_1(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_Cobalt_1(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel61.Text = rm.GetString("labelRaportTotaluUppercase", ci);
        }
