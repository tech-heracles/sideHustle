...
{
    public partial class Rap_FatureShitjeDekoll : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeDekoll(){InitializeComponent();} 

        public Rap_FatureShitjeDekoll(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeDekoll(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel45.Text = rm.GetString("lblrptPerqindjeZbritje", ci);
            xrLabel56.Text = rm.GetString("labelZbritje", ci);
