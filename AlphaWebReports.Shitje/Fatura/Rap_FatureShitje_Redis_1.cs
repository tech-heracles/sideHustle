...
{
    public partial class Rap_FatureShitje_Redis_1 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FatureShitje_Redis_1() { InitializeComponent(); }
        public Rap_FatureShitje_Redis_1(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitje_Redis_1(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
