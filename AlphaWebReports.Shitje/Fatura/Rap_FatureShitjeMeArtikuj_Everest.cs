...
{
    public partial class Rap_FatureShitjeMeArtikuj_Everest : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikuj_Everest(){InitializeComponent();} 
      
        public Rap_FatureShitjeMeArtikuj_Everest(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikuj_Everest(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        { 
            ...
            xrTableCell17.Text = rm.GetString("labelRaportiPershkrimi", ci) + " 2";
