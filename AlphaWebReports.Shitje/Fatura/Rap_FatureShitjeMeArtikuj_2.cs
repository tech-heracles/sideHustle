...
{
    public partial class Rap_FatureShitjeMeArtikuj_2 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_FatureShitjeMeArtikuj_2() { InitializeComponent(); }
        public Rap_FatureShitjeMeArtikuj_2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikuj_2(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            label1.Text = rm.GetString("labelRaportDetyrimi", ci);
