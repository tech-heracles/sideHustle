...
{
    public partial class Rap_FormatShitje_WAT : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatShitje_WAT(){InitializeComponent();} 

        public Rap_FormatShitje_WAT(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatShitje_WAT(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
