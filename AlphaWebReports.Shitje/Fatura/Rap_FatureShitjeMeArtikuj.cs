...
{
    public partial class Rap_FatureShitjeMeArtikuj : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShitjeMeArtikuj(){InitializeComponent();} 
            
        public Rap_FatureShitjeMeArtikuj(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShitjeMeArtikuj(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
