...
{
    public partial class Rap_Format_Printimi_Model20 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Format_Printimi_Model20(){InitializeComponent();} 

        public Rap_Format_Printimi_Model20(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_Format_Printimi_Model20(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel4.Text = rm.GetString("lblBleresi", ci) + ":";
            xrLabel2.Text = rm.GetString("labelShitesi", ci) + ":";
            ...
            xrLabel15.Text = rm.GetString("labelZbritje", ci) + ":";
            xrLabel56.Text = rm.GetString("lblFurnizimeTatueshme", ci);
            xrLabel57.Text = rm.GetString("lblFurnizimePatueshme", ci);
        }
