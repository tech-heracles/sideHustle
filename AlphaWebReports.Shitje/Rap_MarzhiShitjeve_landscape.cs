...
{
    public partial class Rap_MarzhiShitjeve_landscape : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_MarzhiShitjeve_landscape(){InitializeComponent();}
        int formatNumri = 0;
        public Rap_MarzhiShitjeve_landscape(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_MarzhiShitjeve_landscape(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            KartelaT.Text = rm.GetString("labelKartela", ci);
