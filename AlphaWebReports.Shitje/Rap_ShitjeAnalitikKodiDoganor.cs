...
{
    public partial class Rap_ShitjeAnalitikKodiDoganor : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ShitjeAnalitikKodiDoganor(){InitializeComponent();} 
      
        int shifraPasPresjes = 0;
        public Rap_ShitjeAnalitikKodiDoganor(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitikKodiDoganor(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
