...
{
    public partial class Rap_ArtikujShiturMeParapagim : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ArtikujShiturMeParapagim(){InitializeComponent();} 
       
        
        public Rap_ArtikujShiturMeParapagim(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_ArtikujShiturMeParapagim(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel13.Text = rm.GetString("RaportArtikujShiturParapagimTitulli", ci);
