...
{
    public partial class Rap_MarzhiShitjeve_2 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_MarzhiShitjeve_2(){InitializeComponent();}

        int formatNumri = 0;
   
        public Rap_MarzhiShitjeve_2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_MarzhiShitjeve_2(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        public void caktoFormatinENumrave()
        {
            ...
            xrLabel1.XlsxFormatString = xrLabel2.XlsxFormatString = xrLabel3.XlsxFormatString = xrLabel5.XlsxFormatString = xrLabel6.XlsxFormatString = xrLabel7.XlsxFormatString = xrLabel27.XlsxFormatString
             = KMSHTotali.XlsxFormatString = VleraMeZbritjeTotali.XlsxFormatString = MarzhiMeZbritjeTotali.XlsxFormatString = xrLabel4.XlsxFormatString = MarzhiPerqindjeTotali.XlsxFormatString
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            CmimiShitjesT.Text = rm.GetString("labelCmimShitje", ci);
            VleraMeZbritje.Text = rm.GetString("labelVleraShitjesMeZbritje", ci);
            MarzhiBrutoZbritje.Text = rm.GetString("labelMarzhiBrutoMeZbritje", ci);
            MarzhiBrutoPerqind.Text = rm.GetString("labelMarzhiBrutoPerqindje", ci);
