...
{
    public partial class Rap_ShitjeAnalitik_AlphaBank : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ShitjeAnalitik_AlphaBank(){InitializeComponent();} 
           public Rap_ShitjeAnalitik_AlphaBank(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitik_AlphaBank(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
          ...
          System.Reflection.Assembly.Load("App_GlobalResources"));
            ...
            xrLabel5.Text = rm.GetString("lblRaportDtValute", ci);
