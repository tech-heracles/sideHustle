...
namespace AlphaWebReports.RaportetDs.RAP_SHITJE
{
    ...
    public partial class Rap_PorosiBazaar : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_PorosiBazaar(){InitializeComponent();}

        
        public Rap_PorosiBazaar(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, report)
        {

        }
        public Rap_PorosiBazaar(CultureInfo ci, int idNdermarrje, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
        ...
        private void EmraTeLabelave(CultureInfo ci)
        {
            ...
            xrLabel5.Text = rm.GetString("labelRaportiKodProdukti", ci);
            ...
            xrLabel12.Text = rm.GetString("TitullRaportiPorosiBazaar", ci);
            xrLabel1.Text = rm.GetString("labelRaportiBazaarVeprimi", ci);
           ...
           // xrLabel1.Text = rm.GetString("labelFilterNengrupArtikulli", ci) + ":";
            ...
            xrLabel2.Text = rm.GetString("labelLlojDokumenti", ci) + ":";
        }

        private void Rap_PorosiBazaar_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
