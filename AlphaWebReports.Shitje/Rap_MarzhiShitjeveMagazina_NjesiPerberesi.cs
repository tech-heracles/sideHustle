...
{
    public partial class Rap_MarzhiShitjeveMagazina_NjesiPerberesi : DevExpress.XtraReports.UI.XtraReport
        {
		public Rap_MarzhiShitjeveMagazina_NjesiPerberesi(){InitializeComponent();} 
        public Rap_MarzhiShitjeveMagazina_NjesiPerberesi(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_MarzhiShitjeveMagazina_NjesiPerberesi(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            MarzhiShitjeveLabel.Text = rm.GetString("lblRaportTitullMarzhiShitjeveMagNjesiPerb", ci);
            ...
            FitimiLiterKokaR.Text = rm.GetString("labelFitimi_Liter", ci);  
