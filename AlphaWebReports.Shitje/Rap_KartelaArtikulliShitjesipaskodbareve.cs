...
{
    public partial class Rap_KartelaArtikulliShitjesipaskodbareve : DevExpress.XtraReports.UI.XtraReport
    {
        
        public Rap_KartelaArtikulliShitjesipaskodbareve()
        {
            InitializeComponent();
        }
        public Rap_KartelaArtikulliShitjesipaskodbareve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaArtikulliShitjesipaskodbareve(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel17.Text = rm.GetString("RaportKartelaArtikullitsipaskodbareve", ci);
            ...
            xrLabel88.Text = rm.GetString("labelRaportiZbritjePerqindje", ci);
            xrTableCell7.Text=rm.GetString("lblKodbarirap", ci); 
