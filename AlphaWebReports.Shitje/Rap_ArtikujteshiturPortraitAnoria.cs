...
{
    public partial class Rap_ArtikujteshiturPortraitAnoria : DevExpress.XtraReports.UI.XtraReport
    {    
		public Rap_ArtikujteshiturPortraitAnoria(){InitializeComponent();} 
        public Rap_ArtikujteshiturPortraitAnoria(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_ArtikujteshiturPortraitAnoria(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel46.Text = rm.GetString("labelRaportGjatesi", ci);
            xrLabel47.Text = rm.GetString("labelRaportGjeresi", ci);
        }
