...
{
    public partial class Rap_LibriShitjeve2015 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_LibriShitjeve2015(){InitializeComponent();} 

        int shifraPasPresjes = 0;
        public Rap_LibriShitjeve2015(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_LibriShitjeve2015(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi,
