...
{
    public partial class Rap_ShitjeAnalitik_SePDeFn_131302597895823068 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_ShitjeAnalitik_SePDeFn_131302597895823068()
        {
            InitializeComponent();
        }
        int shifraPasPresjes = 0;
        public Rap_ShitjeAnalitik_SePDeFn_131302597895823068(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitik_SePDeFn_131302597895823068(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void caktoFormatinENumrave()
        {
            ...
            xrLabel27.XlsxFormatString = xrLabel28.XlsxFormatString
                ...
                = xrLabel36.XlsxFormatString = xrLabel33.XlsxFormatString = xrLabel35.XlsxFormatString
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel122.Text = rm.GetString("lblGjithsejMeTvsh", ci);
            xrLabel116.Text = rm.GetString("labelZbritjeAnalitike", ci) + " %";
            xrLabel118.Text = rm.GetString("labelVleftameTVSH", ci);
            xrLabel112.Text = rm.GetString("labelZbritjaTotale", ci) + " %";
            xrLabel119.Text = rm.GetString("lblShenimeAnalitikeNrSeriale", ci);
