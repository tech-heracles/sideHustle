...
{
    public partial class Rap_LibriShitjeve2015_SunPetrolium : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_LibriShitjeve2015_SunPetrolium(){InitializeComponent();} 

        
        public Rap_LibriShitjeve2015_SunPetrolium(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_LibriShitjeve2015_SunPetrolium(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi,
