...
namespace AlphaWebReports.RaportetDs.RAP_SHITJE
{
    public partial class Rap_ArtikujShiturDegeAdministrative : DevExpress.XtraReports.UI.XtraReport, IUpdateDetail
    {
        ...
        public Rap_ArtikujShiturDegeAdministrative(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.IdRaporti, param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        { }
        public Rap_ArtikujShiturDegeAdministrative(int idRaporti, CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel13.Text = rm.GetString("RaportArtikujTeShiturDegeAdm", ci);
            ...
            Sasia1.Text = rm.GetString("labelSasia", ci);
            Cmimi1.Text = rm.GetString("labelCmimi", ci);
            ZbritjaAnalitike.Text = rm.GetString("labelZbritjeAnalitike", ci);
            VleftapaTVSH.Text = rm.GetString("labelVleftapaTVSH", ci);
            ZbrtijaTotal.Text = rm.GetString("labelZbritjaTotale", ci);
            TVSH.Text = rm.GetString("labelTVSH", ci);
            VleftameTVSH.Text = rm.GetString("labelVleftameTVSH", ci);
        ...
        private void xrLabel67_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (this.GetCurrentColumnValue("dega") != null)
            {
                ...
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + dega + ";GroupHeader1;artikujTeShiturDegeAdministrative')";
