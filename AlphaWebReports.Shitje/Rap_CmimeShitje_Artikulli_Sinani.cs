...
{
    public partial class Rap_CmimeShitje_Artikulli_Sinani : DevExpress.XtraReports.UI.XtraReport
    {

        public Rap_CmimeShitje_Artikulli_Sinani()
        {
            InitializeComponent();
        }
        public Rap_CmimeShitje_Artikulli_Sinani(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_CmimeShitje_Artikulli_Sinani(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, XtraReport report)
        {
            ...
            Grupim1.Value = report.Parameters[5].Value;
            DtDok.Value = report.Parameters[6].Value;
            Cmimi.Value = report.Parameters[7].Value;
            NivelCmimi.Value = report.Parameters[3].Value;
            ...
            fieldKosto.Caption = rm.GetString("cmbCmimeArtikulliKosto", ci); 
            ...
            cmimetPivotGrid.Fields.AddRange(new  DevExpress.XtraReports.UI.PivotGrid.XRPivotGridField[] {fieldKartela, fieldKodbari, fieldPershkrimArtikulli, fieldNjesia, fieldKosto, fieldNivelCmimi, fieldVleraCmimi});
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("RaportListeCmimeshShitjedheKostoTitulli", ci);
