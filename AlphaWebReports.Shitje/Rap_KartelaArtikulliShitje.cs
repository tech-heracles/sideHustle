...
{
    public partial class Rap_KartelaArtikulliShitje : DevExpress.XtraReports.UI.XtraReport
    {
        
        public Rap_KartelaArtikulliShitje()
        {
            InitializeComponent();
        }
        public Rap_KartelaArtikulliShitje(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaArtikulliShitje(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
