...
{
    public partial class Rap_ArtikujteshiturSipasAutorizimeve : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ArtikujteshiturSipasAutorizimeve()
        { InitializeComponent();} 
        int shifrapaspresjes = 0;
        public Rap_ArtikujteshiturSipasAutorizimeve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_ArtikujteshiturSipasAutorizimeve(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void caktoFormatinENumrave()
        {
            ...
            lblsasia.Summary.FormatString = xrLabel9.Summary.FormatString = xrLabel7.Summary.FormatString = xrLabel8.Summary.FormatString = xrLabel31.Summary.FormatString = lbltotalipatvshmezbr.Summary.FormatString = xrLabel6.Summary.FormatString = "{0:n" + shifrapaspresjes + "}";

            lblsasia.XlsxFormatString = xrLabel9.XlsxFormatString = xrLabel7.XlsxFormatString = xrLabel8.XlsxFormatString = xrLabel31.XlsxFormatString = lbltotalipatvshmezbr.XlsxFormatString = xrLabel6.XlsxFormatString
