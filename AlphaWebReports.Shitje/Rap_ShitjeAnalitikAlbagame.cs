...
{
    public partial class Rap_ShitjeAnalitikAlbagame : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ShitjeAnalitikAlbagame(){InitializeComponent();} 

        int shifraPasPresjes = 0;
        public Rap_ShitjeAnalitikAlbagame(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitikAlbagame(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
          ResourceManager  rm = new ResourceManager("Resources.Strings",
            ...
            VleftapaTVSHR.Text = rm.GetString("labelVleftapaTVSH", ci);
            ...
            PerdoruesR.Text = rm.GetString("labelFilterAvancuarPerdorues", ci);
