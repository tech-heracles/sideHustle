...
{
    public partial class Rap_LibriShitjeveKosove2015 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_LibriShitjeveKosove2015(){InitializeComponent();} 

        public Rap_LibriShitjeveKosove2015(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_LibriShitjeveKosove2015(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel22.Text = rm.GetString("labelShitjeMeShkalle", ci) + " 18%";
            ...
            xrLabel36.Text = rm.GetString("labelShitjeMeShkalle", ci) + " 8%";
            ...
            xrLabel54.Text = rm.GetString("labelKutia", ci) + " (13)";
            xrLabel52.Text = rm.GetString("labelKutia", ci) + " (14)";
