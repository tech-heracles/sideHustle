...
{
    public partial class Rap_ShitjePermbledhesPortraitSipasAutorizimeve : DevExpress.XtraReports.UI.XtraReport
    {        
		public Rap_ShitjePermbledhesPortraitSipasAutorizimeve(){InitializeComponent();} 
        private int cnt = 0;
        private string monedha;
        private bool ndryshuar = false;
       
        public Rap_ShitjePermbledhesPortraitSipasAutorizimeve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjePermbledhesPortraitSipasAutorizimeve(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
