...
{
    public partial class Rap_Artikujteshitur_SePDeFn_131306072108028643 : DevExpress.XtraReports.UI.XtraReport
    {
        int shifrapaspresjes = 0;
        public Rap_Artikujteshitur_SePDeFn_131306072108028643() { InitializeComponent(); }
        public Rap_Artikujteshitur_SePDeFn_131306072108028643(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) : this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi, param.GuidString, param.IdRaporti, param.IdGjuha, param.Vjen, param.IdViti, param.IdSubRaporti, report) { }

        public Rap_Artikujteshitur_SePDeFn_131306072108028643(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            labelKodbari.Text = rm.GetString("lblRaportKF", ci);
