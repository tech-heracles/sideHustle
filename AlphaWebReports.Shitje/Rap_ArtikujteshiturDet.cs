...
{
    public partial class Rap_ArtikujteshiturDet : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ArtikujteshiturDet(){InitializeComponent();} 
        public Rap_ArtikujteshiturDet(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ArtikujteshiturDet(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
            ...
            parameter15.Value = raport.Parameters[10].Value;
            ...
            parameter16.Value = raport.Parameters[14].Value;
            parameter17.Value = raport.Parameters[18].Value;
            parameter18.Value = raport.Parameters[19].Value;
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel13.Text = rm.GetString("RaportArtikujTeShiturMeDetajimeTitulli", ci);
