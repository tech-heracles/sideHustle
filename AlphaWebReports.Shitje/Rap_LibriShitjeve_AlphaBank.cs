...
{
    public partial class Rap_LibriShitjeve_AlphaBank : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_LibriShitjeve_AlphaBank(){InitializeComponent();} 
        public Rap_LibriShitjeve_AlphaBank(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_LibriShitjeve_AlphaBank(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi,
