...
{
    public partial class Rap_DokumentatKonvertuara2 : DevExpress.XtraReports.UI.XtraReport,  IUpdateDetailMeDyId
    {
        ...
        public Rap_DokumentatKonvertuara2()
        {
            InitializeComponent();
        }
        public Rap_DokumentatKonvertuara2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        { }
        public Rap_DokumentatKonvertuara2(CultureInfo ci, int idNdermarja, int idViti, int Idperdorues, XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
