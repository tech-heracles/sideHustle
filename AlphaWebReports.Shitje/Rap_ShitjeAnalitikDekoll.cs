...
{
    public partial class Rap_ShitjeAnalitikDekoll : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ShitjeAnalitikDekoll(){InitializeComponent();} 
       
        public Rap_ShitjeAnalitikDekoll(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitikDekoll(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
          ...
          System.Reflection.Assembly.Load("App_GlobalResources"));
            ...
            xrLabel110.Text = rm.GetString("filterRaportPershkrimi", ci);           
        }
    }
}
