...
namespace AlphaWebReports.RaportetDs.RAP_SHITJE
{
    ...
    public partial class Rap_ShitjetSipasSasiveKrahasueseNeTon : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ShitjetSipasSasiveKrahasueseNeTon(){InitializeComponent();} 

        
		public Rap_ShitjetSipasSasiveKrahasueseNeTon(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
		this(param.Ci,param.IdNdermarrje,param.IdPerdoruesi,param.GuidString,param.IdRaporti,param.IdGjuha,param.Vjen,param.IdViti,param.IdSubRaporti,report)
		{
            ...
            public Rap_ShitjetSipasSasiveKrahasueseNeTon(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport) {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            titulliLabel.Text = rm.GetString("labelRaportShitjetSipasSasiveKrahasueseNeTonTitulli", ci);
