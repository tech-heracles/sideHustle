...
{
    public partial class Rap_ShitjePermbledhes_AlphaBank : DevExpress.XtraReports.UI.XtraReport
    {        
		public Rap_ShitjePermbledhes_AlphaBank(){InitializeComponent();} 
       

        public Rap_ShitjePermbledhes_AlphaBank(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }

        public Rap_ShitjePermbledhes_AlphaBank(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            VleraNeMonedhenBaze.Text = rm.GetString("labelMonedhaBaze", ci);
            Nr.Text = rm.GetString("labelRaportiNr", ci);
            DtValute.Text = rm.GetString("lblRaportDtValute", ci);
