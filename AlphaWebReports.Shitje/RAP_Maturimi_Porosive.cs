...
namespace AlphaWebReports.RaportetDs.RAP_SHITJE
{
    ...
    public partial class RAP_Maturimi_Porosive : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_Maturimi_Porosive(){InitializeComponent();} 
 
        private ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
     
        public RAP_Maturimi_Porosive(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, report)
        {

        }
        public RAP_Maturimi_Porosive(CultureInfo ci, int idNdermarrje, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel19.Text = rm.GetString("labelDateDokumenti", ci);
            xrLabel46.Text = rm.GetString("labelRaportDateMaturmi", ci);
            xrLabel17.Text = rm.GetString("labelKLIENTI", ci);
            xrLabel16.Text = rm.GetString("labelPERSHKRIMI", ci);
            xrLabel14.Text = rm.GetString("label_KODI", ci);
            xrLabel5.Text = rm.GetString("labelRaportDetajimi", ci);            
            ...
            rm.GetString("labelVLERA_ME_TVSH", ci);
