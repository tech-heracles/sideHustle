...
{
    public partial class Rap_KartelaAgjenteveShitjesFormat2 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KartelaAgjenteveShitjesFormat2(){InitializeComponent();} 
              public Rap_KartelaAgjenteveShitjesFormat2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaAgjenteveShitjesFormat2(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel30.Text = rm.GetString("labelKomisionPapaguar", ci);
