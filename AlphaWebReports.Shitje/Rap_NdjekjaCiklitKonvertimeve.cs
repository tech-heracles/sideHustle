...
{
    public partial class Rap_NdjekjaCiklitKonvertimeve : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_NdjekjaCiklitKonvertimeve(){InitializeComponent();} 
        public Rap_NdjekjaCiklitKonvertimeve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, report)
        {

        }
        public Rap_NdjekjaCiklitKonvertimeve(CultureInfo ci,DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
