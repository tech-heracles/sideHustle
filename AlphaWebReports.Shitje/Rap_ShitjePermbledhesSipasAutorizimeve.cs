...
{
    public partial class Rap_ShitjePermbledhesSipasAutorizimeve : DevExpress.XtraReports.UI.XtraReport
    {        
		public Rap_ShitjePermbledhesSipasAutorizimeve(){InitializeComponent();} 
        private int cnt = 0;
        private string monedha;

        public Rap_ShitjePermbledhesSipasAutorizimeve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjePermbledhesSipasAutorizimeve(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
