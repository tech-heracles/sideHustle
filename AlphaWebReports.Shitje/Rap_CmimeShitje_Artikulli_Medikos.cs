...
{
    public partial class Rap_CmimeShitje_Artikulli_Medikos : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_CmimeShitje_Artikulli_Medikos()
        {
            InitializeComponent();
        }

        public Rap_CmimeShitje_Artikulli_Medikos(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_CmimeShitje_Artikulli_Medikos(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, XtraReport report)
        {
            ...
            NivelCmimi.Value = report.Parameters[8].Value;
            PershkrimArt.Value = report.Parameters[9].Value;
            ...
            XRPivotGridField fieldProdhuesiArtikulli = new XRPivotGridField("Prodhuesi", PivotArea.RowArea);
            fieldProdhuesiArtikulli.FieldName = "prodhuesi";
            fieldProdhuesiArtikulli.Caption = rm.GetString("labelRaportiProdhuesi", ci);
            XRPivotGridField fieldTVSHneCmimArtikulli = new XRPivotGridField("TVSHneCmim", PivotArea.RowArea);
            fieldTVSHneCmimArtikulli.FieldName = "tvshneCmim";
            fieldTVSHneCmimArtikulli.Caption = rm.GetString("labelRaportiTvshneCmim", ci);
            ...
            cmimetPivotGrid.Fields.AddRange(new DevExpress.XtraReports.UI.PivotGrid.XRPivotGridField[] {fieldKartela, fieldKodbari, fieldPershkrimArtikulli, fieldProdhuesiArtikulli,fieldTVSHneCmimArtikulli,
