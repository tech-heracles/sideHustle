...
{
    public partial class Rap_ShitjeAnalitikSipasAutorizimeve : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ShitjeAnalitikSipasAutorizimeve(){InitializeComponent();} 
   
       
        public Rap_ShitjeAnalitikSipasAutorizimeve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitikSipasAutorizimeve(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
