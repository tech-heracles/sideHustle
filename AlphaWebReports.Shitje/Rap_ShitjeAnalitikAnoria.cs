...
{
    public partial class Rap_ShitjeAnalitikAnoria : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ShitjeAnalitikAnoria(){InitializeComponent();} 
     
        public Rap_ShitjeAnalitikAnoria(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitikAnoria(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel71.Text = rm.GetString("labelRaportEmri", ci) + ":";
