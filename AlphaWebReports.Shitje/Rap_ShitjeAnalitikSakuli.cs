...
{
    public partial class Rap_ShitjeAnalitikSakuli : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ShitjeAnalitikSakuli(){InitializeComponent();} 

        public Rap_ShitjeAnalitikSakuli(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitikSakuli(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
          ResourceManager  rm = new ResourceManager("Resources.Strings",
            ...
            xrLabel13.Text = rm.GetString("labelTVSH", ci);
            ...
            xrLabel24.Text = rm.GetString("labelVleftameTVSH", ci);
