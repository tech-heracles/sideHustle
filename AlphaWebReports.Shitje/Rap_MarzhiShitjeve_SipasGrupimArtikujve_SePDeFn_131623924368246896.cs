...
{
    public partial class Rap_MarzhiShitjeve_SipasGrupimArtikujve_SePDeFn_131623924368246896 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_MarzhiShitjeve_SipasGrupimArtikujve_SePDeFn_131623924368246896(){InitializeComponent();} 
         int shifraPasPresjes = 0;
        public Rap_MarzhiShitjeve_SipasGrupimArtikujve_SePDeFn_131623924368246896(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {
 
        }

        public Rap_MarzhiShitjeve_SipasGrupimArtikujve_SePDeFn_131623924368246896(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
