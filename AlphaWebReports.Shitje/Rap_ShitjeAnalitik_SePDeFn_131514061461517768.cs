...
{
    public partial class Rap_ShitjeAnalitik_SePDeFn_131514061461517768 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_ShitjeAnalitik_SePDeFn_131514061461517768()
        {
            InitializeComponent();
        }
        int shifraPasPresjes = 0;
        public Rap_ShitjeAnalitik_SePDeFn_131514061461517768(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitik_SePDeFn_131514061461517768(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
