...
{
    public partial class Rap_ShitjeAnalitik : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_ShitjeAnalitik()
        {
            InitializeComponent();
        }
        int shifraPasPresjes = 0;
        public Rap_ShitjeAnalitik(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitik(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
