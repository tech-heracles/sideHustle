...
{
    public partial class Rap_ShitjeAnulluara : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ShitjeAnulluara(){InitializeComponent();} 
      
        public Rap_ShitjeAnulluara(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnulluara(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
          ...
          xrLabel17.Text = rm.GetString("RaportShitjeAnulluaraTitulli", ci);
