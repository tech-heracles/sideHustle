...
{
    public partial class Rap_ShitjeAnalitik_PcStore : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_ShitjeAnalitik_PcStore()
        {
            InitializeComponent();

        }
        int shifraPasPresjes = 0;
        public Rap_ShitjeAnalitik_PcStore(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_ShitjeAnalitik_PcStore(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel17.Text = rm.GetString("RaportRegjistriAnalitikShitjeveTitulliPcStore", ci);
