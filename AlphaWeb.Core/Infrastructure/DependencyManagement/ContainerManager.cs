...
namespace AlphaWeb.Core.Infrastructure.DependencyManagement
{
    ...
    public class ContainerManager
    {
        ...
        private readonly IRequestLifetimeScopeManager _requestLifetimeScopeManager;
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="container">Conainer</param>
        public ContainerManager(IContainer container,IRequestLifetimeScopeManager requestLifetimeScopeManager)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new AlphaWebException("Unknown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (AlphaWebException)
                {

                }
            }
            throw new AlphaWebException("No constructor  was found that had all the dependencies satisfied.");
        }
