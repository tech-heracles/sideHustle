...
namespace AlphaWeb.Core.Common
{
    ...
    /// </summary>
    public class AlphaWebFileProvider : PhysicalFileProvider, IAlphaWebFileProvider
    {

        /// <summary>
        /// Initializes a new instance of a AlphaWebFileProvider
        /// </summary>
        /// <param name="webRootPath"></param>
        /// <param name="contentPath"></param>
        public AlphaWebFileProvider(string webRootPath, string contentPath) : base(webRootPath)
        {
