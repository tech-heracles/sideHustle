...
namespace PlatinumWeb.Templates
{
         ...
         public class MyTemplatePrindiKodifikimArtikulli : ITemplate //template i krijuar per Autorizime
        {
            private int lloji, idNdermarrje;
            private bool llojartikulli;

            public MyTemplatePrindiKodifikimArtikulli(int idNdermarrje, int lloji, bool llojartikulli)
            {
                this.lloji = lloji;
            ...
            public void InstantiateIn(Control Container)
            {
                ...
                kod.IdKodifikimi = 0;
                col.Add(kod);
                col.merrKodifikimArtikulliSipasLlojit(lloji, this.idNdermarrje,llojartikulli);
