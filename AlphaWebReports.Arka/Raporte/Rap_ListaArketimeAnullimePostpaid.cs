...
namespace AlphaWebReports.RaportetDs.Arka.Raporte
{
    ...
    public partial class Rap_ListaArketimeAnullimePostpaid : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ListaArketimeAnullimePostpaid(){InitializeComponent();} 
        public Rap_ListaArketimeAnullimePostpaid(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, report)
        {

        }
        public Rap_ListaArketimeAnullimePostpaid(CultureInfo ci, int idNdermarrje, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
        ...
        private void EmraTeLabelave(CultureInfo ci, bool shtoFilterKompania)
        {
            ...
            xrLabel12.Text = rm.GetString("TitullRaportiArketimeAnullimePostpaid", ci);
