...
{
    public partial class RAP_ARKA_GJENDJAPERMBLEDHUR : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_ARKA_GJENDJAPERMBLEDHUR(){InitializeComponent();} 

        private CultureInfo ci;
        private ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));


        public RAP_ARKA_GJENDJAPERMBLEDHUR(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public RAP_ARKA_GJENDJAPERMBLEDHUR(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            this.ci = ci;
            InitializeComponent();
            EmrateLabelave(ci);
            ...
            parameterVlerePo.Value = rm.GetString("cmbFilterPo", ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("RaportGjendjaPermbArkaTitulli", ci);
