...
{
    public partial class RAP_ARKA_GJENDJAPERMBLEDHUR_NIVEL_RAPORTUES : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_ARKA_GJENDJAPERMBLEDHUR_NIVEL_RAPORTUES(){InitializeComponent();} 

        private CultureInfo ci;
        private ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));

        public RAP_ARKA_GJENDJAPERMBLEDHUR_NIVEL_RAPORTUES(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public RAP_ARKA_GJENDJAPERMBLEDHUR_NIVEL_RAPORTUES(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            this.ci = ci;
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("RaportGjendjaPermbArkaNivelRaportuesTitulli", ci);
            ...
            xrLabel13.Text = rm.GetString("lblRaportTotaliArkave", ci) + ":";
        }
    }
}
