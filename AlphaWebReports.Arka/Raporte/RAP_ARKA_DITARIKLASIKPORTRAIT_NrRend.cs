...
{
    public partial class RAP_ARKA_DITARIKLASIKPORTRAIT_NrRend : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_ARKA_DITARIKLASIKPORTRAIT_NrRend(){InitializeComponent();} 
        private CultureInfo ci;
        private ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));


        public RAP_ARKA_DITARIKLASIKPORTRAIT_NrRend(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public RAP_ARKA_DITARIKLASIKPORTRAIT_NrRend(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            this.ci = ci;
            InitializeComponent();
            EmrateLabelave(ci);
