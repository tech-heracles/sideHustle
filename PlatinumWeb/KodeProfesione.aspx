<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KodeProfesione.aspx.cs" Inherits="PlatinumWeb.KodeProfesione" %>
    ...
    Utils.shfaqLoadingGif();;
        ...
        <div style="width: 100%">
            ...
            <asp:UpdatePanel runat="server" ID="pnlGrida" UpdateMode="Conditional">
                <ContentTemplate>
                    <dx:ASPxGridView ID="gvKodeProfesione" runat="server" Width="100%" OnAfterPerformCallback="gridat_AfterPerformCallback"
                        OnHeaderFilterFillItems="gridat_HeaderFilterFillItems" OnRowUpdating="rowUpdating"
                        ClientInstanceName="gvKodeProfesione" OnProcessColumnAutoFilter="gridat_ProcessColumnAutoFilter"
                    ...
                    <dx:ASPxGridViewExporter ID="gridExport" runat="server" GridViewID="gvKodeProfesione" ExportedRowType="All">
