<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_QendraKosto.aspx.cs"
    Inherits="PlatinumWeb.Shto_QendraKosto" %>
...
<head id="Head1" runat="server">
 ...
 <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    ...
    <script src="js/aspx.js/Shto_Burime.aspx-IMB.2.1.js?versioni22" type="text/javascript"></script>--%>
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myMesazh-IMB.2.1.js;~/js/myBuxhet-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/Shto_QendraKosto.aspx-IMB.3.1.js&v76""
...
<body>
                            ...
                            <dx:ContentControl>
                                <table class="renditKontrolle">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="renditKontrolleCellMeWidth33">
                                                <dx:ASPxComboBox ID="cmbKonfigurimi" runat="server" ClientInstanceName="cmbKonfigurimi"
                                                    Width="100%" Height="23px" SettingsLoadingPanel-ImagePosition="Top" ShowShadow="False"
                                        ...
                                        <tr>
                                            <td>
									            <dx:ASPxButton ID="btnXlsxExport1" runat="server" ToolTip="Export to Xlsx" Image-Height="16px"
										            Image-Url="images/xlsx24.png" Font-Size="8" UseSubmitBehavior="false" OnClick="btnXlsxExport_Click1">
										        </dx:ASPxButton>
									        </td>
									        <td>
									            <dx:ASPxButton ID="btnPdfExport1" runat="server" ToolTip="Export to Pdf" Image-Height="16px"
										            Image-Url="images/pdf_icon.png" Font-Size="8" UseSubmitBehavior="false" OnClick="btnPdfExport_Click1">
										        </dx:ASPxButton>
									        </td>
								        </tr>
                                    </tbody>
                                ...
                                <asp:UpdatePanel ID="pnl" runat="server">
                                    <ContentTemplate>
                                        <dx:ASPxTreeList ID="trlQendra" runat="server" ClientInstanceName="trlQendra" Width="100%"
                                            OnCustomCallback="trlQendra_CustomCallback1" OnDataBound="trlQendra_DataBound">
                                            <ClientSideEvents EndCallback="function(s, e) {        
}"
                                                NodeDblClick="function(s, e){    OnGridDoubleClick(e.visibleIndex);   kaloTab=true;
                          }"
	...
	BeginCallback(s,e);
                                        ...
                                        <dx:ASPxTreeListExporter ID="ASPxTreeListExporter1" runat="server" TreeListID="trlQendra">
                    ...
                    <dx:TabPage Name="Qendra Kosto" Text="Qendra Kosto" >
                        ...
                        <ContentCollection>
                            <dx:ContentControl ID="ContentControl3" runat="server">
                                ...
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="cmbMonedha" ID="lblMonedha" runat="server"
                                    ClientInstanceName="lblMonedha" Text="Tipi:">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <%--<div id="dvcmbTipi">--%>
                                ...
                                <dx:ASPxComboBox ID="cmbPrindi" ClientInstanceName="cmbPrindi" Width="100%" runat="server"
                                    ...
                                    <ClientSideEvents TextChanged="function(s,e){cmbPrindiTextChanged(s,e)}" />
                                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" CausesValidation="true"
                                 ...
                                 <dx:ASPxLabel Wrap="False" AssociatedControlID="txtNiveli" ID="lblNiveli" runat="server"
                                    Text="Kodi:" ClientInstanceName="lblNiveli">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <%--<div id="dvtxtKodi">--%>
                                <dx:ASPxTextBox ID="txtNiveli" runat="server" Width="100%" AutoPostBack="false" ClientInstanceName="txtNiveli">
                                    <ValidationSettings CausesValidation="true" ValidationGroup="entries" SetFocusOnError="true"
                                        Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                        <ErrorFrameStyle ImageSpacing="4px">
                                            <ErrorTextPaddings PaddingLeft="4px" />
                    ...
                    <dx:TabPage Name="Buxhetet" Text="Buxhetet" >
                        <ContentCollection>
                            <dx:ContentControl ID="ContentControl1" runat="server">
                                ...
                                <table>
                                    <tr>
                                        <td>
									        <dx:ASPxButton ID="btnXlsxExport2" runat="server" ToolTip="Export to Xlsx" Image-Height="16px"
										        Image-Url="images/xlsx24.png" Font-Size="8" UseSubmitBehavior="false" OnClick="btnXlsxExport_Click2">
										    </dx:ASPxButton>
									    </td>
									    <td>
									        <dx:ASPxButton ID="btnPdfExport2" runat="server" ToolTip="Export to Pdf" Image-Height="16px"
										        Image-Url="images/pdf_icon.png" Font-Size="8" UseSubmitBehavior="false" OnClick="btnPdfExport_Click2">
										    </dx:ASPxButton>
									    </td>
								    </tr>
							    </table>
                                ...
                                <dx:ASPxGridView ID="gvBuxheti" runat="server" ClientInstanceName="gvBuxheti"
                                    Width="100%" OnHtmlRowCreated="gvBuxheti_HtmlRowCreated"
                                ...
                                <dx:ASPxGridViewExporter ID="gridExport" runat="server" GridViewID="gvBuxheti" ExportedRowType="All">
