<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B_Shto_RegjistrimRialokimBuxheti.aspx.cs" Inherits="PlatinumWeb.B_Shto_RegjistrimRialokimBuxheti" %>
        ...
        <asp:UpdatePanel runat="server" ID="updatePanel1">
            <ContentTemplate> 
                            ...
                            <div id="divgride1" style="min-height:200px;">
                                ...
                                <div class="dx-viewport demo-container">
                                    <div id="data-grid-buxheti">
                                        <div id="dxDataGrid_trupRialokimi" class ="noUndoGrida"></div>
                                    </div>
                                </div>
                                <!------------------------------------------------------->
                            </div>
                ...
                <div id="dvFillim" class="">
                    ...
                    <dx:ASPxLabel Wrap="False" runat="server" ID="lblQendraShendetesore" ClientInstanceName="lblQendraShendetesore" AssociatedControlID="txtQendraShendetesore" Text="Qendra Shëndetësore:" />
                    <dx:ASPxTextBox Width="100%" runat="server" ID="txtQendraShendetesore" ClientInstanceName="txtQendraShendetesore">
                ...
                <div id="dvFundi" class="renditKontrolle">
