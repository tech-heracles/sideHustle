<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_FormatSeriali.aspx.cs" Inherits="PlatinumWeb.Shto_FormatSeriali" %>
...
<meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/selectize.min.js;~/js/multiSelect.js;~/js/myMesazh-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/Shto_FormatSeriali.aspx-IMB.7.1.js&v76"
                    ...
                    <dx:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                        <ContentCollection>
                            <dx:ContentControl>
                                ...
                                <dx:ASPxGridView ID="ASPxGridView_FormatSeriali" ClientInstanceName="ASPxGridView_FormatSeriali" runat="server"
                                    Width="100%" OnDataBound="ASPxGridView_FormatSeriali_DataBound" OnAfterPerformCallback="ASPxGridView_FormatSeriali_AfterPerformCallback"
                                    OnHeaderFilterFillItems="ASPxGridView_FormatSeriali_HeaderFilterFillItems" OnProcessColumnAutoFilter="ASPxGridView_FormatSeriali_ProcessColumnAutoFilter"
                                    OnCustomJSProperties="ASPxGridView_FormatSeriali_CustomJSProperties" OnCustomCallback="ASPxGridView_FormatSeriali_CustomCallback"
                                    OnAutoFilterCellEditorInitialize="ASPxGridView_FormatSeriali_AutoFilterCellEditorInitialize">
                                    <Templates>
                                        <TitlePanel>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <dx:ASPxButton ID="ASPxButton2" runat="server" ToolTip="Zgjidh kolonat" AutoPostBack="false"
                                                            ...
                                                            <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,ASPxGridView_FormatSeriali)}"
                                                    ...
                                                    <td>
                                                        <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                                            ...
                                                            <ClientSideEvents Click="function(s, e) { ASPxGridView_FormatSeriali.SelectAllRowsOnPage(); }" />
                                                        </dx:ASPxButton>
                                                    ...
                                                    <td>
                                                        <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                                            ...
                                                            <ClientSideEvents Click="function(s, e) { ASPxGridView_FormatSeriali.SelectRows(); }" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                                            ...
                                                            <ClientSideEvents Click="function(s, e) { ASPxGridView_FormatSeriali.UnselectRows(); }" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                </tr>
                                            </table>
                    ...
                    <dx:TabPage Name="Informacion" Text="Informacion">
                        ...
                        <ContentCollection>
                            <dx:ContentControl ID="ContentControl3" runat="server">
                                <table id="tblFormatet" class="renditKontrolle">
                                    <tbody>
                                    </tbody>
                                </table>

                                <dx:ASPxLabel Wrap="False" AssociatedControlID="txtKodiFormat" ID="lblKodiFormat" runat="server" Text="Kodi:" ClientInstanceName="lblKodiFormat">
                                </dx:ASPxLabel>
                                <dx:ASPxTextBox ID="txtKodiFormat" runat="server" Width="100%" AutoPostBack="false" ClientInstanceName="txtKodiFormat">
                                ...
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="txtPershkrimFormat" ID="lblPershkrimFormat" runat="server" Text="Pershkrimi:" ClientInstanceName="lblPershkrimFormat">
                                </dx:ASPxLabel>
                                <dx:ASPxTextBox ID="txtPershkrimFormat" runat="server" Width="100%" AutoPostBack="false" ClientInstanceName="txtPershkrimFormat">
                                    <DisabledStyle BackColor="#EEEEEE" Font-Bold="False" ForeColor="Black">
                                    </DisabledStyle>
                                </dx:ASPxTextBox>

                                <dx:ASPxLabel Wrap="False" AssociatedControlID="cmbKategoriaFormat" ID="lblKategoriaFormat" runat="server" Text="Emertimi:" ClientInstanceName="lblKategoriaFormat">
                                </dx:ASPxLabel>
                                <dx:ASPxComboBox ID="cmbKategoriaFormat" ClientInstanceName="cmbKategoriaFormat"
