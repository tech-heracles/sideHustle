<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMLupaAnketa.aspx.cs" Inherits="PlatinumWeb.CRMLupaAnketa" %>
...
<head id="Head1" runat="server">
 ...
 <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/CRMLupaAnketa.aspx-IMB.4.8.js&v49"
                                    ...
                                    <tr>
                                        <td>
                                            <dx:ASPxGridView ID="gvLupaAnketa" runat="server" ClientInstanceName="gvLupaAnketa"
                                                OnDataBound="gvLupaAnketa_DataBound" OnAfterPerformCallback="gvLupaAnketa_AfterPerformCallback"
                                                OnHeaderFilterFillItems="gvLupaAnketa_HeaderFilterFillItems" Width="100%"
