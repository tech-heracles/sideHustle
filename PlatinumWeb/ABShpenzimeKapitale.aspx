<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABShpenzimeKapitale.aspx.cs" Inherits="PlatinumWeb.ABShpenzimeKapitale" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="dvAktiviteti" style="display: block">
            ...
            <dx:ASPxGridView ID="gvShpenzimeKapitale"
                Width="100%" ToolTip="Parashikimet per shpenzime kapitale" runat="server"
                OnBatchUpdate="gvShpenzimeKapitale_BatchUpdate"
                OnAfterPerformCallback="gvShpenzimeKapitale_AfterPerformCallback" OnHtmlFooterCellPrepared="gvShpenzimeKapitale_HtmlFooterCellPrepared"
                OnCustomCallback="gvShpenzimeKapitale_CustomCallback"  OnDataBound="gvShpenzimeKapitale_DataBound" OnCustomUnboundColumnData="gvShpenzimeKapitale_CustomUnboundColumnData" >
