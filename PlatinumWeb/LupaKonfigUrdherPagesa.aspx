<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaKonfigUrdherPagesa.aspx.cs"
    Inherits="PlatinumWeb.LupaKonfigUrdherPagesa" %>
...
<head id="Head1" runat="server">
  ...
  <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myMesazh-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaKonfigUrdherPagesa.aspx-IMB.2.1.js&v76""
...
<body onload="Init()">
    ...
    <div id='div' style="display: none">
        <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" HeaderText="Zgjidh Llogarine"
            Width="100%" ClientInstanceName="panel" ShowHeader="False">
            <PanelCollection>
                <dx:PanelContent>
                    <%-- shtuar--%>
                    <table width="100%">
                                ...
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvLupaKonfig" runat="server" ClientInstanceName="gvLupaKonfig"
                                            ...
                                            Width="100%" OnCustomCallback="gvLupaKonfig_CustomCallback" SettingsDataSecurity-AllowReadUnlistedFieldsFromClientApi="True">
