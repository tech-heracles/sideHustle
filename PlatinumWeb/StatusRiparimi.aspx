<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatusRiparimi.aspx.cs" Inherits="PlatinumWeb.StatusRiparimi" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/StatusRiparimi.aspx-IMB.4.0.js&v76"
    ...
    Utils.shfaqLoadingGif();;
        ...
        <div style="width: 50%">
            <asp:UpdatePanel ID="pnlGrida" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <dx:ASPxGridView ID="gvStatusRiparimi" runat="server" Width="100%" OnAfterPerformCallback="gvStatusRiparimi_AfterPerformCallback"
                        OnHeaderFilterFillItems="gvStatusRiparimi_HeaderFilterFillItems" OnAutoFilterCellEditorInitialize="gvStatusRiparimi_AutoFilterCellEditorInitialize"
                        OnRowUpdating="gvStatusRiparimi_RowUpdating" ClientInstanceName="gvStatusRiparimi"
                        OnProcessColumnAutoFilter="gvStatusRiparimi_ProcessColumnAutoFilter" OnCancelRowEditing="gvStatusRiparimi_StartRowEditing"
                        OnRowInserting="gvStatusRiparimi_RowInserting" OnRowValidating="gvStatusRiparimi_RowValidating"
                        OnInitNewRow="gvStatusRiparimi_InitNewRow" OnCustomCallback="gvStatusRiparimi_CustomCallback"
                        OnCustomJSProperties="gvStatusRiparimi_CustomJSProperties" ClientIDMode="AutoID">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                                ...
                                                <ClientSideEvents Click="function(s, e) { gvStatusRiparimi.SelectAllRowsOnPage(); }" />
                                            </dx:ASPxButton>
                                        </td>
                                        <td>
                                            <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                                ...
                                                UseSubmitBehavior="false">
                                                <ClientSideEvents Click="function(s, e) { gvStatusRiparimi.SelectRows(); }" />
                                            </dx:ASPxButton>
                                        </td>
                                        <td>
                                            <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                                ...
                                                UseSubmitBehavior="false">
                                                <ClientSideEvents Click="function(s, e) { gvStatusRiparimi.UnselectRows(); }" />
                                            </dx:ASPxButton>
                                        </td>
