<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegjistrimRezervimi.aspx.cs"
    Inherits="PlatinumWeb.RegjistrimRezervimi" %>
	...
	popKonvertim.Hide();
        ...
        <asp:UpdatePanel ID="pnlKryesor" runat="server">
            <ContentTemplate>
                ...
                <br />
                <dx:ASPxGridView ID="gvRegRZ" ClientInstanceName="gvRegRZ" runat="server" Width="100%"
                    OnDataBound="gvRegRZ_DataBound" OnAfterPerformCallback="gvRegRZ_AfterPerformCallback"
                    OnCustomCallback="gvRegRZ_CustomCallback" OnCustomJSProperties="gvRegRZ_CustomJSProperties"
                    OnProcessColumnAutoFilter="gvRegRZ_ProcessColumnAutoFilter" OnHeaderFilterFillItems="gvRegRZ_HeaderFilterFillItems">
                    <Templates>
                        <TitlePanel>
                            <table>
                                <tr>
                                    <td>
                                        <dx:ASPxButton ID="ASPxButton2" runat="server" ToolTip="Zgjidh kolonat" AutoPostBack="false"
                                            ...
                                            <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,gvRegRZ)}"
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                            ...
                                            <ClientSideEvents Click="function(s, e) { gvRegRZ.SelectAllRowsOnPage(); }" />
                                        </dx:ASPxButton>
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                            ...
                                            <ClientSideEvents Click="function(s, e) { gvRegRZ.SelectRows(); }" />
                                        </dx:ASPxButton>
                                    </td>
                                    <td>
                                        <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                            ...
                                            <ClientSideEvents Click="function(s, e) { gvRegRZ.UnselectRows(); }" />
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                            </table>
