<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_ObjektivaKosto.aspx.cs" Inherits="PlatinumWeb.Shto_ObjektivaKosto" %>
...
<body>
                    ...
                    <dxtc:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                        <ContentCollection>
                            <dxw:ContentControl>
                                ...
                                <dx:ASPxGridView ID="gvObjektiva" ClientInstanceName="gvObjektiva" runat="server" Width="100%"
                                    OnDataBound="gvObjektiva_DataBound" OnAfterPerformCallback="gvObjektiva_AfterPerformCallback"
                                    OnHeaderFilterFillItems="gvObjektiva_HeaderFilterFillItems" OnProcessColumnAutoFilter="gvObjektiva_ProcessColumnAutoFilter"
                                    OnCustomJSProperties="gvObjektiva_CustomJSProperties" OnCustomCallback="gvObjektiva_CustomCallback"
                                    OnAutoFilterCellEditorInitialize="gvObjektiva_AutoFilterCellEditorInitialize">
                                    <Templates>
                                        <TitlePanel>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <dx:ASPxButton ID="ASPxButton2" runat="server" Text="Zgjidh kolonat" AutoPostBack="false"
                                                            ...
                                                            <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,gvObjektiva)}"
	...
	BeginCallback(s,e);
                    ...
                    <dxtc:TabPage Name="Objektiva" Text="Objektiva" >
                      
                        <ContentCollection>
                            <dxw:ContentControl ID="ContentControl3" runat="server">
                                <table id="tblObjektiva" class="renditKontrolle">
                                    <tbody>
                                    </tbody>
                                </table>
                                <%--<div id="dvlblKodi">--%>
                                ...
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="dteNga" ID="lblNga"
                                    runat="server" Text="Kohezgjatje Nga:" ClientInstanceName="lblNga">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <%--<div id="dvdteDtRegjistrimi">--%>
                                <dx:ASPxDateEdit ID="dteNga" runat="server" ClientInstanceName="dteNga"
                                ...
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="dteNe" ID="lblNe"
                                    runat="server" Text="Ne:" ClientInstanceName="lblNe">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <%--<div id="dvdteDtRegjistrimi">--%>
                                <dx:ASPxDateEdit ID="dteNe" runat="server" ClientInstanceName="dteNe"
                                    ShowShadow="False" Width="100%">
                                    <DropDownButton>
                                        <Image>
                                            <SpriteProperties HottrackedCssClass="dxEditors_edtDropDownHover_Aqua" PressedCssClass="dxEditors_edtDropDownPressed_Aqua" />
