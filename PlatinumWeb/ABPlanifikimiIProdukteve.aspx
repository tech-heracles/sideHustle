<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABPlanifikimiIProdukteve.aspx.cs" Inherits="PlatinumWeb.ABPlanifikimiIProdukteve" %>
...
<body>
    ...
    <dx:ASPxLoadingPanel ID="LoadingPanel" runat="server" ClientInstanceName="LoadingPanel"
        ...
        <div id="dvAktiviteti" style="display: block;">
             ...
             <dx:ASPxGridView ID="gvPlanifikimiIProdukteve"
                Width="100%" ToolTip="Planifikimi i produkteve te programit ne sasi dhe ne vlere" runat="server"
                OnBatchUpdate="gvPlanifikimiIProdukteve_BatchUpdate"
                OnAfterPerformCallback="gvPlanifikimiIProdukteve_AfterPerformCallback" OnHtmlFooterCellPrepared="gvPlanifikimiIProdukteve_HtmlFooterCellPrepared"
                OnCustomCallback="gvPlanifikimiIProdukteve_CustomCallback"  OnDataBound="gvPlanifikimiIProdukteve_DataBound" >
                <ClientSideEvents BeginCallback="gvBeginCallback" EndCallback="gvEndCallback" BatchEditStartEditing="StartEditing"  />
