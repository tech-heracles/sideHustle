<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LlojDifekti.aspx.cs" Inherits="PlatinumWeb.LlojDifekti" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/aspx.js/LlojDifekti.aspx-IMB.4.0.js&v76"
    ...
    Utils.shfaqLoadingGif();;
        ...
        <div style="width: 50%">
            <asp:UpdatePanel ID="pnlGrida" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <dx:ASPxGridView ID="gvLlojDifekti" runat="server" Width="100%" OnAfterPerformCallback="gvLlojDifekti_AfterPerformCallback"
                        OnHeaderFilterFillItems="gvLlojDifekti_HeaderFilterFillItems" OnAutoFilterCellEditorInitialize="gvLlojDifekti_AutoFilterCellEditorInitialize"
                        OnRowUpdating="gvLlojDifekti_RowUpdating" ClientInstanceName="gvLlojDifekti"
                        OnProcessColumnAutoFilter="gvLlojDifekti_ProcessColumnAutoFilter" OnCancelRowEditing="gvLlojDifekti_StartRowEditing"
                        OnRowInserting="gvLlojDifekti_RowInserting" OnRowValidating="gvLlojDifekti_RowValidating"
                        OnInitNewRow="gvLlojDifekti_InitNewRow" OnCustomCallback="gvLlojDifekti_CustomCallback"
                        OnCustomJSProperties="gvLlojDifekti_CustomJSProperties" ClientIDMode="AutoID">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                                ...
                                                <ClientSideEvents Click="function(s, e) { gvLlojDifekti.SelectAllRowsOnPage(); }" />
                                            </dx:ASPxButton>
                                        </td>
                                        <td>
                                            <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                                ...
                                                UseSubmitBehavior="false">
                                                <ClientSideEvents Click="function(s, e) { gvLlojDifekti.SelectRows(); }" />
                                            </dx:ASPxButton>
                                        </td>
                                        <td>
                                            <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                                ...
                                                UseSubmitBehavior="false">
                                                <ClientSideEvents Click="function(s, e) { gvLlojDifekti.UnselectRows(); }" />
                                            </dx:ASPxButton>
                                        </td>
