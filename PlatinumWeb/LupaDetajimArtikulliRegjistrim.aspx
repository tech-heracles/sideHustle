<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaDetajimArtikulliRegjistrim.aspx.cs"
    Inherits="PlatinumWeb.LupaDetajimArtikulliRegjistrim" %>
...
<head id="Head1" runat="server">
  ...
  <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaDetajimArtikulliRegjistrim.aspx-IMB.2.1.js;~/js/Utils-IMB.2.1.js&v76""
...
<body onload="Init()">
    ...
    <div id='div' style="display: none">
            ...
            <PanelCollection>
                <dx:PanelContent>
                    <table width="100%">
                        <tr>
                            <td>
                                <dx:ASPxGridView ID="gvLupaDetArtRegj" runat="server" ClientInstanceName="gvLupaDetArtRegj"
                                    OnDataBound="gvLupaDetArtRegj_DataBound" OnAfterPerformCallback="gvLupaDetArtRegj_AfterPerformCallback"
                                    Width="100%" OnAutoFilterCellEditorInitialize="gvLupaDetArtRegj_AutoFilterCellEditorInitialize"
                                    OnHtmlRowCreated="gvLupaDetArtRegj_HtmlRowCreated" OnCustomJSProperties="gvLupaDetArtRegj_CustomJSProperties">
                        ...
                        <tr>
                            <td align="center" class="style1">
                                <dx:ASPxButton ID="btnOk" runat="server" Text="Ok" AutoPostBack="false" ClientInstanceName="btnOk" Visible="false">                                    
                                </dx:ASPxButton>
                            </td>
                        </tr>
                    </table>
        ...
        <asp:HiddenField ID="hfVleftatZgjedhura" runat="server" />
