<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B_RegjistrimRialokimBuxheti.aspx.cs" Inherits="PlatinumWeb.B_RegjistrimRialokimBuxheti" %>
...
<head runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/selectize.min.js;~/js/multiSelect.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/B_RegjistrimRialokimBuxheti.aspx-IMB.7.6.js&v76"
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="pnlKryesor" runat="server">
            <ContentTemplate>
                <dx:ASPxGridView ID="gv_RialokimBuxheti" ClientInstanceName="gv_RialokimBuxheti" runat="server" Width="100%" OnDataBound="gv_RialokimBuxheti_DataBound" OnAfterPerformCallback="gv_RialokimBuxheti_AfterPerformCallback" OnCustomCallback="gv_RialokimBuxheti_CustomCallback"  OnCustomJSProperties="gv_RialokimBuxheti_CustomJSProperties" OnHeaderFilterFillItems="gv_RialokimBuxheti_HeaderFilterFillItems" SettingsPager-PageSize="20">
                    <Styles>
