<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShperndarjeShpenzimesh.aspx.cs"
    Inherits="PlatinumWeb.ShperndarjeShpenzimesh" %>
...
<head id="Head1" runat="server">
 ...
 <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    ...
    <script src="js/aspx.js/ShperndarjeShpenzimesh.aspx-IMB.2.1.js?versioni22" type="text/javascript"></script>--%>
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/jquery-ui-1.10.2.custom.min.js;~/js/jqGrid445/plugins/ui.multiselect.js;~/js/jqGrid445/grid.locale-en.js;~/js/jqGrid445/jquery.jqGrid.min.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;;~/js/myCookies-IMB.2.1.js;~/js/aspx.js/ShperndarjeShpenzimesh.aspx-IMB.2.1.js&v76""
    ...
    Utils.shfaqLoadingGif();;
        ...
        <asp:UpdatePanel ID="pnlKryesor" runat="server">
            <ContentTemplate>
                ...
                <br />
                <dx:ASPxGridView ID="grid_ShperndarjeShpenzimesh" ClientInstanceName="grid_ShperndarjeShpenzimesh"
                    runat="server" Width="100%"
                    OnDataBound="grid_ShperndarjeShpenzimesh_DataBound" OnAfterPerformCallback="grid_ShperndarjeShpenzimesh_AfterPerformCallback"
                    OnCustomCallback="grid_ShperndarjeShpenzimesh_CustomCallback" OnCustomJSProperties="grid_ShperndarjeShpenzimesh_CustomJSProperties"
                    OnProcessColumnAutoFilter="grid_ShperndarjeShpenzimesh_ProcessColumnAutoFilter"
                    OnHeaderFilterFillItems="grid_ShperndarjeShpenzimesh_HeaderFilterFillItems">
