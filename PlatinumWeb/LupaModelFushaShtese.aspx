<%@ Page Language="C#" AutoEventWireup="true" Title="" CodeBehind="LupaModelFushaShtese.aspx.cs"
    Inherits="PlatinumWeb.LupaModelFushaShtese" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaModelFushaShtese.aspx-IMB.2.1.js&v76"
...
<body onload="Init()">
    <form id="form1" runat="server">
        ...
        <div id='div' style="display: none">
            <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" HeaderText="Zgjidh Modelin"
                        ...
                        <asp:UpdatePanel ID="pnlKryesor" runat="server">
                            <ContentTemplate>
                                <table>
                                    <tr>
                                        <td>
                                            <dx:ASPxGridView ID="gvLupaModele" runat="server" ClientInstanceName="gvLupaModele" Settings-ShowTitlePanel="true"
                                                OnDataBound="gvLupaModele_DataBound"
                                                Width="100%"
                                                OnCustomCallback="gvLupaModele_CustomCallback">
                                                <Templates>
                                                    <TitlePanel>
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                                                        ...
                                                                        <ClientSideEvents Click="function(s, e) { gvLupaModele.SelectAllRowsOnPage(); }" />
                                                                    </dx:ASPxButton>
                                                                </td>
                                                                <td>
                                                                    <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                                                        ...
                                                                        <ClientSideEvents Click="function(s, e) { gvLupaModele.SelectRows(); }" />
                                                                    </dx:ASPxButton>
                                                                </td>
                                                                <td>
                                                                    <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                                                        ...
                                                                        <ClientSideEvents Click="function(s, e) { gvLupaModele.UnselectRows(); }" />
                                                                    </dx:ASPxButton>
                                                                </td>
                                                            </tr>
                                                        </table>
