<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfesioneTitujPune.aspx.cs" Inherits="PlatinumWeb.ProfesioneTitujPune" %>
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <dx:ASPxPageControl EnableHierarchyRecreation="false" ID="ASPxPageControl1" runat="server" ClientInstanceName="PageControl"
                        ...
                        <TabPages>
                            <dx:TabPage Name="Profesione" Text="Profesione">
                                <ContentCollection>
                                    <dx:ContentControl ID="ContentControl1" runat="server">
                                        ...
                                        <br />
                                     <asp:UpdatePanel runat="server" ID="pnlGridaProfesione" UpdateMode="Conditional">
                                         <ContentTemplate>
                                        <dx:ASPxGridView ID="gvProfesione" runat="server" Width="100%" OnAfterPerformCallback="gridat_AfterPerformCallback"
                                            OnHeaderFilterFillItems="gridat_HeaderFilterFillItems" OnRowUpdating="rowUpdating"
                                            ClientInstanceName="gvProfesione" OnProcessColumnAutoFilter="gridat_ProcessColumnAutoFilter"
                                        ...
                                        <dx:ASPxGridViewExporter ID="gridExport1" runat="server" GridViewID="gvProfesione" ExportedRowType="All">
                            ...
                            <dx:TabPage Name="TitujPune" Text="Pozicione Pune">
                                <ContentCollection>
                                    <dx:ContentControl ID="ContentControl2" runat="server">
                                        ...
                                        <br />
                                        <asp:UpdatePanel runat="server" ID="pnlGridaTituj" UpdateMode="Conditional">
                                         <ContentTemplate>
                                        <dx:ASPxGridView ID="gvtituj" runat="server" Width="100%" OnAfterPerformCallback="gridat_AfterPerformCallback"
                                            OnHeaderFilterFillItems="gridat_HeaderFilterFillItems" OnRowUpdating="rowUpdating"
                                            ClientInstanceName="gvtituj" OnProcessColumnAutoFilter="gridat_ProcessColumnAutoFilter"
                                            OnCancelRowEditing="startRowEditing" OnRowInserting="rowInserting" OnRowValidating="rowValidating"
                                            OnInitNewRow="initNewRow" OnCustomCallback="gridat_CustomCallback" OnCustomJSProperties="gridat_CustomJSProperties">
                                        ...
                                        <dx:ASPxGridViewExporter ID="gridExport2" runat="server" GridViewID="gvtituj" ExportedRowType="All" MaxColumnWidth="250">
                                        </dx:ASPxGridViewExporter>
                                             </ContentTemplate>
                                            </asp:UpdatePanel>
                                    </dx:ContentControl>
