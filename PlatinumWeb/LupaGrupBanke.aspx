<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaGrupBanke.aspx.cs"
    Inherits="PlatinumWeb.LupaGrupBanke" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaGrupBanke.aspx-IMB.2.1.js&v76"
                    ...
                    <asp:UpdatePanel ID="pnl" runat="server">
                        <ContentTemplate>
                            ...
                            <table width="100%">
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvLupaGrBanka" runat="server" ClientInstanceName="gvLupaGrBanka"
                                            OnDataBound="gvLupaGrBanka_DataBound" OnAfterPerformCallback="gvLupaGrBanka_AfterPerformCallback"
                                            OnHeaderFilterFillItems="gvLupaGrBanka_HeaderFilterFillItems" Width="100%" OnRowInserting="gvLupaGrBanka_RowInserting"
                                            OnRowValidating="gvLupaGrBanka_RowValidating" OnStartRowEditing="gvLupaGrBanka_StartRowEditing"
                                            OnRowUpdating="gvLupaGrBanka_RowUpdating" OnRowInserted="gvLupaGrBanka_RowInserted">
