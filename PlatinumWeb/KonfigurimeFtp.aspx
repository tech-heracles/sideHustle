<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KonfigurimeFtp.aspx.cs"
    Inherits="PlatinumWeb.KonfigurimeFtp" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/selectize.min.js;~/js/multiSelect.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/KonfigurimeFtp.aspx-IMB.6.5.js&v76""
...
<body>
                    ...
                    <dxtc:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                        <ContentCollection>
                            <dxw:ContentControl ID="ContentControl3" runat="server">
                                ...
                                <dx:ASPxGridView ID="gvKonfigurimeFTP" runat="server" ClientInstanceName="gvKonfigurimeFTP"
                                    OnAfterPerformCallback="gvKonfigurimeFTP_AfterPerformCallback" Width="100%"
                                    OnCustomCallback="gvKonfigurimeFTP_CustomCallback"
                                    OnDataBound="gvKonfigurimeFTP_DataBound"
                                    OnProcessColumnAutoFilter="gvKonfigurimeFTP_ProcessColumnAutoFilter">
	...
	BeginCallback(s,e);
                    ...
                    <dxtc:TabPage Name="Konfigurime FTP" Text="Konfigurime FTP">
                        <ContentCollection>
                            <dxw:ContentControl ID="ContentControl1" runat="server">
                                <table id="tblKonfigurimeFtp" class="renditKontrolle">
                                    <tbody>
                                    </tbody>
                                </table>
                                ...
                                <dx:ASPxLabel Wrap="False" ID="lblHostName" runat="server" AssociatedControlID="txtHostName"
                                    ClientInstanceName="lblHostName" Text="Hostname">
                                </dx:ASPxLabel>
                                <dx:ASPxTextBox ID="txtHostName" runat="server" ClientInstanceName="txtHostName" Width="100%">
                                ...
                                <dx:ASPxLabel Wrap="False" ID="lblUsername" runat="server" AssociatedControlID="txtUsername"
                                    ClientInstanceName="lblUsername" Text="Username:">
                                </dx:ASPxLabel>
                                ...
                                <dx:ASPxTextBox ID="txtVerifikoPassword" runat="server" ClientInstanceName="txtVerifikoPassword" Password="true" Width="100%">
                                    <ValidationSettings CausesValidation="true" ErrorDisplayMode="ImageWithTooltip" Display="Dynamic"
                                ...
                                <dx:ASPxLabel Wrap="False" ID="lblPorta" runat="server" AssociatedControlID="txtPorta"
                                    ClientInstanceName="lblPorta" Text="Porta SMTP:">
                                </dx:ASPxLabel>

                                <dx:ASPxTextBox ID="txtPorta" runat="server" ClientInstanceName="txtPorta" Width="100%">
                                ...
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="cmbMetoda" ID="lblMetoda"
                                    runat="server" Text="Metoda:" ClientInstanceName="lblMetoda">
                                </dx:ASPxLabel>
                                <dx:ASPxComboBox ID="cmbMetoda" runat="server" ClientInstanceName="cmbMetoda" ShowShadow="False" ReadOnly="false" SettingsLoadingPanel-ImagePosition="Top" Width="100%">
                                ...
                                <dx:ASPxLabel Wrap="False" ID="lblEshteSFTP" runat="server" AssociatedControlID="cbEnableSsl"
                                    ClientInstanceName="lblEshteSFTP" Text="Eshte SFTP">
                                </dx:ASPxLabel>
                                <dx:ASPxCheckBox ID="cbEshteSFTP" runat="server" ClientInstanceName="cbEshteSFTP" TextSpacing="2px">
                                    <DisabledStyle Font-Bold="False"></DisabledStyle>
                                </dx:ASPxCheckBox>

                                <dx:ASPxLabel Wrap="False" ID="lblFolderPath" runat="server" AssociatedControlID="txtFolderPath"
                                    ClientInstanceName="lblFolderPath" Text="Folder Path">
                                </dx:ASPxLabel>
                                <dx:ASPxTextBox ID="txtFolderPath" runat="server" ClientInstanceName="txtFolderPath" Width="100%">
