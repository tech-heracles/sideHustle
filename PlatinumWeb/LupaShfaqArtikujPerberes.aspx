<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaShfaqArtikujPerberes.aspx.cs" Inherits="PlatinumWeb.LupaShfaqArtikujPerberes"
...
<head id="Head1" runat="server">
 ...
 <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaShfaqArtikujPerberes.aspx-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js&v76""
                        ...
                        <asp:UpdatePanel ID="pnlKryesor" runat="server">
                            <ContentTemplate>
                                <table width="100%">
                                    <tr>
                                        <td>
                                            <dx:ASPxGridView ID="gvLupaArtikullPerberes" runat="server" ClientInstanceName="gvLupaArtikullPerberes"
                                                OnDataBound="gvLupaArtikullPerberes_DataBound" 
