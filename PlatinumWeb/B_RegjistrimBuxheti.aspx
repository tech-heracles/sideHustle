<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B_RegjistrimBuxheti.aspx.cs" Inherits="PlatinumWeb.B_RegjistrimBuxheti" %>
...
<head runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/selectize.min.js;~/js/multiSelect.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/B_RegjistrimBuxheti.aspx-IMB.2.1.js&v76"
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="pnlKryesor" runat="server">
            <ContentTemplate>
                ...
                <dx:ASPxGridView ID="gv_RegjistrimBuxheti" ClientInstanceName="gv_RegjistrimBuxheti" runat="server" Width="100%" OnDataBound="gv_RegjistrimBuxheti_DataBound" OnAfterPerformCallback="gv_RegjistrimBuxheti_AfterPerformCallback" OnCustomCallback="gv_RegjistrimBuxheti_CustomCallback"  OnCustomJSProperties="gv_RegjistrimBuxheti_CustomJSProperties" OnHeaderFilterFillItems="gv_RegjistrimBuxheti_HeaderFilterFillItems" SettingsPager-PageSize="20">
                    <Styles>
