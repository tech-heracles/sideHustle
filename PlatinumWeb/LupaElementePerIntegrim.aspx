<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaElementePerIntegrim.aspx.cs" Inherits="PlatinumWeb.LupaElementePerIntegrim" %>
...
<head id="Head1" runat="server">
  ...
  <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaElementePerIntegrim.aspx-IMB.5.8.js&v76""
...
<body onload="Init()">
    ...
    <div id='div' style="display: none">
        ...
        <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" ClientInstanceName="panel"
            Width="100%" Height="100%" HeaderText="Zgjidh Nivelin e autorizimeve" ShowHeader="False">
            <PanelCollection>
                <dx:PanelContent>
                    <%-- shtuar--%>
                    <table width="100%">
                    ...
                    <asp:UpdatePanel ID="pnlKryesor" runat="server">
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvLupaElementePerIntegrim" runat="server" ClientInstanceName="gvLupaElementePerIntegrim"
                                            OnDataBound="gvLupaElementePerIntegrim_DataBound" OnAfterPerformCallback="gvLupaElementePerIntegrim_AfterPerformCallback"
                                            Width="100%" OnCustomCallback="gvLupaElementePerIntegrim_CustomCallback">
