<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SigurimeSuplementare.aspx.cs"
    Inherits="PlatinumWeb.SigurimeSuplementare" %>
...
<head id="Head1" runat="server">
 ...
 <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/SigurimeSuplementare.aspx-IMB.2.1.js&v76""
...
<body>
    ...
    <div style="width: 100%">
        <asp:UpdatePanel runat="server" ID="pnlGrida" UpdateMode="Conditional">
            <ContentTemplate>
                <dx:ASPxGridView ID="gvSigurimeSuplementare" runat="server" Width="100%" OnAfterPerformCallback="gridat_AfterPerformCallback"
                    OnHeaderFilterFillItems="gridat_HeaderFilterFillItems" OnRowUpdating="rowUpdating"
                    ClientInstanceName="gvSigurimeSuplementare" OnProcessColumnAutoFilter="gridat_ProcessColumnAutoFilter"
                    ...
                    <ClientSideEvents EndCallback="function(s, e) { EndCallbackGrida(s, e); }" RowDblClick="function (s, e) {RowDblClickGrida1(s, e);}" />
                    <Styles>
    ...
    </div>    <dx:ASPxHiddenField ID="hfTeDrejta" runat="server" ClientInstanceName="hfTeDrejta">
    </dx:ASPxHiddenField>
