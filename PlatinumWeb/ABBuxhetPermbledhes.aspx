<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABBuxhetPermbledhes.aspx.cs" Inherits="PlatinumWeb.ABBuxhetPermbledhes" %>
...
<body>
    <form id="form1" runat="server">         
        ...
        <div id="dvAktiviteti" style="display: block">
            ...
            <dx:ASPxGridView ID="gvbuxhetPermbledhes"
                Width="100%" ToolTip="Permbledhese e buxhetit te vitit pasardhes" runat="server"
                OnBatchUpdate="gvbuxhetPermbledhes_BatchUpdate"
                OnCustomUnboundColumnData="gvbuxhetPermbledhes_CustomUnboundColumnData"  OnAfterPerformCallback="gvbuxhetPermbledhes_AfterPerformCallback" OnHtmlFooterCellPrepared="gvbuxhetPermbledhes_HtmlFooterCellPrepared"
                OnCustomCallback="gvbuxhetPermbledhes_CustomCallback"  OnDataBound="gvbuxhetPermbledhes_DataBound" >
