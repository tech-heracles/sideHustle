<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaNjesiProdhimi.aspx.cs" Inherits="PlatinumWeb.LupaNjesiProdhimi" %>
...
<head runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaNjesiProdhimi.aspx-IMB.4.7.js;~/js/myButtonClickLupa-IMB.2.1.js&v76""
    ...
    <form id="form1" runat="server">
        ...
        <div id='div' style="display: none">
            <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" ClientInstanceName="panel"
                ...
                <ContentPaddings PaddingLeft="3px" PaddingTop="3px" PaddingRight="3px" PaddingBottom="3px"></ContentPaddings>
                <PanelCollection>
                    <dx:PanelContent>
                        <table width="100%">
                            <tr>
                        ...
                        <asp:UpdatePanel ID="pnlKryesor" runat="server">
                            <ContentTemplate>
                                <table width="100%">
                                    <tr>
                                        <td>
                                            <dx:ASPxGridView ID="gvLupaNjesiProdhimi" runat="server" ClientInstanceName="gvLupaNjesiProdhimi"
                                                OnDataBound="gvLupaNjesiProdhimi_DataBound" OnCustomJSProperties="gvLupaNjesiProdhimi_CustomJSProperties"
                                                OnAfterPerformCallback="gvLupaNjesiProdhimi_AfterPerformCallback" OnProcessColumnAutoFilter="gvLupaNjesiProdhimi_ProcessColumnAutoFilter"
                                                Width="100%" OnCustomCallback="gvLupaNjesiProdhimi_CustomCallback" SettingsBehavior-AllowSelectSingleRowOnly="True">
