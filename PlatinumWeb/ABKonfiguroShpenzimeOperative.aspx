<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABKonfiguroShpenzimeOperative.aspx.cs" Inherits="PlatinumWeb.ABKonfiguroShpenzimeOperative" %>
        ...
        <div id="dvAktiviteti" style="display: block">
         ...
         <%--   <table class="renditKontrolle">
            ...
            <dx:ASPxGridView ID="gvKonfiguroShpenzimeOperative"
                ...
                <ClientSideEvents EndCallback="gvEndCallback"  BatchEditStartEditing="StartEditing" BatchEditEndEditing="EndEditing" BatchEditRowValidating="rowValidation"/>
