<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaKerkoFushaShtese.aspx.cs" Inherits="PlatinumWeb.LupaKerkoFushaShtese" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaKerkoFushaShtese.aspx-IMB.6.6.js&v73"></script>
</head>
<body>
                                ...
                                <dx:PanelContent>
                                    <table style="float: left">
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxCheckBox ID="cmbGrupo" runat="server" AutoPostBack="false" ClientVisible="false" ClientInstanceName="cmbGrupo" Width="100%">
