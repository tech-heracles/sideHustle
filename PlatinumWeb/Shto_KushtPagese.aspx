<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_KushtPagese.aspx.cs"
    Inherits="PlatinumWeb.Shto_KushtPagese" %>
        ...
        <asp:UpdatePanel ID="pnl" runat="server">
            <ContentTemplate>
                <dxtc:ASPxPageControl EnableHierarchyRecreation="false" ID="ASPxPageControl1" ClientInstanceName="PageControl" runat="server"
                    ActiveTabIndex="2"   TabSpacing="3px" Width="100%">
                    <ContentStyle>
                    ...
                    <TabPages>
                        <dxtc:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                            <ContentCollection>
                                <dxw:ContentControl ID="ContentControl3" runat="server">
                                    <dx:ASPxGridView ID="grid_KushtePagese" runat="server" ClientInstanceName="grid_KushtePagese"
                                        OnRowInserting="grid_KushtePagese_RowInserting" Width="60%" OnAfterPerformCallback="grid_KushtePagese_AfterPerformCallback"
                                        OnRowValidating="grid_KushtePagese_RowValidating" OnStartRowEditing="grid_KushtePagese_StartRowEditing"
                                        OnCellEditorInitialize="grid_KushtePagese_CellEditorInitialize" OnInitNewRow="grid_KushtePagese_InitNewRow">
                                    </dx:ASPxGridView>
                                    <br />
                                    <table class="butonat">
                                        <tr>
                                            ...
                                            <td align="right" style="width: 10%">
                                                <dx:ASPxButton ID="overview_Button" runat="server" OnClick="overview_Button_Click"
                                                    Text="Ruaj" Width="100%">
                                                    <ClientSideEvents Click="function(s,e){RuajOverview_Click(s,e)}" />
                                                </dx:ASPxButton>
                                            </td>
                                            <td align="right" style="width: 10%">
                                                <dx:ASPxButton ID="overview_pastro_ASPxButton" runat="server" OnClick="overview_pastro_ASPxButton_Click"
                                                    Text="Pastro" Width="100%">
                                                </dx:ASPxButton>
                                            </td>
                                            <td align="right" style="width: 10%">
                                                <dx:ASPxButton ID="overviewAnullo" runat="server" PostBackUrl="~/KushtePagese.aspx"
                                                    Text="Anullo" Width="100%">
                                                </dx:ASPxButton>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <dxtc:TabPage Name="Kusht Pagese" Text="Kusht Pagese" TabStyle-Height="150px">
                            <TabStyle>
                            </TabStyle>
                            <ContentCollection>
                                <dxw:ContentControl ID="ContentControl1" runat="server">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            grida=false;
                                            Autorizimi_Click();}" LostFocus="Lost_Focus" />
                                                    <LoadingPanelImage>
                                                    </LoadingPanelImage>
                                                    <DropDownButton>
                                                        <Image>
                                                    ...
                                                    <ValidationSettings CausesValidation="true" ValidationGroup="entries" SetFocusOnError="true">
                                                        ...
                                                        <%--    <RequiredField IsRequired = "true" ErrorText="Zgjidhni autorizimin!" />--%>
                                                    </ValidationSettings>
                                                </dx:ASPxComboBox>
                                            </td>
                                        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" style="width: 10%">
                                                    <dx:ASPxButton ID="pastro_ASPxButton" runat="server" Text="Pastro" Width="100%"
                                                        OnClick="pastro_ASPxButton_Click" CausesValidation="False">
                        ...
                        <dxtc:TabPage Name="Trupi" Text="Trupi" TabStyle-Height="150px">
                            <TabStyle>
                            </TabStyle>
                            <ContentCollection>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxTextBox ID="kodi1_TextBox" runat="server" ClientInstanceName="kodi1_TextBox"
                                                    Width="170px">
                                                    <ClientSideEvents TextChanged="TextChanged_kodi1_TextBox" />
                                                    <ValidationSettings>
                                                        <ErrorFrameStyle ImageSpacing="4px">
                                                            <ErrorTextPaddings PaddingLeft="4px" />
                                                        </ErrorFrameStyle>
                                            ...
                                            <td>
                                                <dx:ASPxTextBox ID="afati_TextBox" runat="server" ClientInstanceName="afati_TextBox"
                                                    Width="170px">
                                                    <ValidationSettings ValidationGroup="entries" RegularExpression-ValidationExpression="[0-9]*"
                                                        RegularExpression-ErrorText="Afati duhet te jete numur pozitiv">
                                                        <ErrorFrameStyle ImageSpacing="4px">
                                                            <ErrorTextPaddings PaddingLeft="4px" />
                                                        </ErrorFrameStyle>
                                                        <RegularExpression ErrorText="Afati duhet te jete numur pozitiv" ValidationExpression="[0-9]*" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxTextBox ID="emertimi1_TextBox" runat="server" ClientInstanceName="emertimi1_TextBox"
                                                    Width="170px">
                                                    <ClientSideEvents TextChanged="TextChanged_emertimi1_TextBox" />
                                                    <ValidationSettings>
                                                        <ErrorFrameStyle ImageSpacing="4px">
                                                            <ErrorTextPaddings PaddingLeft="4px" />
                                                        </ErrorFrameStyle>
                                    ...
                                    <div>
                                        <table class="butonat">
                                            <tr>
                                                ...
                                                <td align="right" style="width: 10%">
                                                    <dx:ASPxButton ID="pastro_Button" runat="server" Text="Pastro" Width="100%" OnClick="pastro_ASPxButton_Click"
