<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABInventariPerdorues.aspx.cs" Inherits="PlatinumWeb.ABInventariPerdorues" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="dvAktiviteti" style="display: block;">
             ...
             <dx:ASPxGridView ID="gvinventariPerdorues"
                Width="100%" ToolTip="Inventari sipas perdoruesve" runat="server"
                OnBatchUpdate="gvinventariPerdorues_BatchUpdate"
                OnAfterPerformCallback="gvinventariPerdorues_AfterPerformCallback" OnHtmlFooterCellPrepared="gvinventariPerdorues_HtmlFooterCellPrepared"
                OnCustomCallback="gvinventariPerdorues_CustomCallback"  OnDataBound="gvinventariPerdorues_DataBound" >
