<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaKpf.aspx.cs" Inherits="PlatinumWeb.LupaKpf" %>
...
<head id="Head1" runat="server">
  ...
  <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaKpf.aspx-IMB.2.1.js&v76""
    ...
    <form id="form1" runat="server">           
        ...
        <dx:ASPxGlobalEvents ID="ASPxGlobalEvents1" runat="server">
            <%--<ClientSideEvents EndCallback="function(s,e){
             if (window.parent.identifikuesperKPF == 'LlogariShpejte')
                    window.parent.window.parent.window.parent.SessionTimeout.sendKeepAlive();
                else window.parent.window.parent.SessionTimeout.sendKeepAlive(); }" />--%>
        </dx:ASPxGlobalEvents>
         <dx:ASPxHiddenField ID="hfState" runat="server" SyncWithServer="true" ViewStateMode="Enabled">
            </dx:ASPxHiddenField>
        <div id='div' style="display: none">
            <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel2" runat="server" ClientInstanceName="panel"
                Width="100%" HeaderText="Zgjidh KPF " ShowHeader="False">
                <PanelCollection>
                    <dx:PanelContent>
                        <%-- shtuar--%>
                        <table width="100%">
                        ...
                        <asp:UpdatePanel ID="pnlKryesor" runat="server">
                            <ContentTemplate>
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>
                                            <dx:ASPxGridView ID="gvLupaKpf" runat="server" ClientInstanceName="gvLupaKpf"
                                                OnDataBound="gvLupaKpf_DataBound" OnAfterPerformCallback="gvLupaKpf_AfterPerformCallback"
                                                Width="100%" OnCustomCallback="gvLupaKpf_CustomCallback">
                                                <ClientSideEvents RowDblClick="function(s, e) { zgjidhElement(); }" BeginCallback="function(s, e) { BeginCallback(s,e); }" />
                                                <Styles>
                                    ...
                                    <tr>
                                        <%--<td align="center">
                                <dx:ASPxButton ID="btnOkKPF1" runat="server" Text="Ok" AutoPostBack="False" ClientInstanceName="btnOkKPF1"
                                       >
