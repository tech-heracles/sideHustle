<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_DegeAdministrative.aspx.cs"
    Inherits="PlatinumWeb.Shto_DegeAdministrative" %>
...
<head id="Head1" runat="server">
 ...
 <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    ...
    <script src="js/aspx.js/Shto_DegeAdministrative.aspx-IMB.2.1.js?versioni22" type="text/javascript"></script>--%>
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myMesazh-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/Shto_DegeAdministrative.aspx-IMB.2.1.js&v76"
...
<body>
    ...
    Utils.shfaqLoadingGif();;
        ...
        <div id="dvDega" style="display: none">
                    ...
                    <dxtc:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                        <ContentCollection>
                            <dxw:ContentControl>
                                    ...
                                    <tr>
                                        ...
                                        <td class="renditKontrolleCellMeWidth33">
                                            <dx:ASPxComboBox ID="cmbKonfigurimi" runat="server" ClientInstanceName="cmbKonfigurimi"
                                                ShowShadow="False" Width="100%" ValueType="System.String" Height="27px" Style="font-size: medium"
                                ...
                                <dx:ASPxGridView ID="gvDegeAdministrative" ClientInstanceName="gvDegeAdministrative"
                                    runat="server" Width="100%" OnDataBound="gvDegeAdministrative_DataBound" OnAfterPerformCallback="gvDegeAdministrative_AfterPerformCallback"
                                    OnHeaderFilterFillItems="gvDegeAdministrative_HeaderFilterFillItems" OnProcessColumnAutoFilter="gvDegeAdministrative_ProcessColumnAutoFilter"
                                    OnCustomJSProperties="gvDegeAdministrative_CustomJSProperties" OnCustomCallback="gvDegeAdministrative_CustomCallback"
                                    OnAutoFilterCellEditorInitialize="gvDegeAdministrative_AutoFilterCellEditorInitialize">
                                    <Styles>
                                                ...
                                                <tr>
                                                    <td>
                                                        <dx:ASPxButton ID="ASPxButton2" runat="server" Text="Zgjidh kolonat" AutoPostBack="false"
                                                            ...
                                                            <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,gvDegeAdministrative)}"
	...
	BeginCallback(s,e);
                    ...
                    <dxtc:TabPage Name="Dege Administrative" Text="Dege Administrative" >
                       
                        <ContentCollection>
                            <dxw:ContentControl ID="ContentControl3" runat="server">
                                <table id="tblDegeAdministrative" class="renditKontrolle">
                                    <tbody>
                                    </tbody>
                                </table>
                                <%--<div id="dvlblKodi">--%>
                                ...
                                <dx:ASPxTextBox ID="txtKodi" runat="server" AutoPostBack="false" ClientInstanceName="txtKodi"
                                    ...
                                    <ValidationSettings CausesValidation="true" ValidationGroup="entries" SetFocusOnError="true"
                                        Display="Dynamic" RegularExpression-ValidationExpression="^[\s\S]{0,20}$" RegularExpression-ErrorText="Kodi nuk duhet te jete me shume se 20 karaktere">
                                        <ErrorFrameStyle ImageSpacing="4px">
                                            <ErrorTextPaddings PaddingLeft="4px" />
                                        </ErrorFrameStyle>
                                ...
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="txtKodBiznesi" ID="lblKodBiznesi" runat="server"
                                     ClientInstanceName="lblKodBiznesi" ClientVisible="false">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <%--<div id="dvtxtKodi">--%>
                                <dx:ASPxTextBox ID="txtKodBiznesi" runat="server" AutoPostBack="false" ClientInstanceName="txtKodBiznesi"
                                ...
                                <dx:ASPxComboBox ID="qendraKostos_TextBox" Enabled="true" runat="server" ClientInstanceName="qendraKostos_TextBox"
                                   ...
                                   OnItemRequestedByValue="qendraKostos_TextBox_ItemRequestedByValue" OnItemsRequestedByFilterCondition="qendraKostos_TextBox_ItemsRequestedByFilterCondition"
