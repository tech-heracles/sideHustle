<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABParashikimShpenzimeKonfig.aspx.cs" Inherits="PlatinumWeb.ABParashikimShpenzimeKonfig" %>
    ...
    <form id="form1" runat="server">
     ...
     <dx:ASPxLoadingPanel ID="LoadingPanel" runat="server" ClientInstanceName="LoadingPanel"
        ...
        <div id="dvAktiviteti" style="display: block;">
             ...
             <dx:ASPxGridView ID="gvKonfigParashikimShpenz"
                Width="100%" ToolTip="Planifikimi i produkteve te programit ne sasi dhe ne vlere" runat="server"
                OnBatchUpdate="gvKonfigParashikimShpenz_BatchUpdate"
                OnAfterPerformCallback="gvKonfigParashikimShpenz_AfterPerformCallback" OnHtmlFooterCellPrepared="gvKonfigParashikimShpenz_HtmlFooterCellPrepared"
                OnCustomCallback="gvKonfigParashikimShpenz_CustomCallback"  OnDataBound="gvKonfigParashikimShpenz_DataBound" OnCustomErrorText="gvKonfigParashikimShpenz_CustomErrorText" >
                <ClientSideEvents EndCallback="gvEndCallback" BatchEditStartEditing="StartEditing"  />
