<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EkzekutimProdhimi.aspx.cs"
    Inherits="PlatinumWeb.EkzekutimProdhimi" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="pnlKryesor" runat="server">
            <ContentTemplate>
                ...
                <br />
                <dx:ASPxGridView ID="gvEkzekutimi" ClientInstanceName="gvEkzekutimi" runat="server"
                    Width="100%"
                    OnDataBound="gvEkzekutimi_DataBound" OnAfterPerformCallback="gvEkzekutimi_AfterPerformCallback"
                    OnCustomCallback="gvEkzekutimi_CustomCallback" OnCustomJSProperties="gvEkzekutimi_CustomJSProperties"
                    OnProcessColumnAutoFilter="gvEkzekutimi_ProcessColumnAutoFilter" OnHeaderFilterFillItems="gvEkzekutimi_HeaderFilterFillItems">
