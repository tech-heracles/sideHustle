...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name></Name>
    <UserStyle>
      <Name>V_GIS_Layer_MBETJERIC_SIPASPOP</Name>
      
      <FeatureTypeStyle>        
        <Rule>       
          <Name>Te riciklueshme</Name>
          <ogc:Filter>
            <ogc:PropertyIsGreaterThan><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>50</ogc:Literal></ogc:PropertyIsGreaterThan>
          </ogc:Filter>
          <PolygonSymbolizer>
            <Fill><CssParameter name="fill">#0198E1</CssParameter><CssParameter name="fill-opacity">0.01</CssParameter></Fill>
            <Stroke><CssParameter name="stroke">#0198E1</CssParameter><CssParameter name="fill-opacity">1</CssParameter></Stroke>
          </PolygonSymbolizer>	
        </Rule> 
        
        <Rule>   
          <Name>Te pariciklueshme</Name>
          <ogc:Filter>
          ...
          <PolygonSymbolizer>
            <Fill><CssParameter name="fill">#CC3232</CssParameter><CssParameter name="fill-opacity">0.01</CssParameter></Fill>
            <Stroke><CssParameter name="stroke">#CC3232</CssParameter><CssParameter name="fill-opacity">1</CssParameter></Stroke>
          </PolygonSymbolizer>	
        </Rule>  
        ...
        <Rule>
          <PointSymbolizer>
           ...
           <Graphic>
              <ExternalGraphic>
                <OnlineResource
                  xlink:href="http://chart?cht=p&amp;chf=bg,s,00000000&amp;chd=t:${VLERA},${100 - VLERA}&amp;chco=0198E1,CC3232 " />
