        ...
        <Rule>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource
                        xlink:href="http://chart?cht=bvg&amp;chf=bg,s,FFE1FF90&amp;chs=500x250&amp;chma=30,30,30,30&amp;chtt=Bashkia+${PERSHKRIMI}&amp;chts=000000,20&amp;chxt=x,y,t&amp;chxl=0:|Grumbullim|Transport|Mirembajtje|Personel|Amortizim|Depozitim|1:|Min|Med|Max|2:|${VLG}+Lek|${VLT}+Lek|${VLM}+Lek|${VLP}+Lek|${VLA}+Lek|${VLD}+Lek&amp;chxs=0,000000|1,000000|2,000000&amp;chd=t:${PG}|${PT}|${PM}|${PP}|${PA}|${PD}&amp;chco=CC3333,008AB8,279B61,FFCC33,CC6699,3F5D7D" />
