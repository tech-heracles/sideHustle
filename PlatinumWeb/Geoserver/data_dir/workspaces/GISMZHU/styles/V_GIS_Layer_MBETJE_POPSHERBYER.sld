...
<NamedLayer>
  <Name>V_GIS_Layer_MBETJERIC_SIPASMB</Name>
  <UserStyle>
	<Name>V_GIS_Layer_MBETJERIC_SIPASMB</Name>
	<Title>V_GIS_Layer_MBETJERIC_SIPASMB</Title>
	<Abstract>V_GIS_Layer_MBETJERIC_SIPASMB</Abstract>

	<FeatureTypeStyle> 
	<Rule>
	<Name>  0-20%</Name>     
	  <ogc:Filter>
		<ogc:PropertyIsLessThanOrEqualTo><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>20</ogc:Literal></ogc:PropertyIsLessThanOrEqualTo>
	  </ogc:Filter>
	  <PolygonSymbolizer>
        <Fill><CssParameter name="fill">#800000</CssParameter><CssParameter name="fill-opacity">0.7</CssParameter></Fill>
	...
	<Name>  21-40%</Name>        
		<ogc:Filter>
		  <ogc:And>
			<ogc:PropertyIsGreaterThan><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>20</ogc:Literal></ogc:PropertyIsGreaterThan>
	  ...
	  <PolygonSymbolizer>
        <Fill><CssParameter name="fill">#cc0000</CssParameter><CssParameter name="fill-opacity">0.7</CssParameter></Fill>
        <Stroke><CssParameter name="stroke">#7b3e00</CssParameter><CssParameter name="fill-opacity">1</CssParameter></Stroke>
      </PolygonSymbolizer>	
	</Rule>  
	...
	<Name>  41-50%</Name>     
		<ogc:Filter>
		  <ogc:And>
			<ogc:PropertyIsGreaterThan><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>40</ogc:Literal></ogc:PropertyIsGreaterThan>
	  ...
	  <Name>  51-70%</Name>     
		<ogc:Filter>
		  <ogc:And>
			...
			<ogc:PropertyIsLessThanOrEqualTo><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>70</ogc:Literal></ogc:PropertyIsLessThanOrEqualTo>
		  </ogc:And>
		</ogc:Filter>
	  <PolygonSymbolizer>
        <Fill><CssParameter name="fill">#ff471a</CssParameter><CssParameter name="fill-opacity">0.7</CssParameter></Fill>
        <Stroke><CssParameter name="stroke">#7b3e00</CssParameter><CssParameter name="fill-opacity">1</CssParameter></Stroke>
      </PolygonSymbolizer>	
	</Rule>  
	...
	<Rule>
	  <Name>  71-90%</Name>     
		<ogc:Filter>
		  <ogc:And>
			<ogc:PropertyIsGreaterThan><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>70</ogc:Literal></ogc:PropertyIsGreaterThan>
			<ogc:PropertyIsLessThanOrEqualTo><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>90</ogc:Literal></ogc:PropertyIsLessThanOrEqualTo>
		  </ogc:And>
		</ogc:Filter>
	  <PolygonSymbolizer>
	...
	<Rule>
	  <Name>  91-100%</Name>     
		<ogc:Filter>
		  <ogc:PropertyIsGreaterThan><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>91</ogc:Literal></ogc:PropertyIsGreaterThan>
		</ogc:Filter>
	  <PolygonSymbolizer>
