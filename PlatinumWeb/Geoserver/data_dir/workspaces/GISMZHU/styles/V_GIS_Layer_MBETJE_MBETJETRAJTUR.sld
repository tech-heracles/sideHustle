...
<NamedLayer>
  <Name>V_GIS_Layer_MBETJE_MBULIMKOSTO</Name>
  <UserStyle>
	<Name>V_GIS_Layer_MBETJE_MBETJETRAJTUR</Name>
	<Title>V_GIS_Layer_MBETJE_MBETJETRAJTUR</Title>
	<Abstract>V_GIS_Layer_MBETJE_MBETJETRAJTUR</Abstract>

	<FeatureTypeStyle> 
	<Rule>
	<Name>  0-30%</Name>     
	  <ogc:Filter>
		<ogc:PropertyIsLessThanOrEqualTo><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>30</ogc:Literal></ogc:PropertyIsLessThanOrEqualTo>
	  </ogc:Filter>
	  <PolygonSymbolizer>
	...
	<Rule>
	  <Name>  31-70%</Name>     
		<ogc:Filter>
		  <ogc:And>
			<ogc:PropertyIsGreaterThan><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>30</ogc:Literal></ogc:PropertyIsGreaterThan>
