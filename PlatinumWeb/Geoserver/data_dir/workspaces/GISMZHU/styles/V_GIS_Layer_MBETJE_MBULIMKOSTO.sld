...
<NamedLayer>
  ...
  <UserStyle>
	<Name>V_GIS_Layer_MBETJE_MBULIMKOSTO</Name>
	<Title>V_GIS_Layer_MBETJE_MBULIMKOSTO</Title>
	<Abstract>V_GIS_Layer_MBETJE_MBULIMKOSTO</Abstract>

	<FeatureTypeStyle> 
	<Rule>
	<Name>  0-35%</Name>     
	  <ogc:Filter>
		<ogc:PropertyIsLessThanOrEqualTo><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>35</ogc:Literal></ogc:PropertyIsLessThanOrEqualTo>
	  </ogc:Filter>
	  <PolygonSymbolizer>
	...
	<Rule>
	  <Name>  36-70%</Name>     
		<ogc:Filter>
		  <ogc:And>
			<ogc:PropertyIsGreaterThan><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>35</ogc:Literal></ogc:PropertyIsGreaterThan>
