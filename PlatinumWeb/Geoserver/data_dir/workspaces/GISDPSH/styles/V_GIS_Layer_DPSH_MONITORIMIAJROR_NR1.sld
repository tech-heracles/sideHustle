...
<FeatureTypeStyle>
	...
	<Rule>
	  ...
	  <PointSymbolizer>
        <Graphic>
          <ExternalGraphic>
            <OnlineResource xlink:type="simple" xlink:href="LegendIMG/drone.png"/><Format>image/PNG</Format>
          </ExternalGraphic>
          <Size>40</Size>
        </Graphic>
      </PointSymbolizer>
      ...
      <PointSymbolizer>
        <Graphic>
          <ExternalGraphic>
            <OnlineResource xlink:type="simple" xlink:href="LegendIMG/drone_L.png"/><Format>image/PNG</Format>
          </ExternalGraphic>
          <Size>
