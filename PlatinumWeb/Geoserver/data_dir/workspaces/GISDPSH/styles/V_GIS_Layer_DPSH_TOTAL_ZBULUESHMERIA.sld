...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name></Name>
    <UserStyle>
      <Name>V_GIS_Layer_DPSH_TOTAL_ZBULUESHMERIA</Name>
      
      <FeatureTypeStyle>        
        <Rule>       
          <Name>Te zbuluara në qark</Name>
          <ogc:Filter>
            <ogc:PropertyIsGreaterThan><ogc:PropertyName>VLERA</ogc:PropertyName><ogc:Literal>50</ogc:Literal></ogc:PropertyIsGreaterThan>
          </ogc:Filter>          
          <PolygonSymbolizer>
            <Fill><CssParameter name="fill">#8A2BE2</CssParameter><CssParameter name="fill-opacity">0.01</CssParameter></Fill>
            <Stroke><CssParameter name="stroke">#8A2BE2</CssParameter><CssParameter name="fill-opacity">1</CssParameter></Stroke>
          </PolygonSymbolizer>	
        </Rule> 
        
        <Rule>   
          <Name>Totali i rasteve ne shkalle vendi</Name>
          <ogc:Filter>
          ...
          <PolygonSymbolizer>
            <Fill><CssParameter name="fill">#FF9912</CssParameter><CssParameter name="fill-opacity">0.01</CssParameter></Fill>
            <Stroke><CssParameter name="stroke">#FF9912</CssParameter><CssParameter name="fill-opacity">1</CssParameter></Stroke>
          </PolygonSymbolizer>	
        </Rule>  
        ...
        <Rule>
          <PointSymbolizer>
           ...
           <Graphic>
              <ExternalGraphic>
                <OnlineResource
                  xlink:href="http://chart?cht=p&amp;chf=bg,s,00000000&amp;chd=t:${VLERA},${100 - VLERA}&amp;chco=8A2BE2,FF9912" />
