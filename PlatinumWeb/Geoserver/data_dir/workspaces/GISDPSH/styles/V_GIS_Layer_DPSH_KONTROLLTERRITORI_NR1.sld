...
<FeatureTypeStyle>
	...
	<Rule>
	  ...
	  <PointSymbolizer>
        <Graphic>
          <ExternalGraphic>
            <OnlineResource xlink:type="simple" xlink:href="LegendIMG/pranga.png"/><Format>image/PNG</Format>
          </ExternalGraphic>
          <Size>40</Size>
        </Graphic>
      </PointSymbolizer>
      ...
      <PointSymbolizer>
        <Graphic>
          <ExternalGraphic>
            <OnlineResource xlink:type="simple" xlink:href="LegendIMG/pranga_L.png"/><Format>image/PNG</Format>
          </ExternalGraphic>
          <Size>
