...
<FeatureTypeStyle>
	...
	<Rule>
	  ...
	  <PointSymbolizer>
        <Graphic>
          <ExternalGraphic>
            <OnlineResource xlink:type="simple" xlink:href="LegendIMG/shkresa.png"/><Format>image/PNG</Format>
          </ExternalGraphic>
          <Size>40</Size>
        </Graphic>
      </PointSymbolizer>
      ...
      <PointSymbolizer>
        <Graphic>
          <ExternalGraphic>
            <OnlineResource xlink:type="simple" xlink:href="LegendIMG/shkresa_L.png"/><Format>image/PNG</Format>
          </ExternalGraphic>
          <Size>
