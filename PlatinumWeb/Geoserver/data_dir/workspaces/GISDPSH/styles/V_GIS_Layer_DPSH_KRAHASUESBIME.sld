...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name></Name>
    <UserStyle>
      <Name>V_GIS_Layer_DPSH_KRAHASUESBIME</Name>
      <FeatureTypeStyle>
        <Rule>       
          <Name> Krahasueseve Mujore sipas DVP </Name>
          <PolygonSymbolizer>
            <Stroke>
        ...
        <Rule>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource
                        xlink:href="http://chart?cht=bvg&amp;chf=bg,s,FFE1FF90&amp;chs=600x250&amp;chma=30,30,30,30&amp;chtt=Bime te asgjesuara DVP+${PERSHKRIMI}&amp;chts=000000,20&amp;chxt=x,y,t&amp;chxl=0:|01|02|03|04|05|06|07|08|09|10|11|12|1:|Min|Mes|Max|2:|${VL1}|${VL2}|${VL3}|${VL4}|${VL5}|${VL6}|${VL7}|${VL8}|${VL9}|${VL10}|${VL11}|${VL12}&amp;chxs=0,000000|1,000000|2,000000&amp;chd=t:${P1}|${P2}|${P3}|${P4}|${P5}|${P6}|${P7}|${P8}|${P9}|${P10}|${P11}|${P12}&amp;chco=279B61" />
        ...
        <Rule>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource
                        xlink:href="http://chart?cht=bvg&amp;chf=bg,s,FFE1FF80&amp;chs=500x300&amp;chma=0,0,0,0&amp;chd=t:${P1}|${P2}|${P3}|${P4}|${P5}|${P6}|${P7}|${P8}|${P9}|${P10}|${P11}|${P12}&amp;chco=279B61" />
                <Format>application/chart</Format>
              </ExternalGraphic>
              <Size>
                <ogc:Function name="Categorize">
