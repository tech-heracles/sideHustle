...
<NamedLayer>
<Name>V_GIS_Layer_NENSTACIONE_NR3</Name>
<UserStyle>
<Name>V_GIS_Layer_NENSTACIONE_NR3</Name>
...
<FeatureTypeStyle>
	...
	<Rule>
      ...
      <PolygonSymbolizer>
        <Fill><CssParameter name="fill">#f6a2a2</CssParameter><CssParameter name="fill-opacity">0.2</CssParameter></Fill>
        <Stroke><CssParameter name="stroke">#ff0000</CssParameter><CssParameter name="fill-opacity">1</CssParameter></Stroke>
      </PolygonSymbolizer>	
	  
	  <PointSymbolizer>
        <Graphic>
          <ExternalGraphic>
            <OnlineResource xlink:type="simple" xlink:href="LegendIMG/nenstacioneNR3.png"/><Format>image/PNG</Format>
          </ExternalGraphic>
          <Size>25</Size>
        </Graphic>
      </PointSymbolizer>
