<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UrdherPagesa.aspx.cs" Inherits="PlatinumWeb.UrdherPagesa" %>
...
<%--    <script src="js/myCookies-IMB.2.1.js?versioni22" type="text/javascript"></script>
    ...
    <script src="js/aspx.js/UrdherPagesa.aspx-IMB.2.1.js?versioni22" type="text/javascript"></script>--%>
        <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myCookies-IMB.2.1.js;~/js/aspx.js/UrdherPagesa.aspx-IMB.2.1.js&v76""
...
<body>
        ...
        <tbody>
            <tr>
                ...
                <td class="renditKontrolleCellMeWidth33">
                    <dx:ASPxComboBox ID="cmbKonfigurimi" runat="server" ClientInstanceName="cmbKonfigurimi" ShowShadow="False" 
                        Width="100%" ValueType="System.String" SettingsLoadingPanel-ImagePosition="Top" AnimationType="None">
    ...
    <asp:UpdatePanel ID="pnlKryesor" runat="server">
        <ContentTemplate>
            ...
            <br />
            <dx:ASPxGridView ID="gvUrdherPagesa" ClientInstanceName="gvUrdherPagesa" runat="server"
                Width="100%"    
                OnDataBound="gvUrdherPagesa_DataBound" SettingsBehavior-SortMode="Custom" OnCustomColumnSort="gvUrdherPagesa_CustomColumnSort"
                OnAfterPerformCallback="gvUrdherPagesa_AfterPerformCallback"
                OnCustomCallback="gvUrdherPagesa_CustomCallback" OnCustomJSProperties="gvUrdherPagesa_CustomJSProperties"
                OnProcessColumnAutoFilter="gvUrdherPagesa_ProcessColumnAutoFilter" OnHeaderFilterFillItems="gvUrdherPagesa_HeaderFilterFillItems"  >
                <Styles    >
                            ...
                            <tr>
                                <td>
                                    <dx:ASPxButton ID="ASPxButton2" runat="server" Text="Zgjidh kolonat" AutoPostBack="false"
                                        ...
                                        <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,gvUrdherPagesa)}"
