<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaLidhjaDokumentave.aspx.cs"
    Inherits="PlatinumWeb.ListaLidhjaDokumentave" %>
...
<%--    <script src="js/jquery-1.10.2.min.js" type="text/javascript"></script>
    ...
    <script src="js/aspx.js/ListaLidhjaDokumentave.aspx-IMB.2.1.js?versioni22" type="text/javascript"></script>--%>
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/aspx.js/ListaLidhjaDokumentave.aspx-IMB.2.1.js&v76""
...
<body>
    ...
    <asp:UpdatePanel ID="pnlKryesor" runat="server">
        <ContentTemplate>
            ...
            <br />
            <dx:ASPxGridView ID="gvDokumenta" ClientInstanceName="gvDokumenta" runat="server"
                Width="100%" OnDataBound="gvDokumenta_DataBound" OnAfterPerformCallback="gvDokumenta_AfterPerformCallback"
                OnCustomCallback="gvDokumenta_CustomCallback" OnCustomJSProperties="gvDokumenta_CustomJSProperties"
                OnProcessColumnAutoFilter="gvDokumenta_ProcessColumnAutoFilter" OnHeaderFilterFillItems="gvDokumenta_HeaderFilterFillItems">
                <Styles>
