<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_RegjistrimNdryshimCmimSasi.aspx.cs" Inherits="PlatinumWeb.Shto_RegjistrimNdryshimCmimSasi" %>
...
<body>
    ...
    valueChangedPeriudha();}" />
                                                        ...
                                                        <tr>
                                                            <td style="width: 50%">
                                                                <dx:ASPxButton ID="btnMbyllur" runat="server" Text="-" Width="100%" AutoPostBack="false"
                                                                    Height="25px" Font-Size="9" Font-Bold="true">
                                                            ...
                                                            <td style="width: 50%">
                                                                <dx:ASPxButton ID="btnHapur" runat="server" Text="+" Width="100%" AutoPostBack="false"
                                                                    Height="25px" Font-Size="9">
                                                                    <ClientSideEvents Click="function (s,e){RuajHapurMbyllurplus(true)}" />
                                                                </dx:ASPxButton>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <dx:ASPxNavBar ID="ASPxNavBar1" runat="server" ClientInstanceName="navbar" Width="100%"
                                                        ...
                                                        <Groups>
                                                            <dx:NavBarGroup Text="Info Artikulli" Expanded="true" Name="Artikulli">
                                                                <ContentTemplate>
                ...
                <ClientSideEvents PaneCollapsed="function(s, e) { spliterPaneCollapsed(s,e);}"
                    PaneExpanded="function(s, e) { spliterPaneCollapsed(s,e);}"
                    PaneCollapsing="function(s, e) { spliterPaneCollapsing(s,e);}"
                    PaneExpanding="function(s, e) { spliterPaneExpanding(s,e);}"
                    PaneResized="function(s, e) { spliterPaneCollapsed(s,e);}" />
                <Styles>
                </Styles>
                <Images>
                </Images>
