<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABShpenzimeOperative.aspx.cs" Inherits="PlatinumWeb.ABShpenzimeOperative" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="dvAktiviteti" style="display: block;">
             ...
             <dx:ASPxGridView ID="gvShpenzimeOperative"
                Width="100%" ToolTip=": Projekt-buxheti per vititn 2016 ne zerin 'Shpenzime operative'" runat="server"
                OnBatchUpdate="gvShpenzimeOperative_BatchUpdate"
                OnAfterPerformCallback="gvShpenzimeOperative_AfterPerformCallback" OnHtmlFooterCellPrepared="gvShpenzimeOperative_HtmlFooterCellPrepared"
                OnCustomCallback="gvShpenzimeOperative_CustomCallback"  OnDataBound="gvShpenzimeOperative_DataBound" OnCustomUnboundColumnData="gvShpenzimeOperative_CustomUnboundColumnData">
             ...
             <table class="renditKontrolle">
                <tbody>
                    <tr>
                        ...
                        <td class="renditKontrolleCellMeWidth33">
                          <dx:ASPxSpinEdit runat="server" Width="100%" ID="nrCeshtjeshVitiParaArdhes" ClientInstanceName="nrCeshtjeshVitiParaArdhes" Caption="Numri i ceshtjeve (Viti kaluar)"></dx:ASPxSpinEdit>
                        </td>
                        <td class="renditKontrolleLabelMeWidth33">
                        <dx:ASPxSpinEdit runat="server" Width="100%" ID="nrCeshtjeshVitiAktual" ClientInstanceName="nrCeshtjeshVitiAktual" Caption="Numri i ceshtjeve (Aktual)"></dx:ASPxSpinEdit>
                        </td>
                        <td class="renditKontrolleCellMeWidth33">
                             <dx:ASPxSpinEdit runat="server" Width="100%" ID="nrCeshtjeshVitiPasardhes" ClientInstanceName="nrCeshtjeshVitiPasardhes" Caption="Numri i ceshtjeve (Viti ardhshem)"></dx:ASPxSpinEdit>
                        </td>
                    </tr>
                </tbody>
            </table>
