<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SkedulimProdhimi.aspx.cs" Inherits="PlatinumWeb.SkedulimProdhimi" %>
    ...
    Utils.shfaqLoadingGif();;
        ...
        <asp:UpdatePanel ID="pnlKryesor" runat="server">
            <ContentTemplate>
                ...
                <br />
                <dx:ASPxGridView ID="gvSkedulimi" ClientInstanceName="gvSkedulimi" runat="server"
                    Width="100%" OnDataBound="gvSkedulimi_DataBound" OnAfterPerformCallback="gvSkedulimi_AfterPerformCallback"
                    OnCustomCallback="gvSkedulimi_CustomCallback" OnCustomJSProperties="gvSkedulimi_CustomJSProperties"
                    OnProcessColumnAutoFilter="gvSkedulimi_ProcessColumnAutoFilter" OnHeaderFilterFillItems="gvSkedulimi_HeaderFilterFillItems">
                    <Templates>
                        <TitlePanel>
                            <table>
                                <tr>
                                    <td>
                                        <dx:ASPxButton ID="ASPxButton2" runat="server" ToolTip="Zgjidh kolonat" AutoPostBack="false"
                                            ...
                                            <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,gvSkedulimi)}"
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                            ...
                                            <ClientSideEvents Click="function(s, e) { gvSkedulimi.SelectAllRowsOnPage(); }" />
                                        </dx:ASPxButton>
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                            ...
                                            <ClientSideEvents Click="function(s, e) { gvSkedulimi.SelectRows(); }" />
                                        </dx:ASPxButton>
                                    </td>
                                    <td>
                                        <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                            ...
                                            <ClientSideEvents Click="function(s, e) { gvSkedulimi.UnselectRows(); }" />
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                            </table>
