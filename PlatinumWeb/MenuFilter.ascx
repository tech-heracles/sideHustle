<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MenuFilter.ascx.cs"
    Inherits="PlatinumWeb.MenuFilter" %>
...
<table align="center">        
    <tr>
        <td>
            <dx:ASPxComboBox ID="btnFiltra" ClientIDMode="Static" runat="server" ClientInstanceName="btnFiltra"  
                    AutoPostBack="False" ClientSideEvents-EndCallback="function(s, e){ if(typeof(SetBtnFiltraValue) != 'undefined') SetBtnFiltraValue(s, e);}"
        ...
        <td>
            <dx:ASPxButton ID="Button1" runat="server" Text="" ClientInstanceName="btnRuaj"
                CausesValidation="False" ClientIDMode="Static" AutoPostBack="True">
                <Image Url="~/images/new/ruaj.png">
                </Image>
