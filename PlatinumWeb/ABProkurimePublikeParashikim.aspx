<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABProkurimePublikeParashikim.aspx.cs" Inherits="PlatinumWeb.ABProkurimePublikeParashikim" %>
...
<body>
    ...
    <dx:ASPxLoadingPanel ID="LoadingPanel" runat="server" ClientInstanceName="LoadingPanel"
        ...
        <div id="dvAktiviteti" style="display: block;">
             ...
             <dx:ASPxGridView ID="gvProkurimetParashikim"
                Width="100%" ToolTip="Regjistrim i parashikimit te prokurimeve publike" runat="server"
                OnBatchUpdate="gvProkurimetParashikim_BatchUpdate"
                OnAfterPerformCallback="gvProkurimetParashikim_AfterPerformCallback" OnHtmlFooterCellPrepared="gvProkurimetParashikim_HtmlFooterCellPrepared"
                OnCustomCallback="gvProkurimetParashikim_CustomCallback"  OnDataBound="gvProkurimetParashikim_DataBound" >
