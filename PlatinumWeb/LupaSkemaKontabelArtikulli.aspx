<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaSkemaKontabelArtikulli.aspx.cs"
    Inherits="PlatinumWeb.LupaSkemaKontabelArtikulli" %>
...
<head id="Head1" runat="server">
 ...
 <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaSkemaKontabelArtikulli.aspx-IMB.2.1.js&v76""
...
<body onload="Init()">
    ...
    <dx:ASPxGlobalEvents ID="ASPxGlobalEvents1" runat="server">
        <%--<ClientSideEvents EndCallback="function(s,e){try{ window.parent.  window.parent.    SessionTimeout.sendKeepAlive();} catch (ee){window.parent.  window.parent.  window.parent.  SessionTimeout.sendKeepAlive();
        }}" />--%>
    </dx:ASPxGlobalEvents>
    <div id='div' style="display: none">
        <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" ClientInstanceName="panel"
            Width="100%" Height="100%" HeaderText="Zgjidh Skemen" Font-Bold="True"  
            ShowHeader="False">
                            ...
                            <table width="100%">
                                <tr>
                                    <td>
                                        ...
                                        <dx:ASPxGridView ID="gvLupaSkemaKontArt" runat="server" ClientInstanceName="gvLupaSkemaKontArt"
                                            OnDataBound="gvLupaSkemaKontArt_DataBound" OnAfterPerformCallback="gvLupaSkemaKontArt_AfterPerformCallback"
                                            OnHeaderFilterFillItems="gvLupaSkemaKontArt_HeaderFilterFillItems" Width="90%"
                                            OnCustomCallback="gvLupaSkemaKontArt_CustomCallback">
                                            ...
                                            <ClientSideEvents RowDblClick="function(s, e) { OnGridSelectionChanged(); }" EndCallback="function(s, e) {  }"
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                    <ContentTemplate>
                                                                        <dx:ASPxButton ID="LupaFiltri_ASPxButton" runat="server"  
                                                                            ...
                                                                            <ClientSideEvents Click="function(s, e) {                                                   
                                                       Filtra_Click(s,e,'<%= Container.ClientID %>'); 
                                                        }" />
                                                                        </dx:ASPxButton>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
