<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_Aktivitete.aspx.cs"
    Inherits="PlatinumWeb.Shto_Aktivitete" %>
...
<head id="Head1" runat="server">
 ...
 <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    ...
    <script src="js/aspx.js/Shto_Aktivitete.aspx-IMB.2.1.js?versioni22" type="text/javascript"></script>--%>
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/Shto_Aktivitete.aspx-IMB.2.1.js&v76"
...
<body>
                    ...
                    <dxtc:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                        <ContentCollection>
                            <dxw:ContentControl>
                                ...
                                <dx:ASPxGridView ID="gvAktivitetet" ClientInstanceName="gvAktivitetet" runat="server"
                                    Width="100%" OnDataBound="gvAktivitetet_DataBound" OnAfterPerformCallback="gvAktivitetet_AfterPerformCallback"
                                    OnHeaderFilterFillItems="gvAktivitetet_HeaderFilterFillItems" OnProcessColumnAutoFilter="gvAktivitetet_ProcessColumnAutoFilter"
                                    OnCustomJSProperties="gvAktivitetet_CustomJSProperties" OnCustomCallback="gvAktivitetet_CustomCallback"
                                    OnAutoFilterCellEditorInitialize="gvAktivitetet_AutoFilterCellEditorInitialize">
                                    <Templates>
                                        <TitlePanel>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <dx:ASPxButton ID="ASPxButton2" runat="server" ToolTip="Zgjidh kolonat" AutoPostBack="false"
                                                            ...
                                                            <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,gvAktivitetet)}"
                                                    ...
                                                    <td>
                                                        <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                                            ...
                                                            <ClientSideEvents Click="function(s, e) { gvAktivitetet.SelectAllRowsOnPage(); }" />
                                                        </dx:ASPxButton>
                                                    ...
                                                    <td>
                                                        <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                                            ...
                                                            <ClientSideEvents Click="function(s, e) { gvAktivitetet.SelectRows(); }" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                                            ...
                                                            <ClientSideEvents Click="function(s, e) { gvAktivitetet.UnselectRows(); }" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                </tr>
                                            </table>
	...
	BeginCallback(s,e);
                    ...
                    <dxtc:TabPage Name="Aktiviteti" Text="Aktiviteti">

                        <ContentCollection>
                            <dxw:ContentControl ID="ContentControl3" runat="server">
                                <table id="tblAktiviteti" class="renditKontrolle">
                                    <tbody>
                                    </tbody>
                                </table>
                                <%--<div id="dvlblKodi">--%>
                                ...
                                <dx:ASPxTextBox ID="txtEmertimi" runat="server" Width="100%" AutoPostBack="false"
                                ...
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="cmbNjesiKohe" ID="lblNjesiKohe"
                                    runat="server" ClientInstanceName="lblNjesiKohe" Text="Njesi Kohe:">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <%--<div id="dvcmbNjesiKohe">--%>
                                <dx:ASPxComboBox ID="cmbNjesiKohe" runat="server" ClientInstanceName="cmbNjesiKohe"
                                    Width="100%" SettingsLoadingPanel-ImagePosition="Top" ShowShadow="False">
                                    <ClientSideEvents SelectedIndexChanged="function (s,e) {ndryshoKosto();}" />
                                    <DropDownButton>
                                        <Image>
                                            <SpriteProperties HottrackedCssClass="dxEditors_edtDropDownHover_Aqua" PressedCssClass="dxEditors_edtDropDownPressed_Aqua" />
                                        </Image>
                                ...
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="txtKohaPlan" ID="lblKohaPlan" runat="server"
                                    Text="Koha Plan:" ClientInstanceName="lblKohaPlan">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <div id="dvtxtKohaPlan">
                                    <dx:ASPxTextBox ID="txtKohaPlan" ClientInstanceName="txtKohaPlan" runat="server"
                                        DisplayFormatString="0.00" Width="100%">
                                        <ClientSideEvents TextChanged="function (s,e) {kontrolloKoha();}" />
                                        <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" CausesValidation="True"
                                            ValidationGroup="entries" SetFocusOnError="True">
                    ...
                    <dxtc:TabPage Name="Burimet" Text="Burimet">

                        <ContentCollection>
                            <dxw:ContentControl ID="content">
                                <table id="tblBurimet" class="renditKontrolle">
                                    <tbody>
                                    </tbody>
                                </table>
                                <%--<div id="dvlblDateAkt">--%>
                                ...
                                <asp:UpdatePanel ID="cmbNdryshimi_pnlNdryshimi" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <dx:ASPxComboBox ID="cmbNdryshimi" runat="server" ClientInstanceName="cmbNdryshimi"
                                            ...
                                            <ClientSideEvents SelectedIndexChanged="function (s,e){gvTrupi.PerformCallback('ndryshodate');}" />
                                            <DropDownButton>
                                                <Image>
                                                    <SpriteProperties HottrackedCssClass="dxEditors_edtDropDownHover_Aqua" PressedCssClass="dxEditors_edtDropDownPressed_Aqua" />
                                                </Image>
