...
{
    /// <summary>
    /// Faqja e shtimit te objektivave
    /// </summary>
    public partial class Shto_ObjektivaKosto : MyPageBase
    {
        private const string prefixMesazhNjejes = "Objektiva me Kod: ";
        private const string prefixMesazhShumes = "Objektivat me Kod: ";
        ...
        private const string gabim2aktivitetenegride = "GABIM: Ndodhen 2 objektiva me te njejten id ne gride";
        private const string mesazhZgjidhniNje = "Ju lutem zgjidhni te pakten nje objektive!";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                konfiguroVleraFillestare(idNdermarrje, rm, cultinf);
                ...
                konfiguroGride(idNdermarrje, cmbKonfigurimi.Text.Split(';')[0], 905);
                GridUtil.PercaktoVisibleColumnsGridSipasKodKonfigurimi(idNdermarrje, "gvObjektiva", gvObjektiva, cmbKonfigurimi.Text.Split(';')[0], 905.ToString(), DbCore.mySessionObjects.ktheGjuhe(Session));
                ...
                tedrejtaInfo.merrTeDrejtaPerKeteKomponente(idperdoruesi, idNdermarrje, DbCore.mySessionObjects.ktheIdVitNdermarrje(Session), "Shto_ObjektivaKosto.aspx");
            ...
            GridUtil.konfigGrideListeEMadhePaTheme(gvObjektiva, "Id");
            percaktoTemplateMenu(idgjuha, idviti, idperdoruesi, idNdermarrje, ASPxMenu1);
            mbushComboBoxFiltra(DbCore.mySessionObjects.ktheGjuhe(Session), idNdermarrje, int.Parse(cmbKonfigurimi.Value.ToString()));
            GridUtil.EmrateButonaveMbiGride(gvObjektiva);
        }
        ...
        private void EmrateTabeve(System.Resources.ResourceManager rm, System.Globalization.CultureInfo cultinf)
        {
            ...
            ASPxPageControl1.TabPages[1].Text = rm.GetString("objektivaTab", cultinf);
        }
        ...
        {
            clsToolbarConfig.mbushComboBoxFiltraMeValFieldTextField(idGjuha, idNdermarrje, "gvObjektiva", "Shto_ObjektivaKosto.aspx", "IdFiltra", "FiltraShenime", idkonfig);
        }
        ...
        {
            clsToolbarConfig.percaktoTemplateMenu(idGjuha, idViti, idPerdorues, idNdermarrje, aSPxMenu1, "Shto_ObjektivaKosto.aspx", this, MenuInfo, Ruaj_ASPxButton_Click, FshiFilter_ASPxButton_Click, hfShtimModifikim.Value == "modifikim" ? false : true, false, false, DbCore.mySessionObjects.merrEshteMemeSesioni(Session));
        }
        ...
        protected void RuajKolona_Click(object sender, EventArgs e)
        {
            ...
            var mesazh = GridUtil.ruajFiltra(idNdermarrje, idperdoruesi, idgjuha, "gvObjektiva", "Shto_ObjektivaKosto.aspx", "FilterDefault", gvObjektiva.FilterExpression, gvObjektiva, "Kodi", idkonf, out idfiltri);
            if (!mesazh.Status)
            {
                clsMenuInfo.ShtoMesazhGabimi(MenuInfo, mesazh.PershkrimMesazhi, pnlMesazhi);
                return;
            }
            mesazh = GridUtil.ruajkonfigurimgride(gvObjektiva, cmbKonfigurimi.Text, idNdermarrje, idperdoruesi, 905, idfiltri, idviti, DbCore.mySessionObjects.ktheCultureInfo(Session), DbCore.mySessionObjects.ktheGjuhe(Session));/// ruan konfigurimin e grides dhe filtrin

            clsToolbarConfig.mbushComboBoxFiltra(idgjuha, idNdermarrje, "gvObjektiva", int.Parse(cmbKonfigurimi.Value.ToString()), "Shto_ObjektivaKosto.aspx");
        ...
        /// <param name="sender">derguesi</param>
        /// <param name="e"> argumentat</param>
        protected void gvObjektiva_DataBound(object sender, EventArgs e)
        {
            if (gvObjektiva.Columns["#"] == null)
            {
                var check = new GridViewCommandColumn("#") { ShowSelectCheckbox = true, Width = System.Web.UI.WebControls.Unit.Percentage(2) };

                gvObjektiva.Settings.ShowFilterRow = true;
                gvObjektiva.Settings.ShowFilterRowMenu = true;
                gvObjektiva.Columns.Add(check);
                gvObjektiva.KeyFieldName = "Id";
                gvObjektiva.SettingsBehavior.AllowSelectByRowClick = true;
                gvObjektiva.SettingsBehavior.AllowFocusedRow = true;
            }
        }
        ...
        private void konfiguroGride(int idNdermarrje, string kodKonfigurimi, int idKomponente)
        {
            ...
            gvObjektiva.Columns["#"].VisibleIndex = 0;
        }
        ...
        /// <param name="sender"> derguesi</param>
        /// <param name="e"> argumentat</param>
        protected void gvObjektiva_AfterPerformCallback(object sender, ASPxGridViewAfterPerformCallbackEventArgs e)
        {
            if (e.CallbackName == "COLUMNMOVE" && gvObjektiva.AllColumns[int.Parse(e.Args[0])].Width.Value == 0)
            {
                gvObjektiva.AllColumns[int.Parse(e.Args[0])].Width = System.Web.UI.WebControls.Unit.Percentage(3);
            }
        ...
        /// <param name="sender"> derguesi</param>
        /// <param name="e">argumentat</param>
        protected void gvObjektiva_HeaderFilterFillItems(object sender, ASPxGridViewHeaderFilterEventArgs e)
        {
        ...
        public void FshiFilter_ASPxButton_Click(object sender, EventArgs e)
        {
            ...
            var koka = new DbCore.DbAdmin.clsGridaKoka(DbCore.mySessionObjects.ktheGjuhe(Session), "gvObjektiva", "Shto_ObjektivaKosto.aspx", DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session), int.Parse(cmbKonfigurimi.Value.ToString()));
        ...
        protected void Ruaj_ASPxButton_Click(object sender, EventArgs e)
        {
            ...
            var filtri = new DbCore.DbAdmin.clsFiltraGrida() { FiltraKodi = cmbFiltra.Text, FiltraShenime = cmbFiltra.Text, FiltraUniversal = false };
            var idNdermarrje = DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session);
            var koka = new DbCore.DbAdmin.clsGridaKoka(DbCore.mySessionObjects.ktheGjuhe(Session), "gvObjektiva", "Shto_ObjektivaKosto.aspx", idNdermarrje, int.Parse(cmbKonfigurimi.Value.ToString()));
            filtri.GridaKokaId = koka.IdGridaKoka;
            filtri.FiltraVlera = gvObjektiva.FilterExpression;
            filtri.KoloneRenditje = GridUtil.ktheKolRenditjeNgaGridaPerRuajtje("Kodi", gvObjektiva);
            //var kolona = gvObjektiva.GetSortedColumns();
            //if (kolona.Count > 0)
            //{
        ...
        protected void ButtonOk_Click2(object sender, EventArgs e)
        {
            ...
            {
                rreshtat = gvObjektiva.GetSelectedFieldValues("Id");
            }
            else
            {
            ...
            {
                var skema = new DbCore.DbQendraKosto.clsObjektivaKosto(Convert.ToInt32(id));
                var konf = new DbCore.DbShare.clsKonfigurimAmbjenti() { IdKonfigAmbjente = skema.IdKonfig };
                konf.mbushKonfigAmbjSipasId(konf.IdKonfigAmbjente);
                var lidhur = dbRegjistrim.eshteDokumentiILidhurCelje(skema.Id.ToString(), konf.IdNivel.ToString());
                if (lidhur)
                {
                ...
                if (mesazh.Status)
                {
                    hiqNgaGrida(skema.Id, skema.IdNdermarje);
        ...
        {
            if (gvObjektiva.DataSource != null)
            {
                var dt = (DataTable)gvObjektiva.DataSource;
                var drs = dt.Select(String.Format("Id = '{0}'", Id));
                if (drs.Length > 1)
                {
                ...
                var dr = drs[0];
                dt.Rows.Remove(dr);
                gvObjektiva.DataBind();
            }
            else
            {
                mbushGridNgaDB(idndermarje);
            }
        }
        ...
        private void shtoNeGrid(int idNdermarrje, int Id)
        {
            if (gvObjektiva.DataSource != null)
            {
                ...
                var newArtDr = DbCore.DbQendraKosto.colObjektivaKosto.merrObjektivaKostoDR(Id);
        ...
        /// </summary>
        /// <param name="idNdermarrje">id e ndermarjes</param>
        private void konfiguroVleraFillestare(int idNdermarrje, System.Resources.ResourceManager rm, System.Globalization.CultureInfo cultinf)
        {
            ASPxPageControl1.ActiveTabIndex = 0;
            ConfigureAspxComboBox.mbushComboKonfigurimeshSipasKategorise(idperdoruesi, idNdermarrje, cmbKonfigurimi, 74, rm, cultinf, idgjuha);
        ...
        private void mbushGridNgaSession(int idNdermarrje)
        {
            ...
            {
                gvObjektiva.DataSource = tmpObject;
                gvObjektiva.DataBind();
                tmpObject.Dispose();
            }
        }
        ...
        {
            var dt = DbCore.DbQendraKosto.colObjektivaKosto.merrObjektivaKostoDT(idNdermarrje);
            DbCore.mySessionObjects.ruajGrideNeSession(Session, dt);
            gvObjektiva.DataSource = dt;
            gvObjektiva.DataBind();
            dt.Dispose();
        }
        ...
        /// ruan objektivin
        /// </summary>
        private void ruajObjektiv()
        {
            var objektiv = new DbCore.DbQendraKosto.clsObjektivaKosto();
            ...
            else
            {
                ...
                if (hfShtimModifikim.Value == "shtim" || hfShtimModifikim.Value == "klonim")
                {
                    ...
                    mesazh = objektiv.ruajObjektivKosto();
                    eshteShtim = true;
                }
                else
                {
                    ...
                    var dbRegjistrim = new DbCore.DbRegjistrim.clsDatabaseRegjistrim();
                    var konf = new DbCore.DbShare.clsKonfigurimAmbjenti() { IdKonfigAmbjente = objektiv.IdKonfig };
                    konf.mbushKonfigAmbjSipasId(konf.IdKonfigAmbjente);
                    eshteShtim = false;
                    objektiv.Id = int.Parse(hfId.Value);
                    var lidhur = dbRegjistrim.eshteDokumentiILidhurCelje(objektiv.Id.ToString(), konf.IdNivel.ToString());
                    if (lidhur.ToString() != hfLidhur.Value)
                    {
                        mesazh.Status = false;
                        mesazh.PershkrimMesazhi = "Objektivi eshte i lidhur";
                    }
                    else
                    {
                        mesazh = objektiv.modifikoObjektivKosto();
                    }
                    dbRegjistrim.Dispose();
                }
                if (mesazh.Status == true)
                {
                    ...
                    if (eshteShtim)
                    {
                        shtoNeGrid(DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session), objektiv.Id);
                    }
                    else
                    {
                        modifikoNeGrid(DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session), objektiv.Id);
                    }
                    hfStatusi.Value = "true";
                }
                else
        ...
        /// <summary>
        /// krijon objektivin sipas te dhenave
        /// </summary>
        /// <returns> objektivin me te dhenat</returns>
        private DbCore.DbQendraKosto.clsObjektivaKosto krijoObjektiv()
        {
            bool isshtim;
            if (hfShtimModifikim.Value == "shtim" || hfShtimModifikim.Value == "klonim")
            {
            ...
            var objektiv = new DbCore.DbQendraKosto.clsObjektivaKosto(0, txtKodi.Text, txtPershkrimi.Text, dteNga.Date, cbAktiv.Checked, konfig.IdKonfigAmbjente, dteNe.Date, idNdermarrje, idperdoruesi, idstatusdok, isshtim);
        ...
        /// <param name="sender">derguesi</param>
        /// <param name="e">argumentat</param>
        protected void gvObjektiva_CustomJSProperties(object sender, ASPxGridViewClientJSPropertiesEventArgs e)
        {
            e.Properties["cpPageIndex"] = gvObjektiva.PageIndex;
            e.Properties["cpPageRow"] = gvObjektiva.SettingsPager.PageSize;
            e.Properties["cpRowCount"] = gvObjektiva.VisibleRowCount;
        }
        ...
        /// <param name="sender">derguesi</param>
        /// <param name="e">argumentat</param>
        protected void gvObjektiva_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (arr.Length == 3)
            {
                ...
                {
                    gvObjektiva.FilterExpression = string.Empty;
                }
                else
                {
                    var filtra = new DbCore.DbAdmin.clsFiltraGrida();
                    ...
                    if (filtra.FiltraKodi != null)
                    {
                        gvObjektiva.FilterExpression = filtra.FiltraVlera;
                        GridUtil.renditGriden(filtra.KoloneRenditje, gvObjektiva);
                        hfStatusi.Value = "true";
                    }
                    else
                    {
            ...
            gvObjektiva.Selection.UnselectAll();
        }
        ...
        /// <param name="sender">derguesi</param>
        /// <param name="e">argumentat</param>
        protected void gvObjektiva_AutoFilterCellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
        }
        ...
        /// <param name="sender">derguesi</param>
        /// <param name="e">argumentat</param>
        protected void gvObjektiva_ProcessColumnAutoFilter(object sender, ASPxGridViewAutoFilterEventArgs e)
        {
        }
    }
}
