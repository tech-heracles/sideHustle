<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABParashikimShpenzPersoneli.aspx.cs" Inherits="PlatinumWeb.ABParashikimShpenzPersoneli" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="dvAktiviteti" style="display: block;">
             ...
             <dx:ASPxGridView ID="gvParashikimShpenzPersoneli"
                Width="100%" ToolTip="Parashikimi i shpenzimeve per personelin per vitin pasardhes" runat="server"
                OnBatchUpdate="gvParashikimShpenzPersoneli_BatchUpdate"
                OnAfterPerformCallback="gvParashikimShpenzPersoneli_AfterPerformCallback" OnHtmlFooterCellPrepared="gvParashikimShpenzPersoneli_HtmlFooterCellPrepared"
                OnCustomCallback="gvParashikimShpenzPersoneli_CustomCallback"  OnDataBound="gvParashikimShpenzPersoneli_DataBound" >
