<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaNenGrupLlogari.aspx.cs"
    Inherits="PlatinumWeb.LupaNenGrupLlogari" %>
...
<head id="Head1" runat="server">
  ...
  <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaNenGrupLlogari.aspx-IMB.2.1.js&v76""
...
<body onload="Init()">
    <form id="form1" runat="server">
        ...
        <dx:ASPxGlobalEvents ID="ASPxGlobalEvents1" runat="server">
            ...
            if (window.parent.identikuesPerPopupNenGrupeLlogari == 'LlogariShpejte')
        ...
        <div id='div' style="display: none">
            <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" ClientInstanceName="panel"
                Width="100%" HeaderText="Zgjidh nengrupin e llogarise" ShowHeader="False">
                <%--Width="300px"--%>
                <PanelCollection>
                    <dx:PanelContent>
                        <%-- shtuar--%>
                        ...
                        <asp:UpdatePanel ID="pnlKryesor" runat="server">
                            <ContentTemplate>
                                <table width="100%">
                                    <tr>
                                        <td>
                                            <dx:ASPxGridView ID="gvLupaNGrupLlog" runat="server" ClientInstanceName="gvLupaNGrupLlog"
                                                OnDataBound="gvLupaNGrupLlog_DataBound" OnAfterPerformCallback="gvLupaNGrupLlog_AfterPerformCallback"
                                                Width="100%" OnCustomCallback="gvLupaNGrupLlog_CustomCallback">
