<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecetaOptike.aspx.cs" Inherits="PlatinumWeb.RecetaOptike" %>
...
<body>
    ...
    <asp:UpdatePanel ID="pnlKryesor" runat="server">
        <ContentTemplate>
            ...
            <br />
            <dx:ASPxGridView ID="gvRecetaOptike" ClientInstanceName="gvRecetaOptike" runat="server"
                Width="100%" OnDataBound="gvRecetaOptike_DataBound" OnAfterPerformCallback="gvRecetaOptike_AfterPerformCallback"
                OnCustomCallback="gvRecetaOptike_CustomCallback" OnCustomJSProperties="gvRecetaOptike_CustomJSProperties"
                OnProcessColumnAutoFilter="gvRecetaOptike_ProcessColumnAutoFilter" OnHeaderFilterFillItems="gvRecetaOptike_HeaderFilterFillItems" SettingsPager-PageSize="20">
