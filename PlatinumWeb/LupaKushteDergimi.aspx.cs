...
namespace PlatinumWeb
{
    public partial class LupaKushteDergimi : MyPageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Container.Attributes["src"] = "LupaFiltra.aspx?grida=gvLupaKushtDerg&page=LupaKushteDergimi.aspx";
        }
        ...
        //    if (ofilter != null)
        //        gvLupaKushtDerg.FilterExpression = ofilter.FiltraVlera;
        //}
        private void mbushPopUpListeKushteshDergimi()
        {
            ...
            //DbCore.DbAdmin.colKushteDergimi colKushtet = dbAdmin.merrKushtetDergimit(DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session));
        ...
        private void konfiguroPopupGride(int idKonfigambjenti, bool visibleIndex, bool kerkosaposhkruar)
        {
            ...
            //funk.konfiguroGrideListeMadhe(gvLupaKushtDerg, "IdKushtDergimi");
        ...
        //    DbCore.DbAdmin.clsGridaKoka koka = new DbCore.DbAdmin.clsGridaKoka("gvLupaKushtDerg", "LupaKushteDergimi.aspx", DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session));
        ...
        //        gvLupaKushtDerg.SortBy(gvLupaKushtDerg.Columns[filtra.KoloneRenditje], DevExpress.Data.ColumnSortOrder.Ascending);
        //    else
        //        gvLupaKushtDerg.SortBy(gvLupaKushtDerg.Columns[filtra.KoloneRenditje], DevExpress.Data.ColumnSortOrder.Descending);
        ...
        //        //DbCore.DbAdmin.clsGridaKoka koka = dbAdmin.merrGridaKokaByEmri("gvLupaKushtDerg", "LupaKushteDergimi.aspx", DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session));
        //        DbCore.DbAdmin.clsGridaKoka koka = new DbCore.DbAdmin.clsGridaKoka("gvLupaKushtDerg", "LupaKushteDergimi.aspx", DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session));
        //        filtri.GridaKokaId = koka.IdGridaKoka;
        //        filtri.FiltraVlera = gvLupaKushtDerg.FilterExpression;
        //        System.Collections.ObjectModel.ReadOnlyCollection<GridViewDataColumn> kolona = gvLupaKushtDerg.GetSortedColumns();
        //        if (kolona.Count > 0)
        //        {
        ...
        //        else
        //        {
        //            filtri.KoloneRenditje = "IdKushtDergimi";
        //            filtri.DrejtimRenditje = true;
        //        }
        ...
        //{
        //    DbCore.DbAdmin.clsGridaKoka koka = new DbCore.DbAdmin.clsGridaKoka("gvLupaKushtDerg", "LupaKushteDergimi.aspx", idNdermarrje);
