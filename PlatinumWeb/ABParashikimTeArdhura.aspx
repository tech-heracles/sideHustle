<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABParashikimTeArdhura.aspx.cs" Inherits="PlatinumWeb.ABParashikimTeArdhura" %>
    ...
    <form id="form1" runat="server">
     ...
     <dx:ASPxLoadingPanel ID="LoadingPanel" runat="server" ClientInstanceName="LoadingPanel"
        ...
        <div id="dvAktiviteti" style="display: block;">
             ...
             <dx:ASPxGridView ID="gvparashikimTeArdhura"
                Width="100%" ToolTip="Parashikimi i te ardhurave te veta te ministrive dhe institucioneve buxhetore" runat="server"
                OnBatchUpdate="gvparashikimTeArdhura_BatchUpdate"
                OnAfterPerformCallback="gvparashikimTeArdhura_AfterPerformCallback" OnHtmlFooterCellPrepared="gvparashikimTeArdhura_HtmlFooterCellPrepared"
                OnCustomCallback="gvparashikimTeArdhura_CustomCallback"  OnDataBound="gvparashikimTeArdhura_DataBound" >
