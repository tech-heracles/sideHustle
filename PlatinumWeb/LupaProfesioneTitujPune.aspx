<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaProfesioneTitujPune.aspx.cs" Inherits="PlatinumWeb.LupaProfesioneTitujPune" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myNrAuto-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaProfesioneTitujPune.aspx-IMB.5.1.js&v52"
...
<body onload="Init()">
    ...
    <div id='div' style="display: none">
        ...
        </dx:ASPxHiddenField><dx:ASPxHiddenField ID="hfState" runat="server" ClientInstanceName="hfState">
        </dx:ASPxHiddenField>
                    <%-- shtuar--%>
                    <asp:UpdatePanel ID="pnlKryesor" runat="server">
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvProfesione" runat="server" ClientInstanceName="gvProfesione" 
                                            OnDataBound="gvProfesione_DataBound" OnCustomJSProperties="gvProfesione_CustomJSProperties"  OnRowInserting="gvProfesione_RowInserting" OnRowValidating="rowValidating"
                                            Width="100%" OnCustomCallback="gvProfesione_CustomCallback"    OnBeforeGetCallbackResult="gvProfesione_BeforeGetCallbackResult"  >
                                            <ClientSideEvents RowDblClick="function(s, e) {
                                    OnGridSelectionChanged(e.visibleIndex);                                      
                                     }" EndCallback="function (s,e){EndCallbackGrida(s, e);}"></ClientSideEvents>
                                            <Styles>
