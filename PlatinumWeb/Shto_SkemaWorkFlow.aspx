<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_SkemaWorkFlow.aspx.cs" Inherits="PlatinumWeb.Shto_SkemaWorkFlow" %>
...
<head id="Head1" runat="server">
 ...
 <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/Shto_SkemaWorkFlow.aspx-IMB.3.1.js&v76"
...
<body>
                    ...
                    <dxtc:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                        <ContentCollection>
                            <dxw:ContentControl>
                                ...
                                <dx:ASPxGridView ID="gvSkema" ClientInstanceName="gvSkema" runat="server"
                                    Width="100%" OnDataBound="gvSkema_DataBound" OnAfterPerformCallback="gvSkema_AfterPerformCallback"
                                    OnHeaderFilterFillItems="gvSkema_HeaderFilterFillItems" OnProcessColumnAutoFilter="gvSkema_ProcessColumnAutoFilter"
                                    OnCustomJSProperties="gvSkema_CustomJSProperties" OnCustomCallback="gvSkema_CustomCallback"
                                    OnAutoFilterCellEditorInitialize="gvSkema_AutoFilterCellEditorInitialize">
                                    <Templates>
                                        <TitlePanel>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <dx:ASPxButton ID="ASPxButton2" runat="server" Text="Zgjidh kolonat" AutoPostBack="false"
                                                            ...
                                                            <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,gvSkema)}"
	...
	BeginCallback(s,e);
                    ...
                    <dxtc:TabPage Name="Skema Pune" Text="Skema Pune" >
                       
                        <ContentCollection>
                            <dxw:ContentControl ID="ContentControl3" runat="server">
                                <table id="tblSkema" class="renditKontrolle">
                                    <tbody>
                                    </tbody>
                                </table>
                                <%--<div id="dvlblKodi">--%>
                                ...
                                <dx:ASPxMemo ID="txtEmertimi" runat="server" Width="100%" AutoPostBack="false" Rows="3"
                                    ClientInstanceName="txtEmertimi">
                            ...
                            <dx:ASPxLabel Wrap="False" AssociatedControlID="cbDergo" ID="lblDergo"
                                runat="server" Text="Dergo email pas aprovimit final:" ClientInstanceName="lblDergo">
                            </dx:ASPxLabel>

                            <dx:ASPxCheckBox ID="cbDergo" runat="server" ClientInstanceName="cbDergo"> 
                            <DisabledStyle BackColor="#EEEEEE" Font-Bold="False" ForeColor="Black">
                                </DisabledStyle>
                                <ClientSideEvents CheckedChanged="function (s,e){txtEmail.SetEnabled(cbDergo.GetChecked());}" />
                            </dx:ASPxCheckBox>
                            ...
                            <%--</div>--%>
                            <%--<div id="dvtxtKodi">--%>
                            <dx:ASPxTextBox ID="txtEmail" runat="server" Width="100%" AutoPostBack="false" ClientInstanceName="txtEmail">
                                <ValidationSettings CausesValidation="true" ValidationGroup="entries" SetFocusOnError="true"
                                    Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                    <ErrorFrameStyle ImageSpacing="4px">
                                        <ErrorTextPaddings PaddingLeft="4px" />
                                ...
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="cbNjoftim" ID="lblNjoftim"
                                    runat="server" Text="Njoftim me email:" ClientInstanceName="lblNjoftim">
                                </dx:ASPxLabel>

                                <dx:ASPxCheckBox ID="cbNjoftim" runat="server" ClientInstanceName="cbNjoftim">
                                    <DisabledStyle BackColor="#EEEEEE" Font-Bold="False" ForeColor="Black">
                                    </DisabledStyle>
                                </dx:ASPxCheckBox>
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="txtNr" ID="lblNr"
                                    runat="server" Text="Formula e dates se kujteses:" ClientInstanceName="lblNr">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <%--<div id="dvtxtPershkrimi">--%>
                                <dx:ASPxTextBox ID="txtNr" runat="server" ClientInstanceName="txtNr"
                                    Width="100%">
                                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" RegularExpression-ValidationExpression="[0-9.,]*" RegularExpression-ErrorText="Lejohen vetem numra" RequiredField-IsRequired="True">
                                        <ErrorFrameStyle ImageSpacing="4px">
                                            <ErrorTextPaddings PaddingLeft="4px" />
                                        </ErrorFrameStyle>
                                    </ValidationSettings>
                                ...
                                <%--</div>--%>
                                <%--<div id="dvlblNjesiKohe">--%>
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="cmbFormula" ID="lblFormula"
                                    runat="server" ClientInstanceName="lblFormula" Text="Lloji:">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <%--<div id="dvcmbNjesiKohe">--%>
                                <dx:ASPxComboBox ID="cmbFormula" runat="server" ClientInstanceName="cmbFormula"
                                ...
                                <%--</div>--%>
                                <%--<div id="dvlblKohaPlan">--%>


                                <br />
                                <br />
                                <dx:ASPxGridView ID="gvTrupi" runat="server" ClientInstanceName="gvTrupi" OnAfterPerformCallback="gvTrupi_AfterPerformCallback"
                                    OnHtmlRowCreated="gvTrupi_HtmlRowCreated" OnCustomCallback="gvTrupi_CustomCallback"
                                    OnCustomJSProperties="gvTrupi_CustomJSProperties" Width="100%" OnDataBound="gvTrupi_DataBound">
                                    <ClientSideEvents BeginCallback="gvTrupiBeginCallback" EndCallback="gvTrupiEndCallback"/>
                                    <Styles>
                                        <Header ImageSpacing="5px" SortingImageSpacing="5px">
                                        </Header>
                                    </Styles>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:HiddenField ID="hfVleraLimit" runat="server" />
                <asp:HiddenField ID="hfPaLimit" runat="server" />
                <asp:HiddenField ID="hfEmail" runat="server" />
                <asp:HiddenField ID="hfDelegimi" runat="server" />
                <asp:HiddenField ID="hfLlojGrupimi" runat="server" />
                <asp:HiddenField ID="hfGrupKf" runat="server" />
                <asp:HiddenField ID="hfNiveliApr" runat="server" />
                <asp:HiddenField ID="hfTeDrejtaKonfGride" runat="server" />
                <asp:HiddenField ID="hfKosto" runat="server" />
                <asp:HiddenField ID="hfDite" runat="server" />
