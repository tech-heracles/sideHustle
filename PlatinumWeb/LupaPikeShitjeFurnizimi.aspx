<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaPikeShitjeFurnizimi.aspx.cs"
    Inherits="PlatinumWeb.LupaPikeShitjeFurnizimi" %>
...
<head id="Head1" runat="server">
 ...
 <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaPikeShitjeFurnizimi.aspx-IMB.2.1.js&v76""
...
<body onload="Init()">
    ...
    <div id='div' style="display: none">
        <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" ClientInstanceName="panel"
            Width="100%" Height="100%" HeaderText="Zgjidh Pike Shitje/Furnizmim" Font-Bold="True"
              ShowHeader="False">
                    ...
                    <asp:UpdatePanel ID="pnlKryesor" runat="server">
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvLupaPikeShitjeFurnizimi" runat="server" ClientInstanceName="gvLupaPikeShitjeFurnizimi"
                                            OnDataBound="gvLupaPikeShitjeFurnizimi_DataBound" OnAfterPerformCallback="gvLupaPikeShitjeFurnizimi_AfterPerformCallback"
                                            OnCustomJSProperties="gvLupaPikeShitjeFurnizimi_CustomJSProperties" Width="100%"
                                            OnCustomCallback="gvLupaPikeShitjeFurnizimi_CustomCallback">
