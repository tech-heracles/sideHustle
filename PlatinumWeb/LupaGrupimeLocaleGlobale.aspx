<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaGrupimeLocaleGlobale.aspx.cs" Inherits="PlatinumWeb.LupaGrupimeLocaleGlobale" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaGrupimeLocaleGlobale.aspx-IMB.5.1.js&v38;~/js/myButtonClickLupa-IMB.2.1.js&v76""
                    ...
                    <asp:UpdatePanel ID="pnlKryesor" runat="server">
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvGrupime" runat="server" ClientInstanceName="gvGrupime"
                                            OnDataBound="gvGrupime_DataBound" OnCustomJSProperties="gvGrupime_CustomJSProperties"
                                            Width="100%" OnCustomCallback="gvGrupime_CustomCallback">
