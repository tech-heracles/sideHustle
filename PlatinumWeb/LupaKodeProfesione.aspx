<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaKodeProfesione.aspx.cs" Inherits="PlatinumWeb.LupaKodeProfesione" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaKodeProfesione.aspx-IMB.5.2.js&v38;~/js/myButtonClickLupa-IMB.2.1.js&v76""
                                ...
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvProfesione" runat="server" ClientInstanceName="gvProfesione"
                                            OnDataBound="gvProfesione_DataBound" OnCustomJSProperties="gvProfesione_CustomJSProperties"
                                            Width="100%" OnCustomCallback="gvProfesione_CustomCallback">
