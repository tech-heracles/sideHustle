<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RivleresimeAmortizimi.aspx.cs" Inherits="PlatinumWeb.RivleresimeAmortizimi" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <dx:ASPxHiddenField runat="server" ID="hfState" ClientInstanceName="hfState"></dx:ASPxHiddenField>
    ...
    Utils.shfaqLoadingGif();;
        ...
        <asp:UpdatePanel ID="pnlKryesor" runat="server">
            <ContentTemplate>
                ...
                <br />
                <dx:ASPxGridView ID="gvAmortizimi" ClientInstanceName="gvAmortizimi" runat="server"
                    Width="100%" OnDataBound="gvAmortizimi_DataBound" OnAfterPerformCallback="gvAmortizimi_AfterPerformCallback"
                    OnCustomCallback="gvAmortizimi_CustomCallback" OnCustomJSProperties="gvAmortizimi_CustomJSProperties"
                    OnProcessColumnAutoFilter="gvAmortizimi_ProcessColumnAutoFilter" OnHeaderFilterFillItems="gvAmortizimi_HeaderFilterFillItems">
                    <Templates>
                        <TitlePanel>
                            <table>
                                <tr>
                                    <td>
                                        <dx:ASPxButton ID="ASPxButton2" runat="server" ToolTip="Zgjidh kolonat" AutoPostBack="false"
                                            ...
                                            <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,gvAmortizimi)}"
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                            ...
                                            <ClientSideEvents Click="function(s, e) { gvAmortizimi.SelectAllRowsOnPage(); }" />
                                        </dx:ASPxButton>
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                            ...
                                            <ClientSideEvents Click="function(s, e) { gvAmortizimi.SelectRows(); }" />
                                        </dx:ASPxButton>
                                    </td>
                                    <td>
                                        <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                            ...
                                            <ClientSideEvents Click="function(s, e) { gvAmortizimi.UnselectRows(); }" />
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                            </table>
