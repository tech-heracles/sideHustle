...
{
    public partial class LupaKategoriZbritje : MyPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                clsToolbarConfig.mbushComboBoxFiltra(DbCore.mySessionObjects.ktheGjuhe(Session), idNdermarrje, "gvLupaKatZbr", idKonfigambjenti, "LupaKategoriZbritje.aspx");
            }
            else
            {
        ...
        private void mbushPopUpListeNgaSession()
        {
            ...
            gvLupaKatZbr.DataSource = tmpObject;
        ...
        protected void gvLupaKatZbr_DataBound(object sender, EventArgs e)
        {
            //perdoret per ti vene disa atribute grides
            //behet per te afishuar rreshtin qe do sherbej per filtrim
            gvLupaKatZbr.Settings.ShowFilterRow = true;
            gvLupaKatZbr.KeyFieldName = "IdKokaKategoriZbritje";
            gvLupaKatZbr.SettingsBehavior.AllowSelectByRowClick = true;
        }

        protected void gvLupaKatZbr_AfterPerformCallback(object sender, ASPxGridViewAfterPerformCallbackEventArgs e)
        {
            //kur popupgrida ben callback
            gvLupaKatZbr.Selection.UnselectAll();
        }

        protected void gvLupaKatZbr_HeaderFilterFillItems(object sender, ASPxGridViewHeaderFilterEventArgs e)
        {
        }
        ...
        protected void gvLupaKatZbr_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                if (arr[2] == "")
                    gvLupaKatZbr.FilterExpression = "";
                else
                {
                    DbCore.DbAdmin.clsFiltraGrida filtra = new DbCore.DbAdmin.clsFiltraGrida();
                    DbCore.DbAdmin.clsGridaKoka koka = new DbCore.DbAdmin.clsGridaKoka(DbCore.mySessionObjects.ktheGjuhe(Session), "gvLupaKatZbr", "LupaKategoriZbritje.aspx", idNdermarrje, Convert.ToInt32(cmbKonfigurimi.Value));
                    filtra.mbushFilterPerGrideSipasKodit(arr[2], idNdermarrje, koka.IdGridaKoka);
                    if (filtra.FiltraKodi != null)
                    {
                        gvLupaKatZbr.FilterExpression = filtra.FiltraVlera;
                        GridUtil.renditGriden(filtra.KoloneRenditje, gvLupaKatZbr);
                    }
                }
            }
            gvLupaKatZbr.Selection.UnselectAll();
        ...
        {
            clsToolbarConfig.percaktoTemplateMenu(DbCore.mySessionObjects.ktheGjuhe(Session), idViti, idPerdorues, idNdermarrje, aSPxMenu1, "LupaKategoriZbritje.aspx", this, MenuInfo, Ruaj_ASPxButton_Click, FshiFilter_ASPxButton_Click, true, false, false, DbCore.mySessionObjects.merrEshteMemeSesioni(Session));
            System.Globalization.CultureInfo ci = DbCore.mySessionObjects.ktheCultureInfo(Session);
        ...
        public void FshiFilter_ASPxButton_Click(object sender, EventArgs e)
        {
            ...
            if (filtra.FiltraKodi != null)
            {
                ...
                cmbFiltra.Text = "";
                gvLupaKatZbr.FilterExpression = String.Empty;
            }
        }
