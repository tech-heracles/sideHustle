<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaAktivitete.aspx.cs"
    Inherits="PlatinumWeb.LupaAktivitete" %>
...
<head id="Head1" runat="server">
 ...
 <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaAktivitete.aspx-IMB.2.1.js&v38;~/js/myButtonClickLupa-IMB.2.1.js&v76""
...
<body onload="Init()">
    ...
    <dx:ASPxGlobalEvents ID="ASPxGlobalEvents1" runat="server">
        <%--<ClientSideEvents EndCallback="function(s,e){try{ window.parent.  window.parent.    SessionTimeout.sendKeepAlive();}catch(e){}}" />--%>
    </dx:ASPxGlobalEvents>
    <div id='div' style="display: none">
        <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" ClientInstanceName="panel"
            Width="100%" HeaderText="Zgjidh Aktivitetin" ShowHeader="False">
            <PanelCollection>
                <dx:PanelContent>
                    <%-- shtuar--%>
                    <table width="100%">
                    ...
                    <asp:UpdatePanel ID="pnlKryesor" runat="server">
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvLupaAktivitetet" runat="server" ClientInstanceName="gvLupaAktivitetet"
                                            OnDataBound="gvLupaAktivitetet_DataBound" OnCustomJSProperties="gvLupaAktivitetet_CustomJSProperties"
                                            Width="100%" OnCustomCallback="gvLupaAktivitetet_CustomCallback">
