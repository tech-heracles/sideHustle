<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABPBuxheti3Vjecar.aspx.cs" Inherits="PlatinumWeb.ABPBuxheti3Vjecar" %>
...
<body>
    ...
    <dx:ASPxLoadingPanel ID="LoadingPanel" runat="server" ClientInstanceName="LoadingPanel"
        ...
        <div id="dvAktiviteti" style="display: block;">
             ...
             <dx:ASPxGridView ID="gvPBuxheti3Vjecar"
                Width="100%" ToolTip="Projekt Buxheti per 3 vitet ne vazhdim" runat="server"
                OnBatchUpdate="gvPBuxheti3Vjecar_BatchUpdate"
                OnAfterPerformCallback="gvPBuxheti3Vjecar_AfterPerformCallback" OnHtmlFooterCellPrepared="gvPBuxheti3Vjecar_HtmlFooterCellPrepared"
                OnCustomCallback="gvPBuxheti3Vjecar_CustomCallback"  OnDataBound="gvPBuxheti3Vjecar_DataBound" >
