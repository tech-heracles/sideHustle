<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaFormula.aspx.cs" Inherits="PlatinumWeb.LupaFormula" %>
...
<head runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaFormula.aspx-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js&v76"
...
<body onload="Init()">
    ...
    Utils.shfaqLoadingGif();;
        ...
        <asp:UpdatePanel ID="pnlKryesor" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <dx:ASPxGridView ID="gvFormula" runat="server" Width="100%" ClientInstanceName="gvFormula"
                    OnHeaderFilterFillItems="gvFormula_HeaderFilterFillItems" OnRowUpdating="gvFormula_RowUpdating"
                    OnCancelRowEditing="gvFormula_StartRowEditing" OnRowValidating="gvFormula_RowValidating"
                    OnRowInserting="gvFormula_RowInserting" OnCustomCallback="gvFormula_CustomCallback"
                    OnCellEditorInitialize="gvFormula_CellEditorInitialize">
