<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_Burime.aspx.cs" Inherits="PlatinumWeb.Shto_Burime" %>
...
<head id="Head1" runat="server">
 ...
 <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myMesazh-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/Shto_Burime.aspx-IMB.2.1.js&v76"
...
<body>
                    ...
                    <dxtc:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                        <ContentCollection>
                            <dxw:ContentControl>
                                ...
                                <dx:ASPxGridView ID="gvBurimet" ClientInstanceName="gvBurimet" runat="server"
                                    Width="100%" OnDataBound="gvBurimet_DataBound" OnAfterPerformCallback="gvBurimet_AfterPerformCallback"
                                    OnHeaderFilterFillItems="gvBurimet_HeaderFilterFillItems" OnProcessColumnAutoFilter="gvBurimet_ProcessColumnAutoFilter"
                                    OnCustomJSProperties="gvBurimet_CustomJSProperties" OnCustomCallback="gvBurimet_CustomCallback"
                                    OnAutoFilterCellEditorInitialize="gvBurimet_AutoFilterCellEditorInitialize">
                                    <Templates>
                                        <TitlePanel>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <dx:ASPxButton ID="ASPxButton2" runat="server" ToolTip="Zgjidh kolonat" AutoPostBack="false"
                                                            ...
                                                            <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,gvBurimet)}"
                                                    ...
                                                    <td>
                                                        <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                                            ...
                                                            <ClientSideEvents Click="function(s, e) { gvBurimet.SelectAllRowsOnPage(); }" />
                                                        </dx:ASPxButton>
                                                    ...
                                                    <td>
                                                        <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                                            ...
                                                            <ClientSideEvents Click="function(s, e) { gvBurimet.SelectRows(); }" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                                            ...
                                                            <ClientSideEvents Click="function(s, e) { gvBurimet.UnselectRows(); }" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                </tr>
                                            </table>
	...
	BeginCallback(s,e);
                    ...
                    <dxtc:TabPage Name="Burimi" Text="Burimi">

                        <ContentCollection>
                            <dxw:ContentControl ID="ContentControl3" runat="server">
                                <table id="tblBurimi" class="renditKontrolle">
                                    <tbody>
                                    </tbody>
                                </table>
                                <%--<div id="dvlblKodi">--%>
                                ...
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="txtKostoPlan" ID="lblKostoPlan" runat="server" Text="Kosto/orë Plan:" ClientInstanceName="lblKostoPlan">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <%--<div id="dvtxtKostoPlan">--%>
                                <dx:ASPxTextBox ID="txtKostoPlan" ClientInstanceName="txtKostoPlan" runat="server"
                                ...
                                <%--</div>--%>
                                <%--<div id="dvlblLlog">--%>
                                <dx:ASPxLabel Wrap="False" AssociatedControlID="cmbLlog" ID="lblLlog" runat="server" Text="Llogari shpenzimi:" ClientInstanceName="lblLlog">
                                </dx:ASPxLabel>
                                <%--</div>--%>
                                <%--<div id="dvcmbLlog">--%>
                                <dx:ASPxComboBox ID="cmbLlog" ClientInstanceName="cmbLlog" Width="100%" runat="server"
                                    OnItemRequestedByValue="cmbLlog_ItemRequestedByValue" EnableCallbackMode="True"
