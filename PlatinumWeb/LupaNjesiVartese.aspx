<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaNjesiVartese.aspx.cs"
    Inherits="PlatinumWeb.LupaNjesiVartese" %>
...
<head id="Head1" runat="server">
 ...
 <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaNjesiVartese.aspx-IMB.2.1.js&v76""
                    ...
                    <asp:UpdatePanel ID="pnlKryesor" runat="server">
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvLupaNjesiVartese" runat="server" ClientInstanceName="gvLupaNjesiVartese"
                                            OnDataBound="gvLupaNjesiVartese_DataBound" OnCustomJSProperties="gvLupaNjesiVartese_CustomJSProperties"
                                            Width="100%" OnCustomCallback="gvLupaNjesiVartese_CustomCallback">
