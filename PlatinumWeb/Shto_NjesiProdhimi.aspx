<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_NjesiProdhimi.aspx.cs" Inherits="PlatinumWeb.Shto_NjesiProdhimi" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div id="dvNjesiProdhimi" style="display: none">
                        ...
                        <dxtc:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                            <ContentCollection>
                                <dxw:ContentControl ID="ContentControl1" runat="server">
                                    ...
                                    <dx:ASPxGridView ID="ASPxGridView_NjProdhimi" ClientInstanceName="ASPxGridView_NjProdhimi"
                                        runat="server" Width="100%" OnCustomJSProperties="ASPxGridView_NjProdhimi_CustomJSProperties"
                                        OnDataBound="ASPxGridView_NjProdhimi_DataBound" OnAfterPerformCallback="ASPxGridView_NjProdhimi_AfterPerformCallback"
                                        OnCustomCallback="ASPxGridView_NjProdhimi_CustomCallback" OnHeaderFilterFillItems="ASPxGridView_NjProdhimi_HeaderFilterFillItems"
                                        OnProcessColumnAutoFilter="ASPxGridView_NjProdhimi_ProcessColumnAutoFilter">
                                        <Styles>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dx:ASPxButton ID="ASPxButton2" runat="server" ToolTip="Zgjidh kolonat" AutoPostBack="false"
                                                                ...
                                                                <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s, e, ASPxGridView_NjProdhimi)}"
                                                        ...
                                                        <td>
                                                            <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                                                ...
                                                                <ClientSideEvents Click="function(s, e) { ASPxGridView_NjProdhimi.SelectAllRowsOnPage(); }" />
                                                            </dx:ASPxButton>
                                                        </td>
                                                        <td>
                                                            <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                                                ...
                                                                UseSubmitBehavior="false">
                                                                <ClientSideEvents Click="function(s, e) { ASPxGridView_NjProdhimi.SelectRows(); }" />
                                                            </dx:ASPxButton>
                                                        </td>
                                                        <td>
                                                            <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                                                ...
                                                                UseSubmitBehavior="false">
                                                                <ClientSideEvents Click="function(s, e) { ASPxGridView_NjProdhimi.UnselectRows(); }" />
                                                            </dx:ASPxButton>
                                                        </td>
                                                        <td>
                                    ...
                                    <dx:ASPxGridViewExporter ID="gridExport" runat="server" GridViewID="ASPxGridView_NjProdhimi"
                        ...
                        <dxtc:TabPage Name="Informacion" Text="Informacion">
                            <ContentCollection>
                                <dxw:ContentControl ID="ContentControl3" runat="server">
                                    ...
                                    <dx:ASPxLabel Wrap="False" AssociatedControlID="txtPershkrimi" ID="lblPershkrimi" runat="server" ClientInstanceName="lblPershkrimi">
                                    </dx:ASPxLabel>
                                    <dx:ASPxMemo ID="txtPershkrimi" runat="server" Width="100%" AutoPostBack="false" ClientInstanceName="txtPershkrimi" Rows="3">
                                        <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" CausesValidation="true"
                                            ValidationGroup="entries" SetFocusOnError="True">
                                            <ErrorFrameStyle ImageSpacing="4px">
                                                <ErrorTextPaddings PaddingLeft="4px" />
                                    ...
                                    <dx:ASPxLabel Wrap="False" AssociatedControlID="cmbDegeAdministrative" ID="lblDegeAdministrative" runat="server" ClientInstanceName="lblDegeAdministrative">
                                    </dx:ASPxLabel>
                                    <dx:ASPxComboBox ID="cmbDegeAdministrative" runat="server" ClientInstanceName="cmbDegeAdministrative"
                                        ...
                                        DropDownRows="3" CallbackPageSize="3" OnItemRequestedByValue="cmbDegeAdministrative_ItemRequestedByValue"
                                        OnItemsRequestedByFilterCondition="cmbDegeAdministrative_ItemsRequestedByFilterCondition"
                                        SettingsLoadingPanel-ImagePosition="Top">
                                        <ClientSideEvents ButtonClick="function(s, e) { DegeAdmin_Click(); }" TextChanged="function(s, e) {textChangedDegeAdmin(s,e);}" />
                                        <DropDownButton>
                                            <Image>
                                                <SpriteProperties HottrackedCssClass="dxEditors_edtDropDownHover_Aqua" PressedCssClass="dxEditors_edtDropDownPressed_Aqua" />
                                            </Image>
                                    ...
                                    <dx:ASPxLabel Wrap="False" AssociatedControlID="txtAdresa" ID="lblAdresa" runat="server" ClientInstanceName="lblAdresa">
                                    </dx:ASPxLabel>
                                    <dx:ASPxMemo ID="txtAdresa" runat="server" Width="100%" AutoPostBack="false" ClientInstanceName="txtAdresa" Rows="3">
                                    ...
                                    <dx:ASPxCheckBox ID="cbAktiv" runat="server" Width="100%" ClientInstanceName="cbAktiv">
                                        <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" CausesValidation="false"
                                            ValidationGroup="entries1" ValidateOnLeave="false">
                                            <ErrorFrameStyle ImageSpacing="4px">
                                                <ErrorTextPaddings PaddingLeft="4px" />
                                    ...
                                    <dx:ASPxLabel Wrap="False" AssociatedControlID="txtShenime" ID="lblShenime" runat="server" ClientInstanceName="lblShenime">
                                    </dx:ASPxLabel>
                                    <dx:ASPxMemo ID="txtShenime" runat="server" Width="100%" ClientInstanceName="txtShenime" Rows="3">
                                        <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" CausesValidation="false"
                                            ValidationGroup="entries1" ValidateOnLeave="false">
                                            <ErrorFrameStyle ImageSpacing="4px">
                                                <ErrorTextPaddings PaddingLeft="4px" />
                                    ...
                                    <dx:ASPxLabel Wrap="False" ID="lblDtRegjistrimi" AssociatedControlID="dteDtRegjistrimi" runat="server"
                                        Text="Data" ClientInstanceName="lblDtRegjistrimi">
                                    </dx:ASPxLabel>
                                    <dx:ASPxDateEdit ID="dteDtRegjistrimi" Width="100%" runat="server" ClientInstanceName="dteDtRegjistrimi"
                                        ShowShadow="False">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:HiddenField ID="hfLupaDegeAdministrative" runat="server" />
                </ContentTemplate>
            </asp:UpdatePanel>
