<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaGrupLlogari.aspx.cs"
    Inherits="PlatinumWeb.LupaGrupLlogari" %>
...
<head id="Head1" runat="server">
  ...
  <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaGrupLlogari.aspx-IMB.2.1.js&v76""
    ...
    <form id="form1" runat="server">
        ...
        <div id='div' style="display: none">
            <dx:ASPxGlobalEvents ID="ASPxGlobalEvents1" runat="server">
                ...
                if (window.parent.identikuesPerPopupGrupeLlogari == 'LlogariShpejte')
            ...
            <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" ClientInstanceName="panel"
                Width="100%" HeaderText="Zgjidh grupin e llogarise" ShowHeader="False">
                <%-- Width="300px"--%>
                <PanelCollection>
                    <dx:PanelContent>
                        <%-- shtuar--%>
                        ...
                        <asp:UpdatePanel ID="pnlKryesor" runat="server">
                            <ContentTemplate>
                                <table width="100%">
                                    <tr>
                                        <td>
                                            <dx:ASPxGridView ID="gvLupaGrLlog" runat="server" ClientInstanceName="gvLupaGrLlog"
                                                OnDataBound="gvLupaGrLlog_DataBound" OnAfterPerformCallback="gvLupaGrLlog_AfterPerformCallback"
                                                OnHeaderFilterFillItems="gvLupaGrLlog_HeaderFilterFillItems" Width="100%" OnCustomCallback="gvLupaGrLlog_CustomCallback">
