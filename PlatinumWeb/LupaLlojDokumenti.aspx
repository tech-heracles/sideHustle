<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaLlojDokumenti.aspx.cs"
    Inherits="PlatinumWeb.LupaLlojDokumenti" %>
...
<head id="Head1" runat="server">
  ...
  <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaLlojDokumenti.aspx-IMB.2.1.js&v76""
...
<body onload="Init()">
    ...
    <div id='div' style="display: none">
        <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" ClientInstanceName="panel"
            Width="100%" Height="100%" HeaderText="Zgjidh llojin e dokumentit" Font-Bold="True"
              ShowHeader="False">
            
            <Border BorderColor="#D7D7D7" BorderStyle="Solid" BorderWidth="1px" />
           
            <BorderBottom BorderWidth="0px" />
            <ContentPaddings PaddingBottom="3px" PaddingLeft="3px" PaddingTop="3px" />
            <PanelCollection>
                <dx:PanelContent>
                    <%-- shtuar--%>
                    <table width="100%">
                    ...
                    <asp:UpdatePanel ID="pnlKryesor" runat="server">
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvLupaLlojDok" runat="server" ClientInstanceName="gvLupaLlojDok"
                                            OnDataBound="gvLupaLlojDok_DataBound" OnAfterPerformCallback="gvLupaLlojDok_AfterPerformCallback"
                                            OnHeaderFilterFillItems="gvLupaLlojDok_HeaderFilterFillItems" Width="100%" OnCustomCallback="gvLupaLlojDok_CustomCallback">
