...
namespace PlatinumWeb
{
    public partial class PostoEPaySlip : MyPageBase
    {
        ...
        //    //DbCore.DbAdmin.clsGridaKoka koka = dbAdmin.merrGridaKokaByEmri("ASPxGridView_Vitet", "Shto_Vit.aspx", DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session));
        //    DbCore.DbAdmin.clsGridaKoka koka = new DbCore.DbAdmin.clsGridaKoka("ASPxGridView_Vitet", "Shto_Vit.aspx", DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session));
        ...
        protected void Apliko_ASPxButton_Click(object sender, EventArgs e)
        {
            ...
            int idNdermarrje = DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session);
            int idGjuha = DbCore.mySessionObjects.ktheGjuhe(Session);
            //filtra.mbushFiltraGridaSipasFiltraKodi(cmbFiltra.Text, idNdermarrje);
        ...
        protected void Ruaj_ASPxButton_Click(object sender, EventArgs e)
        {
            ...
            //System.Collections.ObjectModel.ReadOnlyCollection<GridViewDataColumn> kolona = ASPxGridView_Vitet.GetSortedColumns();
            //if (kolona.Count > 0)
            //{
            ...
            //else
            //{
            //    filtri.KoloneRenditje = "KodiViti";
            //    filtri.DrejtimRenditje = true;
            //}
        ...
        protected void ButtonOk_Click2(object sender, EventArgs e)
        {
            ...
            //  List<object> rreshtat = ASPxGridView_Vitet.GetSelectedFieldValues("IdViti");
            CultureInfo ci = DbCore.mySessionObjects.ktheCultureInfo(Session);
            ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
            if (rreshtat.Count == 0)
            {
            ...
            foreach (object id in rreshtat)
            {
                ...
                //konf.IdKonfigAmbjente = colVitet[0] .IdKonfig;
                //konf = new DbCore.DbShare.clsDatabaseShare().merrKonfigAmbjSipasId(konf)[0];

                //bool lidhur = dbRegjistrim.eshteDokumentiILidhurCelje(clsVitet.IdViti.ToString(), konf.IdNivel.ToString());
        ...
        private void konfiguroVleraFillestare(int idPerdoruesi, int idNdermarrje, ResourceManager rm, CultureInfo ci, int idGjuha)
        {
            ...
            // funk.shtoKolonaPerLlogarine(txtLlogMbylljeViti);
            //DbCore.clsFunksione.mbushComboLlogariaPaKolona(idPerdoruesi, idNdermarrje, txtLlogMbylljeViti);
            //DbCore.clsFunksione.percaktoTemplateComboMeEnableCallback(txtLlogMbylljeViti);
        ...
        public void mbushGrideVitesh()
        {
            ...
            //DbCore.DbAdmin.colVitet colVitet = dbAdmin.merrGjitheVitet();
        ...
        //    ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
        //    cmbPeriudhaLloji.Items.Add(rm.GetString("cmbItemNjeMujore", cultinf), 1);
        //    cmbPeriudhaLloji.Items.Add(rm.GetString("cmbItemDyMujore", cultinf), 2);
        //    cmbPeriudhaLloji.Items.Add(rm.GetString("cmbItemTreMujore", cultinf), 3);
        //    cmbPeriudhaLloji.Items.Add(rm.GetString("cmbItemKaterMujore", cultinf), 4);
        //    cmbPeriudhaLloji.Items.Add(rm.GetString("cmbItemGjashteMujore", cultinf), 5);
        ...
        {//konfigurohet grida
            ...
            col5.Visible = false;
          //  DbCore.clsFunksione.percaktoVisibleColumnsMeWidth(DbCore.mySessionObjects.ktheGjuhe(Session), DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session), gvPeriudha, "gvPeriudha", "PostoEPaySlip.aspx");
        ...
        //        int idPerdoruesi = DbCore.mySessionObjects.ktheIdPerdoruesi(Session);
        //        int idNdermarrje = DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session);
        //        int idGjuha = DbCore.mySessionObjects.ktheGjuhePerdoruesi(Session);
        //        System.Globalization.CultureInfo ci = DbCore.mySessionObjects.ktheCultureInfo(Session);
        //        System.Resources.ResourceManager rm = new System.Resources.ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
        ...
        //            if (colKonfkos.Count > 0) konfvkos = colKonfkos[0];
        //            //konf=new DbCore.DbShare.clsDatabaseShare().merrKonfigAmbjSipasIdKategori(konf, DbCore.mySessionObjects.ktheIdPerdoruesi(Session))[0];
        //            DbCore.DbAdmin.clsTeDrejtaRoli tedrejtaInfo = new DbCore.DbAdmin.clsTeDrejtaRoli();

        //            tedrejtaInfo.merrTeDrejtaPerKeteKomponente(idPerdoruesi, idNdermarrje, DbCore.mySessionObjects.ktheIdVitNdermarrje(Session), "PostoEPaySlip.aspx");
        ...
        //                    return;
        //                }
        //                mesazh = viti.ruaj(ruajPeriudha(), konf.IdKonfigAmbjente, konfvkos.IdKonfigAmbjente);
        //                eshteShtim = true;
        //            }
        //            else
        //            {
        ...
        //                // konf.IdKonfigAmbjente = viti.IdKonfig;
        //                //konf = new DbCore.DbShare.clsDatabaseShare().merrKonfigAmbjSipasId(konf)[0];
        ...
        //                }
        //                else
        //                    mesazh = viti.modifiko(ruajPeriudha(), Session);
        ...
        private bool isValidVit(int idNdermarrje, ResourceManager rm, CultureInfo ci)
        {
            ...
            //        //DbCore.DbAdmin.clsNdermarrje nder = new DbCore.DbAdmin.clsNdermarrje(idNdermarrje);
        ...
        protected void gvPeriudha_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            //{
               ...
               // periudhat = new DbCore.DbAdmin.clsDatabaseAdmin().merrPeriudhaSipasViti(id);
                ...
                //{
                //    if (periudhat[periudhat.Count - 1].EmerPeriudha != DbCore.DbAdmin.clsPeriudhaKontabel.periudheMbyllje)
                //    {
                //        DbCore.DbAdmin.clsPeriudhaKontabel per = new DbCore.DbAdmin.clsPeriudhaKontabel();
        ...
        protected void txtLlogMbylljeViti_ItemRequestedByValue(object source, ListEditItemRequestedByValueEventArgs e)
        {
            if (IsCallback)
            {
                ...
                {
                  //  DbCore.clsFunksione.mbushComboLlogariaPaKolona(DbCore.mySessionObjects.ktheIdPerdoruesi(Session), DbCore.mySessionObjects.merrIdNdermarrjeSesioni(Session), txtLlogMbylljeViti);
                }
            }
