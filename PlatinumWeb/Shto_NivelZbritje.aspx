<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_NivelZbritje.aspx.cs"
    Inherits="PlatinumWeb.Shto_NivelZbritje" %>
...
<head id="Head1" runat="server">
 ...
 <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    ...
    <script src="js/aspx.js/Shto_NivelZbritje.aspx-IMB.2.1.js?versioni22" type="text/javascript"></script>--%>
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/Shto_NivelZbritje.aspx-IMB.2.1.js&v76"
...
<body>
    ...
    Utils.shfaqLoadingGif();;
		...
		popFshi.Hide();
                ...
                <div id="dvNiveli" style="display: none">
                    <dxtc:ASPxPageControl EnableHierarchyRecreation="false" ID="ASPxPageControl1" runat="server" ActiveTabIndex="1" ClientInstanceName="PageControl"
                            ...
                            <dxtc:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                                <ContentCollection>
                                    <dxw:ContentControl ID="ContentControl1" runat="server">
                                        ...
                                        <dx:ASPxGridView ID="gvNivelZbritje" runat="server" ClientInstanceName="gvNivelZbritje"
                                            OnAfterPerformCallback="gvNivelZbritje_AfterPerformCallback" OnCustomCallback="gvNivelZbritje_CustomCallback"
                                            OnCustomJSProperties="gvNivelZbritje_CustomJSProperties" OnDataBound="gvNivelZbritje_DataBound"
                                            OnHeaderFilterFillItems="gvNivelZbritje_HeaderFilterFillItems" OnProcessColumnAutoFilter="gvNivelZbritje_ProcessColumnAutoFilter"
                                            Width="100%">
                                            <Templates>
                                                <TitlePanel>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxButton ID="ASPxButton2" runat="server" Text="Zgjidh kolonat" AutoPostBack="false"
                                                                    ...
                                                                    <ClientSideEvents Click="function (s,e){myFaqeCelje.buttonKonfiguroClick(s,e,gvNivelZbritje)}"
	...
	BeginCallback(s,e);
                            ...
                            <dxtc:TabPage  Name="Nivel Zbritje" Text="Nivel Zbritje">
                               
                                <ContentCollection>
                                    <dxw:ContentControl ID="ContentControl3" runat="server" Width="100%">
                                        <table id="tblNivelZbritje" class="renditKontrolle">
                                            <tbody>
                                            </tbody>
                                        </table>
                                        <%--<div id="dvlblKodi">--%>
                                        ...
                                        <dx:ASPxLabel Wrap="False" AssociatedControlID="txtEmertimi" ID="lblEmertimi" runat="server"
                                            ClientInstanceName="lblEmertimi" Text="Emertimi i nivelit:">
                                        </dx:ASPxLabel>
                                        <%--</div>--%>
                                        ...
                                        <dx:ASPxLabel Wrap="False" AssociatedControlID="btneEmertimPrindi" ID="lblPrindi"
                                            runat="server" ClientInstanceName="lblPrindi" Text="Emertimi i prindit:">
                                        </dx:ASPxLabel>
                                        <%--</div>--%>
                                        ...
                                        <dx:ASPxComboBox ID="btneEmertimPrindi" runat="server" ClientInstanceName="btneEmertimPrindi"
                                            ...
                                            ReadOnly="false" ValidationSettings-CausesValidation="True" SettingsLoadingPanel-ImagePosition="Top"
                                            ShowShadow="False" Width="100%">
                                            <ClientSideEvents ButtonClick="function(s, e) { NivelZbritje_Click(); }" SelectedIndexChanged="function(s, e) {btneEmertimPrindiIndexChanged(s,e);}" />
                                            <DropDownButton>
                                                <Image>
                                                    <SpriteProperties HottrackedCssClass="dxEditors_edtDropDownHover_Aqua" PressedCssClass="dxEditors_edtDropDownPressed_Aqua" />
                                                </Image>
                                ...
                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender8" runat="server" Enabled="True"
                                    HighlightCssClass="validorCalloutHighlight" TargetControlID="CustomValidator8">
                                        ...
                                        <dx:ASPxLabel Wrap="False" AssociatedControlID="cmbPrioriteti" ID="lblPrioriteti"
                                            runat="server" ClientInstanceName="lblPrioriteti" Width="180px" Text="Prioriteti:">
                                        </dx:ASPxLabel>
                                        <%--</div>--%>
