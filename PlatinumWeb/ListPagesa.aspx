<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListPagesa.aspx.cs" Inherits="PlatinumWeb.ListPagesa" %>
...
<%--    <script src="js/jquery-1.10.2.min.js" type="text/javascript"></script>
    ...
    <script src="js/aspx.js/ListPagesa.aspx-IMB.2.1.js?versioni22" type="text/javascript"></script>--%>
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myMesazh-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/myCookies-IMB.2.1.js;~/js/aspx.js/ListPagesa.aspx-IMB.2.1.js&v76""
...
<body>
    ...
    <asp:UpdatePanel ID="pnlKryesor" runat="server">
        <ContentTemplate>
            ...
            <br />
            <dx:ASPxGridView ID="gvListPagesa" ClientInstanceName="gvListPagesa" runat="server"
                Width="100%" OnDataBound="gvListPagesa_DataBound" OnAfterPerformCallback="gvListPagesa_AfterPerformCallback"
                OnCustomCallback="gvListPagesa_CustomCallback" OnCustomJSProperties="gvListPagesa_CustomJSProperties"
                OnProcessColumnAutoFilter="gvListPagesa_ProcessColumnAutoFilter" OnHeaderFilterFillItems="gvListPagesa_HeaderFilterFillItems">
                <Styles>
