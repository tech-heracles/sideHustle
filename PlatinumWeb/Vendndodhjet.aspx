<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vendndodhjet.aspx.cs" Inherits="PlatinumWeb.Vendndodhjet" %>
        ...
        <div style="width: 100%">
            <asp:UpdatePanel runat="server" ID="pnlGrida" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <dx:ASPxGridView ID="gvVendndodhjet" runat="server" Width="100%" OnAfterPerformCallback="gridat_AfterPerformCallback"
                        OnHeaderFilterFillItems="gridat_HeaderFilterFillItems" OnRowUpdating="rowUpdating"
                        ClientInstanceName="gvVendndodhjet" OnProcessColumnAutoFilter="gridat_ProcessColumnAutoFilter"
