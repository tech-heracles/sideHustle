<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaShtoArtikull.aspx.cs"
    Inherits="PlatinumWeb.LupaShtoArtikull" %>
...
<head id="Head1" runat="server">
  ...
  <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaShtoArtikull.aspx-IMB.2.1.js&v76""
        ...
        <asp:UpdatePanel ID="pnl" runat="server">
            <ContentTemplate>
                <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" ClientInstanceName="panel"
                    Width="100%" Height="100%" HeaderText="Shto Artikuj Zevendesues" Font-Bold="True"
                      ShowHeader="False">
                            ...
                            <asp:UpdatePanel ID="pnlKryesor" runat="server">
                                <ContentTemplate>
                                    <table width="100%">
                                        <tr>
                                            <td>
                                                <dx:ASPxGridView ID="gvLupaShtoArt" runat="server" ClientInstanceName="gvLupaShtoArt"
                                                    OnAfterPerformCallback="gvLupaShtoArt_AfterPerformCallback" OnHtmlRowCreated="gvLupaShtoArt_HtmlRowCreated"
                                                    OnCustomCallback="gvLupaShtoArt_CustomCallback" OnCustomJSProperties="gvLupaShtoArt_CustomJSProperties"
                                                    OnDataBound="gvLupaShtoArt_DataBound">
	...
	merrTeDhena();
		...
		merrTeDhena();
                                        ...
                                        <tr>
                                         ...
                                         window.parent.     btneArtikuj.SetFocus(true); 
                                         window.parent.popupUniversal.Hide();
                                        }" />
                                        </dx:ASPxButton>--%>
                                                <dx:ASPxTextBox ID="hfArtikulli" runat="server" ClientInstanceName="hfArtikulli"
                                                    Width="0" Height="0" ForeColor="White">
                                                    <Border BorderColor="White" />
                                                </dx:ASPxTextBox>
                                                <dx:ASPxTextBox ID="hfEmertimiA" runat="server" ClientInstanceName="hfEmertimiA"
                                                    Width="0" Height="0" ForeColor="White">
                                                    <Border BorderColor="White" />
                                                </dx:ASPxTextBox>
                                                <dx:ASPxTextBox ID="hfPrioritetiA" runat="server" ClientInstanceName="hfPrioritetiA"
                                                    Width="0" Height="0" ForeColor="White">
                                                    <Border BorderColor="White" />
                                                </dx:ASPxTextBox>
                                            </td>
                                    ...
                                    <dx:ASPxPopupControl EnableHierarchyRecreation="false" ID="popZgjidhFiltrin" runat="server" AllowDragging="True"
                                        ...
                                        PopupVerticalAlign="WindowCenter" Width="300px" ClientIDMode="AutoID" CssPostfix="Glass">
                                        <HeaderStyle>
                                        ...
                                        <ContentCollection>
                                            <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
                                                <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ZgjidhFiltrin_ASPxRoundPanel" runat="server" Width="410px"
                                                    ShowHeader="false" CssPostfix="Glass" GroupBoxCaptionOffsetY="-24px">
                                                    ...
                                                    <PanelCollection>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                            <ContentTemplate>
                                                                                <dx:ASPxButton ID="LupaFiltri_ASPxButton" runat="server" CssPostfix="Glass" CausesValidation="False">
                                                       ...
                                                       Filtra_Click(); 
                                                                    ...
                                                                    <td>
                                                                        <dx:ASPxButton ID="Apliko_ASPxButton" CssPostfix="Glass" runat="server" Text="Apliko"
                                                                            OnClick="Apliko_ASPxButton_Click" CausesValidation="False" Style="font-weight: 700">
                                        ...
                                        <ContentCollection>
                                            <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server">
                                                <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="RuajFiltrin_ASPxRoundPanel" runat="server" Width="300px"
                                                    EnableTheming="False" CssPostfix="Glass" GroupBoxCaptionOffsetY="-24px" ShowHeader="false">
                                                    <ContentPaddings PaddingLeft="4px" PaddingTop="10px" PaddingBottom="10px" />
                                ...
                                *</asp:RequiredFieldValidator>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dx:ASPxButton ID="Ruaj_ASPxButton" CssPostfix="Glass" runat="server" Text="Ruaj"
                                                                            OnClick="Ruaj_ASPxButton_Click">
                                                                        </dx:ASPxButton>
                                                                    </td>
                                                                    <td>
                                                                    </td>
                                    ...
                                    <asp:UpdatePanel ID="pnlfiltra" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="True">
                                        <ContentTemplate>
                                            <dx:ASPxPopupControl EnableHierarchyRecreation="false" ID="ASPxPopupControl1" runat="server" AllowDragging="True"
                                                ...
                                                EnableViewState="False" HeaderText="Zgjidh Filtrin" Modal="True" PopupHorizontalAlign="WindowCenter"
                                                PopupVerticalAlign="WindowCenter" ClientIDMode="AutoID" CssPostfix="Glass">
                                                <HeaderStyle>
                                                    <Paddings PaddingLeft="10px" PaddingRight="6px" PaddingTop="1px" />
                                                </HeaderStyle>
                                                <ContentCollection>
        ...
        <asp:UpdatePanel ID="UpdatePanel5" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
            <ContentTemplate>
                <dx:ASPxPopupControl EnableHierarchyRecreation="false" ID="popupUniversal" runat="server" AllowDragging="True" ClientInstanceName="popupUniversal"
                    CloseAction="CloseButton" EnableAnimation="False" EnableViewState="False" HeaderText="Zgjidh Artikullin "
                    Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter">
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl4" runat="server">
                            <iframe id="Container" name="ContainerArtikull" frameborder="0" runat="server"></iframe>
                        </dx:PopupControlContentControl>
                    </ContentCollection>
                </dx:ASPxPopupControl >
            </ContentTemplate>
