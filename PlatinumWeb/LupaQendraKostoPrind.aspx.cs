...
{
    public partial class LupaQendraKostoPrind : MyPageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int idKonfigAmbjenti = DbCore.clsFunksione.getIdKonfigAmbLupa(vleraQueryString, idNdermarrje, "LQKP");
            ...
            if (!IsPostBack)
            {
                ...
                clsToolbarConfig.mbushComboBoxFiltra(DbCore.mySessionObjects.ktheGjuhe(Session), idNdermarrje, "gvLupaQendraKosto", idKonfigAmbjenti, "LupaQendraKostoPrind.aspx");
            }
            else
            {
        ...
        {
            GridUtil.percaktoVisibleColumnsSipasKonfigurimit(gvLupaQendraKosto, "gvLupaQendraKosto", "LupaQendraKostoPrind.aspx", idKonfigAmbjenti, visibleIndex, DbCore.mySessionObjects.ktheGjuhe(Session));
        ...
        protected void gvLupaQendraKosto_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (arr.Length == 3)
            {
                ...
                else
                {
                    ...
                    DbCore.DbAdmin.clsGridaKoka koka = new DbCore.DbAdmin.clsGridaKoka(DbCore.mySessionObjects.ktheGjuhe(Session), "gvLupaQendraKosto", "LupaQendraKostoPrind.aspx", idNdermarrje, Convert.ToInt32(cmbKonfigurimi.Value));
