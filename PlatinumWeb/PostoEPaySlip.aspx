<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostoEPaySlip.aspx.cs" Inherits="PlatinumWeb.PostoEPaySlip" %>
...
<body>
    ...
    Utils.shfaqLoadingGif();;
		...
		popFshi.Hide();
                    ...
                    <dx:ASPxPopupControl EnableHierarchyRecreation="false" ID="popMbyllje" runat="server" AllowDragging="True" ClientInstanceName="popMbyllje"
                        CloseAction="CloseButton" EnableAnimation="False" EnableViewState="False" HeaderText="Kujdes"
                        Font-Bold="true" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter"
                        Width="350px" ClientIDMode="AutoID" CssPostfix="Glass">
                        <HeaderStyle>
                            <Paddings PaddingLeft="10px" PaddingRight="6px" PaddingTop="1px" />
                        </HeaderStyle>
                        <ContentCollection>
                            <dx:PopupControlContentControl ID="PopupControlContentControl17" runat="server">
                                <dx:ASPxPanel EnableHierarchyRecreation="false" ID="ASPxPanel2" runat="server" ClientIDMode="AutoID" Width="350px">
                                    <PanelCollection>
                                        <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                            <dx:ASPxLabel ID="lblMsgbox2" runat="server" ClientIDMode="AutoID" Text="Nese deshironi te azhornomi klientet dhe llogarite ne valute perpara se te mbyllni vitin ushtrimor duhet te kryeni veprimet perkatese ne ambjentet Azhornime Klient/Furnitor dhe Flete Kontabel lloji Azhornime. 
                                        Jeni i sigurte per te vazhduar? ">
                                            </dx:ASPxLabel>
                                            <br />
                                            <br />
                                            <div style="text-align: right;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dx:ASPxButton ID="ButtonOk2" runat="server" CausesValidation="False" ClientInstanceName="ButtonOk2"
                                                                OnClick="ButtonOk2_Click" Text="Ok">
                                                                <ClientSideEvents Click="function(s, e) {          
	popMbyllje.Hide();
    Utils.shfaqLoadingGif();;
}" />
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                    ...
                    <asp:HiddenField ID="hfKycje" runat="server" />
                     <asp:HiddenField ID="hfposto" runat="server" />
                     <asp:HiddenField ID="hfpostom" runat="server" />
                      <asp:HiddenField ID="hfpostoa" runat="server" />
