<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaSkemaFk.aspx.cs" Inherits="PlatinumWeb.LupaSkemaFleteKontabel" %>
...
<head id="Head1" runat="server">
 ...
 <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaSkemaFk.aspx-IMB.2.1.js&v76""
...
<body onload="Init()">
    ...
    <div id='div' style="display: none">
        <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" runat="server" ClientInstanceName="panel"
            Width="100%" HeaderText="Zgjidh Llogarine" ShowHeader="False">
            <PanelCollection>
                <dx:PanelContent>
                    <%-- shtuar--%>
                    ...
                    <table width="100%">
                        <tr>
                            <td>
                                <dx:ASPxGridView ID="gvLupaSkemaFK" runat="server" ClientInstanceName="gvLupaSkemaFK"
                                    OnDataBound="gvLupaSkemaFK_DataBound" OnAfterPerformCallback="gvLupaSkemaFK_AfterPerformCallback"
                                    Width="100%" OnCustomCallback="gvLupaSkemaFK_CustomCallback">
                                    <ClientSideEvents RowDblClick="function(s, e) { OnGridSelectionChanged(); window.parent.popupUniversal.Hide(); }"
                        ...
                        <tr>
                         ...
                         window.parent.popupUniversal.Hide();                                   
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="btnFshi" runat="server" Text="Fshi" AutoPostBack="false" AllowFocus="true"
                                                ClientInstanceName="btnFshi" OnClick="btnFshi_Click">
                                            </dx:ASPxButton>
                                        </td>
                                    </tr>
                                </table>
