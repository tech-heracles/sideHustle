<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABEvidencaStatistikore.aspx.cs" Inherits="PlatinumWeb.ABEvidencaStatistikore" %>
        ...
        <div id="dvDetyra" style="display: none">
            <dx:ASPxPageControl EnableHierarchyRecreation="false" ID="ASPxPageControl1" runat="server"   TabSpacing="3px"
                ...
                <TabPages>
                    ...
                    <dx:TabPage Name="Dokumentat" Text="Lista e Evidencave">
                        <ContentCollection>
                            <dx:ContentControl>
                                ...
                                <asp:UpdatePanel ID="pnlGrida" runat="server">
                                    <ContentTemplate>
                                           <dx:ASPxGridView ID="gvListaEvidencat" ClientInstanceName="gvListaEvidencat" ToolTip="Evidenca" runat="server"
                                    Width="100%" OnDataBound="gvListaEvidencat_DataBound">
                                     <ClientSideEvents RowDblClick="gvListaEvidencatRowDblClick"
                                                FocusedRowChanged="gvListaEvidencatFocusedRowChanged"
                                                BeginCallback="gvListaEvidencatBeginCallback" />
                                    <Styles>
                    ...
                    <dx:TabPage Name="Dokumenti" Text="Regjistrimi i evidences">
                        <ContentCollection>
                            <dx:ContentControl ID="content">
                                ...
                                <div id="divFillim" class="atributeDiveFshehur">
                                    ...
                                    <dx:ASPxComboBox ID="cmbPeriudha" runat="server"  EnableSynchronization="True" Width="100%" AutoPostBack="false" ClientInstanceName="cmbPeriudha">
                                        ...
                                        <dx:ASPxLabel Wrap="False" AssociatedControlID="txtGjyqtarPlan" ID="lblGjyqtarPlan" runat="server"
                                            Text="Gjyqtar plan" ClientInstanceName="lblGjyqtarPlan">
                                        </dx:ASPxLabel>
                                           
                                        <dx:ASPxSpinEdit ID="txtGjyqtarPlan" runat="server" Width="100%" AutoPostBack="false" ClientInstanceName="txtGjyqtarPlan">
                                        <ValidationSettings CausesValidation="true" ValidationGroup="entries" SetFocusOnError="true"
                                                        Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                            <ErrorFrameStyle ImageSpacing="4px">
                                                <ErrorTextPaddings PaddingLeft="4px" />
                                            </ErrorFrameStyle>
                                     <%--       <RegularExpression ErrorText="Kodi duhet te jete numerik" ValidationExpression="^[0-9]+$"></RegularExpression>--%>
                                            <RequiredField IsRequired="true" />
                                        </ValidationSettings>
                                        <DisabledStyle BackColor="#EEEEEE" Font-Bold="False" ForeColor="Black">
                                            </DisabledStyle>
                              ...
                              <br />
                                <div id="divGrida" class="atributeDiveFshehur">
                                        ...
                                        <dx:ASPxRoundPanel EnableHierarchyRecreation="false" runat="server" ShowCollapseButton="true" AllowCollapsingByHeaderClick="true" Width="100%" HeaderText="Trupi i evidences">
                                    <PanelCollection>
                                        <dx:PanelContent>
                                            

                                             <dx:ASPxGridView ID="gvEvidenca" ClientInstanceName="gvEvidenca" runat="server" OnCustomCallback="gvEvidenca_CustomCallback"
                                    Width="100%" OnDataBound="gvEvidenca_DataBound"  OnBatchUpdate="gvEvidenca_BatchUpdate"  OnCustomErrorText="gvEvidenca_CustomErrorText">
