...
function aplikoFiltra(s, e) {
    ...
    myMenu.aplikoFiltra(s, e, gvStandarte, "", '');
}
...
function Poshte_click(e) {
    indexSel = myMenu.JSlevizNeGride.Poshte_click(e, gvStandarte, indexSel);
}
...
function Lart_click(e) {
    indexSel = myMenu.JSlevizNeGride.Lart_click(e, gvStandarte, indexSel);
}
/*
...
function Fillim_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fillim_click(e, gvStandarte, indexSel);
}
/*
Function: Fund_click
...
function Fund_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fund_click(e, gvStandarte, indexSel);
}
...
function callWebservice() {
    var emer = 'StandarteAmortizimi.aspx';
    $.ajax({
...
function switchEditMode(index) {
    ...
    gvStandarte.StartEditRow(index);
    indexEdit = index;
}
...
function menu_click(s, e) {
    var hfRuaj = $('#hfRuaj');
    myMenu.menu_click_celjevogel(s, e, hfRuaj, gvStandarte, hfTeDrejta);
}

function changeName() {
    myFaqeCelje.changeNameRegjistrime('StandarteAmortizimi.aspx', 0);
}
...
function EndCallbackGrida(s, e) {
    if ($('#hfRuaj').val() == 'Modifiko') {
        Emertimi.SetEnabled(false);
    }
    else if ($('#hfRuaj').val() == 'Ruaj') {
        Emertimi.SetEnabled(true);
    }
    $.ajax({
