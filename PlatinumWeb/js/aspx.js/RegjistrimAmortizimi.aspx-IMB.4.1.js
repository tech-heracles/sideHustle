...
function changeName() {
    ...
    myFaqeCelje.changeName('RegjistrimAmortizimi.aspx', 0, hf);
...
function OnGetRowValues(values) {
    ...
    if (mbush) myMenu.ShikoClick(editor, 'Shto_RegjistrimAmortizimi.aspx?shtim_modifikim=modifikim&numer=' + values[1] + '&indexrow=' + indexModifiko + '&id=' + gvAmortizimi.GetRowKey(gvAmortizimi.GetFocusedRowIndex()));
}
//per filtrat
...
function menu_click(s, e) {
    ...
    myMenu.menu_click_regjistrime(s, e, "Shto_RegjistrimAmortizimi.aspx?shtim_modifikim=shtim&id=0", 'Shto_RegjistrimAmortizimi.aspx?shtim_modifikim=modifikim&numer=' + numur + '&indexrow=' + indexModifiko + '&id=' + gvAmortizimi.GetRowKey(gvAmortizimi.GetFocusedRowIndex()));
...
function OnGridDoubleClick(e, index) {
    if (!focuschange) {
        ...
        myMenu.ShikoClick(editor, 'Shto_RegjistrimAmortizimi.aspx?shtim_modifikim=modifikim&numer=' + numur + '&indexrow=' + indexModifiko + '&id=' + gvAmortizimi.GetRowKey(gvAmortizimi.GetFocusedRowIndex()));
    } else {
        indexModifiko = index;
        mbush = true;
    }
...
function ndryshoKonfigurimin() {
    ...
    callWebserviceKonfigurimi("1004", cmbKonfigurimi.GetText());
}
