...
function aplikoFiltra(s, e) {
    ...
    myMenu.aplikoFiltra(s, e, gvNjesiArtikulli, "", '');
}
...
function Poshte_click(e) {
    indexSel = myMenu.JSlevizNeGride.Poshte_click(e, gvNjesiArtikulli, indexSel);
}
...
function Lart_click(e) {
    indexSel = myMenu.JSlevizNeGride.Lart_click(e, gvNjesiArtikulli, indexSel);
}
/*
...
function Fillim_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fillim_click(e, gvNjesiArtikulli, indexSel);
}
/*
Function: Fund_click
...
function Fund_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fund_click(e, gvNjesiArtikulli, indexSel);
}
...
function switchEditMode(index) {
    ...
    gvNjesiArtikulli.StartEditRow(index);
    indexEdit = index;
}
...
function menu_click(s, e) {
    var hfRuaj = $('#hfRuaj');
    myMenu.menu_click_celjevogel(s, e, hfRuaj, gvNjesiArtikulli, hfTeDrejta);
}

function changeName() {
    myFaqeCelje.changeNameRegjistrime('NjesiArtikulli.aspx', 0);
}
...
function EndCallbackGrida(s, e) {
    if ($('#hfRuaj').val() == 'Modifiko') {
        KodNjesia.SetEnabled(false);
    }
    else if ($('#hfRuaj').val() == 'Ruaj') {
        KodNjesia.SetEnabled(true);
    }
    $.ajax({
