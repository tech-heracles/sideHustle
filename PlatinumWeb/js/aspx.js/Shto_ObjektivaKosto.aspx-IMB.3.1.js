...
function aplikoFiltra(s, e) {
    btnFiltrat = s;
    myMenu.aplikoFiltra(s, e, gvObjektiva, "905", cmbKonfigurimi.GetText());
}
...
function Poshte_click(e) {
    indexSel = myMenu.JSlevizNeGride.Poshte_click(e, gvObjektiva, indexSel);
}
/*Function: Lart_click
...
function Lart_click(e) {
    indexSel = myMenu.JSlevizNeGride.Lart_click(e, gvObjektiva, indexSel);
}
/*
...
function Fillim_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fillim_click(e, gvObjektiva, indexSel);
}
/*
Function: Fund_click
...
function Fund_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fund_click(e, gvObjektiva, indexSel);
}
...
function mbushfusha() {
    ...
    indexModifiko = gvObjektiva.GetFocusedRowIndex();
    if (indexModifiko == -1)
        myMesazh.ShtoMesazhGabimi('Duhet te zgjidhni nje objektive!');
    else
        gvObjektiva.GetRowValues(indexModifiko, 'Id;Kodi;Pershkrimi;Aktiv;Nga;Deri', OnGetRowValuesMod); Utils.shfaqLoadingGif();;
}
...
function OnGetRowValuesMod(values) {
    ...
    dteNga.SetDate(values[4]);
    dteNe.SetDate(values[5]);
    $.ajax({
        url: Utils.getServerApiUrl("Konfigurime", "eshteLidhur"),
        data: JSON.stringify({ idkomp: "905", kodkonfi: cmbKonfigurimi.GetText(), iddokumenti: values[0], idNdermarrje: hfState.Get('idNdermarrje'), idGjuha: hfState.Get('idGjuha') })
...
function callWebserviceKonfigurimi(idKomp, kodKonf) {
    ...
    gvObjektiva.PerformCallback(idKomp + ";" + kodKonf);
}
...
function ndryshoKonfigurimin() {
    ...
    callWebserviceKonfigurimi("905", cmbKonfigurimi.GetText());
}
function ndryshoKonfiguriminInit() {

    callWebserviceKonfigurimiInit("905", cmbKonfigurimi.GetText());
}
...
function changeName() {
    ...
    myFaqeCelje.changeName('Shto_ObjektivaKosto.aspx', 0, hf);
...
function EndRequestHandler(sender, args) {
    ...
    indexModifiko = myFaqeCelje.EndRequestHandlerNew(sender, args, hf, colKontrollet, colAtrTrupi, hfShtimModifikim, hfId, indexModifiko, PageControl, gvObjektiva, "905", pastrofusha, hfTeDrejta);
}
