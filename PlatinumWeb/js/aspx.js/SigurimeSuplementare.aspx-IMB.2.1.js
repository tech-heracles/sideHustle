...
var indexEdit = -1;
var indexModifiko;
var grida = "gvSigurimeSuplementare";
//per filtrat
...
function aplikoFiltra(s, e) {
    ...
    myMenu.aplikoFiltra(s, e, gvSigurimeSuplementare, "", '');
...
function Poshte_click(e) {
    indexSel = myMenu.JSlevizNeGride.Poshte_click(e, gvSigurimeSuplementare, indexSel);
}
/*Function: Lart_click
...
function Lart_click(e) {
    indexSel = myMenu.JSlevizNeGride.Lart_click(e, gvSigurimeSuplementare, indexSel);
}
/*
...
function Fillim_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fillim_click(e, gvSigurimeSuplementare, indexSel);
}
/*
Function: Fund_click
...
function Fund_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fund_click(e, gvSigurimeSuplementare, indexSel);
}
...
function callWebservice() {
    var emer = 'SigurimeSuplementare.aspx';
    $.ajax({
...
function switchEditMode(index, grida) {
    ...
    gvSigurimeSuplementare.StartEditRow(index);
...
///shfaq emrin e faqes
function changeName() {
    myFaqeCelje.changeNameRegjistrime('SigurimeSuplementare.aspx',0);
}
