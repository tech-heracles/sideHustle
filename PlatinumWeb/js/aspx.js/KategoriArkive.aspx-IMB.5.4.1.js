...
function aplikoFiltra(s, e) {
    ...
    myMenu.aplikoFiltra(s, e, gvKategoriArkive, "", '');
}
...
function Poshte_click(e) {
    indexSel = myMenu.JSlevizNeGride.Poshte_click(e, gvKategoriArkive, indexSel);
}
...
function Lart_click(e) {
    indexSel = myMenu.JSlevizNeGride.Lart_click(e, gvKategoriArkive, indexSel);
}
...
function Fillim_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fillim_click(e, gvKategoriArkive, indexSel);
}
...
function Fund_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fund_click(e, gvKategoriArkive, indexSel);
}
...
function switchEditMode(index) {
    ...
    gvKategoriArkive.StartEditRow(index);
    indexEdit = index;
}
...
function menu_click(s, e) {
    var hfRuaj = $('#hfRuaj');
    myMenu.menu_click_celjevogel(s, e, hfRuaj, gvKategoriArkive, hfTeDrejta);
}

function changeName() {
    myFaqeCelje.changeNameRegjistrime('KategoriArkive.aspx', 0);
}
...
function EndCallbackGrida(s, e) {
    if ($('#hfRuaj').val() == 'Modifiko') {
        IdNivel.SetEnabled(false);
    }
    else if ($('#hfRuaj').val() == 'Ruaj') {
        IdNivel.SetEnabled(true);
    }
    $.ajax({      
...
function RowDblClick_gvKategoriArkive(s, e) {
    callWebservice();
