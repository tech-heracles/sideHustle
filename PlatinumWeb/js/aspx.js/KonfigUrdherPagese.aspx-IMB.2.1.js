...
function aplikoFiltra(s, e) {
    ...
    myMenu.aplikoFiltra(s, e, gvKonfigUrdherPagese, "", '');
}
...
function Poshte_click(e) {
    indexSel = myMenu.JSlevizNeGride.Poshte_click(e, gvKonfigUrdherPagese, indexSel);
}
/*Function: Lart_click
...
function Lart_click(e) {
    indexSel = myMenu.JSlevizNeGride.Lart_click(e, gvKonfigUrdherPagese, indexSel);
}
/*
...
function Fillim_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fillim_click(e, gvKonfigUrdherPagese, indexSel);
}
/*
Function: Fund_click
...
function Fund_click(e) {
    indexSel = myMenu.JSlevizNeGride.Fund_click(e, gvKonfigUrdherPagese, indexSel);
}
...
function callWebservice() {
    var emer = 'KonfigUrdherPagese.aspx?lloji=' + Utils.getUrlVar('lloji');    
    $.ajax({        
...
function switchEditMode(index) {
    ...
    gvKonfigUrdherPagese.StartEditRow(index);
    indexEdit = index;
}
...
function menu_click(s, e) {
    var hfRuaj = $('#hfRuaj')
    myMenu.menu_click_celjevogel(s, e, hfRuaj, gvKonfigUrdherPagese,hfTeDrejta);
}

function changeName() {
    myFaqeCelje.changeNameRegjistrime('KonfigUrdherPagese.aspx?lloji=' + Utils.getUrlVar('lloji'),0);
}
