...
Samples.RunTests = function(){
    ...
    for(var g = 0; g < Samples.SampleList.length; g++)
    {
        for(var i = 0; i < Samples.SampleList[g].Samples.length; i++)
        {
            ...
            {
                failureCount++;
                strFailedTest = strFailedTest + Samples.SampleList[g].Samples[i] + "<br/>";
            }
        }
    }
    ...
    if (failureCount > 0) {
        elem.innerHTML = elem.innerHTML + "<br/><strong>Failed Tests:</strong><br/>" + strFailedTest;
    }
};
...
Samples.Views.People = function(people) {
    ...
    if (people.length == undefined)
    {
        ...
        str = str + "<tr><td>" + people.ID + "</td><td>" + people.FirstName + "</td><td>" + people.LastName + "</td><td>" + Samples.Views.StringArray(people.BookIDs) + "</td></tr>";
    }
    else
    {
        for(var i = 0; i < people.length; i++){
            str = str + "<tr><td>" + people[i].ID + "</td><td>" + people[i].FirstName + "</td><td>" + people[i].LastName + "</td><td>" + Samples.Views.StringArray(people[i].BookIDs) + "</td></tr>";
        }
    }
    str =str + "</table>";
    return str;
...
Samples.Views.StringArray = function(strArray) {
    ...
    for(var i = 0; i < strArray.length; i++){
        str = str + "<tr><td>" + strArray[i] + "</td></tr>";
    }
    str =str + "</table>";
    return str;
};
