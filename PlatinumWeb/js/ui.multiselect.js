    ...
    $.widget("ui.multiselect", {
        ...
        _lang: function (lang) {
            switch (lang) {
                case 2:
                    $.extend($.ui.multiselect, {
                        locale: {
                            ...
                            itemsCount: 'elements selectionnes'
                        }
                    });
                    break;
                case 1:
                ...
                case 0:
                    $.extend($.ui.multiselect, {
                        locale: {
                            addAll: 'Shtoi te gjithe',
                            removeAll: 'Hiqi te gjithe',
                            itemsCount: 'te zgjedhur'
                        }
                    });
                    break;
                default:
                    console.error("Id gjuhe e panjohur: " + lang);
                    break;
            }            
        },
        destroy: function () {
        ...
        _populateLists: function (options) {
            ...
            var items = $(options.map(function (i) {
                ...
                var item = that._getOptionNode(this).appendTo(selected ? that.selectedList : that.availableList).show();

                if (this.selected) that.count += 1;
                that._applyItemState(item, selected);
                item.data('idx', i);
                return item[0];
            }));
