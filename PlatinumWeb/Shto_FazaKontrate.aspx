<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_FazaKontrate.aspx.cs" Inherits="PlatinumWeb.Shto_FazaKontrate" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <%--    <table class="renditKontrolle">
                    ...
                    <tr>
                        ...
                        <td class="renditKontrolleCellMeWidth33">
                            <dx:ASPxComboBox ID="cmbAmbjenti" runat="server" ClientInstanceName="cmbAmbjenti"
                                ...
                                <ClientSideEvents SelectedIndexChanged="function(s,e){ndryshoAmbjentin()}" />
                                <DropDownButton>
                                    <Image>
            ...
            <dx:ASPxGridView ID="gvFazat"   
                Width="100%" ToolTip="Ambjenti i Fazave te Kontrates" runat="server"  OnDataBound="gvFazat_DataBound"  OnCustomCallback="gvFazat_CustomCallback"
                OnBatchUpdate="gvFazat_BatchUpdate">
                <ClientSideEvents BeginCallback="gvBeginCallback" EndCallback="gvEndCallback"  CustomButtonClick="CustomButtonsClick"  BatchEditRowValidating="rowValidation"  BatchEditStartEditing="StartEditing" BatchEditEndEditing="EndEditing" />
        ...
        <asp:HiddenField ID="hfDataDok" runat="server" />
