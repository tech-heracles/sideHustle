<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RaportHarta.aspx.cs" Inherits="PlatinumWeb.RaportHarta" %>
...
<head runat="server">
    ...
    <script src="https://maps.google.com/maps/api/js?v=3.7&amp;sensor=false">
    </script>

    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/jquery-ui-1.10.2.custom.min.js;~/js/myMesazh-IMB.2.1.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/OpenLayers-2.13.1/OpenLayers.js;~/js/myHarta.js;~/js/aspx.js/ReportHarta.js&v76""
