<%@ Page Language="C#" AutoEventWireup="true" Title="" CodeBehind="GISLupaObjekte.aspx.cs"
    Inherits="PlatinumWeb.GISLupaObjekte" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/GISLupaObjekte.aspx-IMB.2.1.js&v76"
                        ...
                        <asp:UpdatePanel ID="pnlKryesor" runat="server">
                            <ContentTemplate>
                                <table>
                                    <tr>
                                        <td>
                                            <dx:ASPxGridView ID="gvLupaObjekteGIS" runat="server" ClientInstanceName="gvLupaObjekteGIS" Settings-ShowTitlePanel="true"
                                                OnDataBound="gvLupaObjekteGIS_DataBound"
                                                Width="100%"
                                             >
                                                <Templates>
                                                    <TitlePanel>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <dx:ASPxButton ID="gridaSelectFaqe" runat="server" ToolTip="Zgjidh te gjithe faqen"
                                                                        ...
                                                                        <ClientSideEvents Click="function(s, e) { gvLupaObjekteGIS.SelectAllRowsOnPage(); }" />
                                                                    </dx:ASPxButton>
                                                                </td>
                                                                <td>
                                                                    <dx:ASPxButton ID="gridaSelectTeGjitha" runat="server" ToolTip="Zgjidh te gjithe"
                                                                        ...
                                                                        <ClientSideEvents Click="function(s, e) { gvLupaObjekteGIS.SelectRows(); }" />
                                                                    </dx:ASPxButton>
                                                                </td>
                                                                <td>
                                                                    <dx:ASPxButton ID="gridaUnSelectTeGjitha" runat="server" ToolTip="Fshi Zgjedhjen"
                                                                        ...
                                                                        <ClientSideEvents Click="function(s, e) { gvLupaObjekteGIS.UnselectRows(); }" />
                                                                    </dx:ASPxButton>
                                                                </td>
                                                            </tr>
                                                        </table>
