<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaLayerElementi.aspx.cs"
    Inherits="PlatinumWeb.LupaLayerElementi" %>
...
<head id="Head1" runat="server">
  ...
  <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaLayerElementi-IMB.6.3.2.js&v76""
...
<body onload="Init()">
    ...
    <div id='div' style="display: none">
        <dx:ASPxRoundPanel EnableHierarchyRecreation="false" ID="ASPxRoundPanel1" ClientInstanceName="panel" runat="server"
            Width="100%" Height="100%" HeaderText="Zgjidh Layer/Element" Font-Bold="True"
              ShowHeader="False">
