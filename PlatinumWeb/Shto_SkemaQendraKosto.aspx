<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shto_SkemaQendraKosto.aspx.cs"
    Inherits="PlatinumWeb.Shto_SkemaQendraKosto" %>
...
<head id="Head1" runat="server">
 ...
 <link href="bootstrap-3.3.6-dist/css/bootstrap-iso.css" rel="stylesheet" />
    ...
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/myButtonClickLupa-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/Shto_SkemaQendraKosto.aspx-IMB.3.1.js&v76"
...
<body>
                    ...
                    <dxtc:TabPage Name="Te pergjithshme" Text="Te pergjithshme">
                        <ContentCollection>
                            <dxw:ContentControl>
                                ...
                                <dx:ASPxGridView ID="gvSkema" ClientInstanceName="gvSkema" runat="server" Width="100%"
                                    OnDataBound="gvSkema_DataBound" OnAfterPerformCallback="gvSkema_AfterPerformCallback"
	...
	BeginCallback(s,e);
                    ...
                    <dxtc:TabPage Name="Skema" Text="Skema" >
                        ...
                        <ContentCollection>
                            <dxw:ContentControl ID="ContentControl3" runat="server">
                                ...
                                <dx:ASPxGridView ID="gvTrupi" runat="server" ClientInstanceName="gvTrupi" OnAfterPerformCallback="gvTrupi_AfterPerformCallback"
                                    ...
                                    <Templates>
                                        <TitlePanel>
                                            <dx:ASPxLabel Wrap="False" ID="lblQendra" runat="server" Text="Qendrat e kostos:"
                                                ClientInstanceName="lblQendra">
                                            </dx:ASPxLabel>
                                        </TitlePanel>
                                    </Templates>
