<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABInventariVite.aspx.cs" Inherits="PlatinumWeb.ABInventariVite" %>
    ...
    <form id="form1" runat="server">       
     <dx:ASPxLoadingPanel ID="LoadingPanel" runat="server" ClientInstanceName="LoadingPanel"
        ...
        <div id="dvAktiviteti" style="display: block;">
             ...
             <dx:ASPxGridView ID="gvinventariVite"
                Width="100%" ToolTip="Inventari sipas viteve" runat="server"
                OnBatchUpdate="gvinventariVite_BatchUpdate"
                OnAfterPerformCallback="gvinventariVite_AfterPerformCallback" OnHtmlFooterCellPrepared="gvinventariVite_HtmlFooterCellPrepared"
                OnCustomCallback="gvinventariVite_CustomCallback"  OnDataBound="gvinventariVite_DataBound" >
