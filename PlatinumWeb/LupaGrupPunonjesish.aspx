<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LupaGrupPunonjesish.aspx.cs"
    Inherits="PlatinumWeb.LupaGrupPunonjesish" %>
...
<head id="Head1" runat="server">
  ...
  <meta name="viewport" content="width=device-width,initial-scale=1.0" />
    <script src="DX.ashx?jsfileset=~/js/jquery-1.11.3.min.js;~/js/noty/jquery.noty.packaged.imb.js;~/js/noty/bootstrap.js;~/js/noty/relax.js;~/js/noty.defaults.js;~/js/myFaqeCelje-IMB.2.1.js;~/js/myMesazh-IMB.2.1.js;~/js/jquery.blockUI.js;~/js/Utils-IMB.2.1.js;~/js/aspx.js/LupaGrupPunonjesish.aspx-IMB.2.1.js&v76"
                    ...
                    <asp:UpdatePanel ID="pnl" runat="server">
                        <ContentTemplate>
                            ...
                            <table width="100%">
                                <tr>
                                    <td>
                                        <dx:ASPxGridView ID="gvLupaGrPunonjesish" runat="server" ClientInstanceName="gvLupaGrPunonjesish"
                                            OnDataBound="gvLupaGrPunonjesish_DataBound" OnAfterPerformCallback="gvLupaGrPunonjesish_AfterPerformCallback"
                                            Width="100%" OnRowInserting="gvLupaGrPunonjesish_RowInserting" OnRowValidating="gvLupaGrPunonjesish_RowValidating"
                                            OnStartRowEditing="gvLupaGrPunonjesish_StartRowEditing" OnRowUpdating="gvLupaGrPunonjesish_RowUpdating">
