...
{
    public partial class RAP_ARKABANKA_DITARIPERMBLEDHES : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_ARKABANKA_DITARIPERMBLEDHES(){InitializeComponent();} 
   
        private CultureInfo ci;
        private ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));

        public RAP_ARKABANKA_DITARIPERMBLEDHES(ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }

        public RAP_ARKABANKA_DITARIPERMBLEDHES(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            this.ci = ci;
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("TitullRaportiDitarPermbledhesArkeBanke", ci);
            ...
            xrTableCell7.Text = rm.GetString("labelRaportiPershkrimi", ci);
