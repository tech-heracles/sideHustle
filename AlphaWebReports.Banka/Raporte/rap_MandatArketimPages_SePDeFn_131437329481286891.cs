...
{
    public partial class rap_MandatArketimPages_SePDeFn_131437329481286891 : DevExpress.XtraReports.UI.XtraReport
    {
        public rap_MandatArketimPages_SePDeFn_131437329481286891()
        {
            InitializeComponent();
        }
        ...
        public rap_MandatArketimPages_SePDeFn_131437329481286891(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje)
        {

        }
        public rap_MandatArketimPages_SePDeFn_131437329481286891(CultureInfo ci, int idNdermarrje)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
