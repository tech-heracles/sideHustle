...
{
    public partial class RAP_BANKA_DITARIKLASIKPORTRAIT : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_BANKA_DITARIKLASIKPORTRAIT(){InitializeComponent();} 
       

        private CultureInfo ci;


        public RAP_BANKA_DITARIKLASIKPORTRAIT(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public RAP_BANKA_DITARIKLASIKPORTRAIT(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            this.ci = ci;
            InitializeComponent();
            EmrateLabelave(ci);
