...
{
    public partial class rap_MandatArketimiVodafone2 : DevExpress.XtraReports.UI.XtraReport
    {
		public rap_MandatArketimiVodafone2(){InitializeComponent();}
        private System.Resources.ResourceManager rm = new System.Resources.ResourceManager("Resources.Strings",
                     System.Reflection.Assembly.Load("App_GlobalResources"));

        public rap_MandatArketimiVodafone2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje)
        {

        }

        public rap_MandatArketimiVodafone2(CultureInfo ci, int idNdermarrje)
        {
            InitializeComponent();
            EmrateLabelave(ci);
