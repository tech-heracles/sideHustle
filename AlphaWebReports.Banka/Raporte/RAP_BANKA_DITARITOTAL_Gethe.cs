...
{
    public partial class RAP_BANKA_DITARITOTAL_Gethe : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_BANKA_DITARITOTAL_Gethe(){InitializeComponent();} 
 
    
        public RAP_BANKA_DITARITOTAL_Gethe(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public RAP_BANKA_DITARITOTAL_Gethe(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
