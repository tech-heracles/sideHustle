...
{
    public partial class RAP_BANKA_DITARITOTAL_NrRend : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_BANKA_DITARITOTAL_NrRend(){InitializeComponent();} 

 
        public RAP_BANKA_DITARITOTAL_NrRend(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public RAP_BANKA_DITARITOTAL_NrRend(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
