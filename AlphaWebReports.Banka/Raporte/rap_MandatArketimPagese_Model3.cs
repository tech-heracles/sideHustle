...
{
    public partial class rap_MandatArketimPagese_Model3 : DevExpress.XtraReports.UI.XtraReport
    {
		public rap_MandatArketimPagese_Model3(){InitializeComponent();}
        private ResourceManager rm = new ResourceManager("Resources.Strings",
                 System.Reflection.Assembly.Load("App_GlobalResources"));
       private CultureInfo ci;
        public rap_MandatArketimPagese_Model3(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje)
        {
        }
        public rap_MandatArketimPagese_Model3(CultureInfo ci, int idNdermarrje)
        {
            this.ci = ci;
            InitializeComponent();
            EmrateLabelave(ci);
