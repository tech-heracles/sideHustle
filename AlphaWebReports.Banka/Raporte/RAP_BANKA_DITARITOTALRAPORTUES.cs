...
{
    public partial class RAP_BANKA_DITARITOTALRAPORTUES : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_BANKA_DITARITOTALRAPORTUES(){InitializeComponent();} 

      
        public RAP_BANKA_DITARITOTALRAPORTUES(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public RAP_BANKA_DITARITOTALRAPORTUES(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("RaportDitariTotalRaportuesTitullijoKapitale", ci);
