...
{
    public partial class RAP_BANKA_DITARITOTAL_SUBJEKTI : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_BANKA_DITARITOTAL_SUBJEKTI(){InitializeComponent();}

        public RAP_BANKA_DITARITOTAL_SUBJEKTI(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public RAP_BANKA_DITARITOTAL_SUBJEKTI(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell52.Text = rm.GetString("labelRaportiTotali", ci);
            xrTableCell55.Text = rm.GetString("labelFilterAvancuarGjendja", ci);
