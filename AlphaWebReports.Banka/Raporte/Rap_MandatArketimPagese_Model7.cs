...
{
    public partial class Rap_MandatArketimPagese_Model7 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_MandatArketimPagese_Model7(){InitializeComponent();} 
        public Rap_MandatArketimPagese_Model7(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje)
        {

        }
        public Rap_MandatArketimPagese_Model7(CultureInfo ci, int idNdermarrje)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
