...
{
    public partial class RAP_BANKA_DITARIKLASIKSIPASAUTORIZIMEVEPORTRAIT : DevExpress.XtraReports.UI.XtraReport
    {
		public RAP_BANKA_DITARIKLASIKSIPASAUTORIZIMEVEPORTRAIT(){InitializeComponent();} 
  
       
        public RAP_BANKA_DITARIKLASIKSIPASAUTORIZIMEVEPORTRAIT(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public RAP_BANKA_DITARIKLASIKSIPASAUTORIZIMEVEPORTRAIT(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
