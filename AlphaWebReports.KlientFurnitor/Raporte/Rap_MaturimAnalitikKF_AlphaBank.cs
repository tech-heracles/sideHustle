...
{
    public partial class Rap_MaturimAnalitikKF_AlphaBank : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_MaturimAnalitikKF_AlphaBank() { InitializeComponent(); }

        public Rap_MaturimAnalitikKF_AlphaBank(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.IdGjuha, param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_MaturimAnalitikKF_AlphaBank(int idGjuha, CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell24.Text = rm.GetString("lblRaportDtValute", ci);
