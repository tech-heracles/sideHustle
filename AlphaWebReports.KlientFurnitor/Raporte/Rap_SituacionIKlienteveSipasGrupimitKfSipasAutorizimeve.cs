...
{
    public partial class Rap_SituacionIKlienteveSipasGrupimitKfSipasAutorizimeve  : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_SituacionIKlienteveSipasGrupimitKfSipasAutorizimeve(){InitializeComponent();} 
        public Rap_SituacionIKlienteveSipasGrupimitKfSipasAutorizimeve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_SituacionIKlienteveSipasGrupimitKfSipasAutorizimeve(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("RaportSituacioniKlientitsipasAutorizimeveTitulli", ci);
            ...
            Qyteti.Text = rm.GetString("labelQyteti", ci);
            xrTableCell7.Text = rm.GetString("labelGrupimi", ci);
            xrTableCell23.Text = rm.GetString("labelRaportiTotaliRaportit", ci);
        }       
    }
}
