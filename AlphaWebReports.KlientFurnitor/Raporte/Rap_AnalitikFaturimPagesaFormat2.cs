...
namespace AlphaWebReports.RaportetDs.KlientFurnitor.Raporte
    {
    public partial class Rap_AnalitikFaturimPagesaFormat2 : DevExpress.XtraReports.UI.XtraReport
        {
		public Rap_AnalitikFaturimPagesaFormat2(){InitializeComponent();} 
     
        ResourceManager rm = new ResourceManager("Resources.Strings",System.Reflection.Assembly.Load("App_GlobalResources"));
        CultureInfo ci;


        public Rap_AnalitikFaturimPagesaFormat2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_AnalitikFaturimPagesaFormat2(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            this.ci = ci;
            InitializeComponent();
            EmrateLabelave(ci);
     ...
     /// <summary>
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell10.Text = rm.GetString("labelFilterAvancuarArkaBanka",ci);
