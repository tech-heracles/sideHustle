...
{
    public partial class Rap_KartelaKlientMeTotalPeriudhe : DevExpress.XtraReports.UI.XtraReport
    {
         public Rap_KartelaKlientMeTotalPeriudhe() { InitializeComponent(); }
        public Rap_KartelaKlientMeTotalPeriudhe(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaKlientMeTotalPeriudhe(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        public void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("RaportKartelaKlientitNeMBTitulliMeTotalPeriudhe", ci);
