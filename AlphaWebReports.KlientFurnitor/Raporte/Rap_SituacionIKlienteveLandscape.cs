...
{
    public partial class Rap_SituacionIKlienteveLandscape : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_SituacionIKlienteveLandscape(){InitializeComponent();} 
  
        public Rap_SituacionIKlienteveLandscape(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_SituacionIKlienteveLandscape(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
        ...
        private void EmrateLabelave(CultureInfo ci, ResourceManager rm)
        {
            ...
            xrTableCell8.Text = rm.GetString("labelRaportiNrLlogari", ci);
