...
{
    public partial class Rap_SituacionIKlienteve : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_SituacionIKlienteve(){InitializeComponent();} 

        public Rap_SituacionIKlienteve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_SituacionIKlienteve(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
