...
namespace AlphaWebReports.RaportetDs.KlientFurnitor.Raporte
    {
    public partial class Rap_AnalitikFaturimPagesa_AlphaBank : DevExpress.XtraReports.UI.XtraReport
        {
		public Rap_AnalitikFaturimPagesa_AlphaBank(){InitializeComponent();} 
     
        ResourceManager rm = new ResourceManager("Resources.Strings",System.Reflection.Assembly.Load("App_GlobalResources"));
        CultureInfo ci;
      
        public Rap_AnalitikFaturimPagesa_AlphaBank(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_AnalitikFaturimPagesa_AlphaBank(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            this.ci = ci;
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell10.Text = rm.GetString("lblRaportDtValute", ci);
            ...
            xrTableCell19.Text = rm.GetString("lblDtFature", ci);
