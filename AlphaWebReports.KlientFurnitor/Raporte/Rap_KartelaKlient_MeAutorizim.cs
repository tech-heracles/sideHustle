...
{
    public partial class Rap_KartelaKlient_MeAutorizim : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KartelaKlient_MeAutorizim(){InitializeComponent();} 
       
        public Rap_KartelaKlient_MeAutorizim(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaKlient_MeAutorizim(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);          
        }
