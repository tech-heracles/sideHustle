...
{
    public partial class Rap_KartelaFurnitor : DevExpress.XtraReports.UI.XtraReport
    {

        public Rap_KartelaFurnitor()
        {
            InitializeComponent();
        }
        public Rap_KartelaFurnitor(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaFurnitor(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell55.Text = rm.GetString("labelRaportDebitorKreditor", ci);
        }
