...
{
    public partial class Rap_SituacionIFurnitoreveLandscape : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_SituacionIFurnitoreveLandscape(){InitializeComponent();} 

        public Rap_SituacionIFurnitoreveLandscape(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_SituacionIFurnitoreveLandscape(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
