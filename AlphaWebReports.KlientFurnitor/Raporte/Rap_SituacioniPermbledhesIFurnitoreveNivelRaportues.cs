...
{
    public partial class Rap_SituacioniPermbledhesIFurnitoreveNivelRaportues : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_SituacioniPermbledhesIFurnitoreveNivelRaportues(){InitializeComponent();} 
        public Rap_SituacioniPermbledhesIFurnitoreveNivelRaportues(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.IdRaporti, param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, param.IdGjuha, report)
        {

        }
        public Rap_SituacioniPermbledhesIFurnitoreveNivelRaportues(int idRaporti, CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, int idGjuha, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
        ...
        {
            xrLabel12.Text = rm.GetString("RaportiSituacionipermbledhesFurnitorevenivelraportuesTitulli", ci);
            ...
            xrTableCell35.Text = rm.GetString("labelRaportMbetjaKreditore", ci);
