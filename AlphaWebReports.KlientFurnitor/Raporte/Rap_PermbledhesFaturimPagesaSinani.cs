...
{
    public partial class Rap_PermbledhesFaturimPagesaSinani : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_PermbledhesFaturimPagesaSinani()
        {
            InitializeComponent();
        }
        public Rap_PermbledhesFaturimPagesaSinani(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.IdGjuha, param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_PermbledhesFaturimPagesaSinani(int idGjuha, CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
