...
{
    public partial class Rap_Kartela_E_Furnitorit_arkaLlogari : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Kartela_E_Furnitorit_arkaLlogari(){InitializeComponent();} 
        public Rap_Kartela_E_Furnitorit_arkaLlogari(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }

        public Rap_Kartela_E_Furnitorit_arkaLlogari(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell9.Text = rm.GetString("labelRaportMonedheLlogarie", ci);
           ...
           xrTableCell7.Text = rm.GetString("labelRaportiTotali", ci);
            xrTableCell27.Text = rm.GetString("labelRaportDebitorKreditor", ci);
