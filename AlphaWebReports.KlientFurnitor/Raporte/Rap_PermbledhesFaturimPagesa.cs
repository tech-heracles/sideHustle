...
namespace AlphaWebReports.RaportetDs.KlientFurnitor.Raporte
    {
    public partial class Rap_PermbledhesFaturimPagesa : DevExpress.XtraReports.UI.XtraReport
    {
        CultureInfo ci;
        public Rap_PermbledhesFaturimPagesa()
        {
            InitializeComponent();
        }
        public Rap_PermbledhesFaturimPagesa(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.IdGjuha, param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_PermbledhesFaturimPagesa(int idGjuha,CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            this.ci = ci;
            InitializeComponent();
            EmrateLabelave(ci);
