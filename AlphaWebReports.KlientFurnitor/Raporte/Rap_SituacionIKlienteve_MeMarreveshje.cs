...
{
    public partial class Rap_SituacionIKlienteve_MeMarreveshje : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_SituacionIKlienteve_MeMarreveshje(){InitializeComponent();} 

        public Rap_SituacionIKlienteve_MeMarreveshje(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_SituacionIKlienteve_MeMarreveshje(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
