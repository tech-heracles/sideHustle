...
{
    public partial class Rap_ShlyerjeKlientiPeriudhaMonKlient : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ShlyerjeKlientiPeriudhaMonKlient(){InitializeComponent();} 

        public Rap_ShlyerjeKlientiPeriudhaMonKlient(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ShlyerjeKlientiPeriudhaMonKlient(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell5.Text = rm.GetString("labelRaportKlienti", ci);
            xrTableCell33.Text = rm.GetString("labelGjithsej", ci);
