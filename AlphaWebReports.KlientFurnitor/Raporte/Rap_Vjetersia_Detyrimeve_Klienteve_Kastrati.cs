...
{
    public partial class Rap_Vjetersia_Detyrimeve_Klienteve_Kastrati : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Vjetersia_Detyrimeve_Klienteve_Kastrati(){InitializeComponent();} 
        public Rap_Vjetersia_Detyrimeve_Klienteve_Kastrati(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_Vjetersia_Detyrimeve_Klienteve_Kastrati(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
