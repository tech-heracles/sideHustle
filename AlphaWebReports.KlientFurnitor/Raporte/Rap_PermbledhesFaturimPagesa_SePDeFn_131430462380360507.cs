...
{
    public partial class Rap_PermbledhesFaturimPagesa_SePDeFn_131430462380360507 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_PermbledhesFaturimPagesa_SePDeFn_131430462380360507()
        {
            InitializeComponent();
        }

        public Rap_PermbledhesFaturimPagesa_SePDeFn_131430462380360507(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.IdGjuha, param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_PermbledhesFaturimPagesa_SePDeFn_131430462380360507(int idGjuha, CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell9.Text = rm.GetString("labelRaportTotaliFatuimePagesa", ci);
