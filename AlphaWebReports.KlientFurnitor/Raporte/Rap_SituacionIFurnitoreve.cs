...
{
    public partial class Rap_SituacionIFurnitoreve : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_SituacionIFurnitoreve(){InitializeComponent();} 

        public Rap_SituacionIFurnitoreve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_SituacionIFurnitoreve(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
