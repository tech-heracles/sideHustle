...
{
    public partial class Rap_KartelaKlientEDetajuar : DevExpress.XtraReports.UI.XtraReport
    { 
        public Rap_KartelaKlientEDetajuar() { InitializeComponent(); }
    
        public Rap_KartelaKlientEDetajuar(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaKlientEDetajuar(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("RaportKartelaKlientitTeDetajuarTitull", ci);
