...
{
    public partial class Rap_ArtikujGjendjeMinMaks_SipasMagazines : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ArtikujGjendjeMinMaks_SipasMagazines(){InitializeComponent();} 


        public Rap_ArtikujGjendjeMinMaks_SipasMagazines(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ArtikujGjendjeMinMaks_SipasMagazines(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("RaportGjendjaArtikujveMinimumMaksimumSipasMagTitulli", ci);
            ...
            xrTableCell18.Text = rm.GetString("labelRaportDalje", ci);
            xrTableCell19.Text = rm.GetString("filterSasiaPakonvertuar", ci);
        }
