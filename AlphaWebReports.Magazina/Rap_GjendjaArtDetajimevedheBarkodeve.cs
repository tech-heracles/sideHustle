...
{
    public partial class Rap_GjendjaArtDetajimevedheBarkodeve : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_GjendjaArtDetajimevedheBarkodeve()
        {
            InitializeComponent();
        }
        public Rap_GjendjaArtDetajimevedheBarkodeve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_GjendjaArtDetajimevedheBarkodeve(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("lblRaportTitullGjendjeArtDetajimeBarkod", ci);
