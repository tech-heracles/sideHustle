...
{
    public partial class Rap_MagazinaGjendja_SePDeFn_131387254592020949 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_MagazinaGjendja_SePDeFn_131387254592020949()
        {
            InitializeComponent();
        }
        public Rap_MagazinaGjendja_SePDeFn_131387254592020949(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_MagazinaGjendja_SePDeFn_131387254592020949(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
