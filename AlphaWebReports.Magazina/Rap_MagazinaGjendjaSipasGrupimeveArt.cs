...
{
    public partial class Rap_MagazinaGjendjaSipasGrupimeveArt : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_MagazinaGjendjaSipasGrupimeveArt(){InitializeComponent();}
        int shifraPasPresjes = 0;
        public Rap_MagazinaGjendjaSipasGrupimeveArt(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_MagazinaGjendjaSipasGrupimeveArt(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
