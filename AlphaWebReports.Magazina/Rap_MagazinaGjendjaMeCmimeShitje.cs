...
{
    public partial class Rap_MagazinaGjendjaMeCmimeShitje : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_MagazinaGjendjaMeCmimeShitje() { InitializeComponent(); }
        int formatNumri = 0;
        string windowWidth = "";
   
        private bool teGrupuar = false;
   
        public Rap_MagazinaGjendjaMeCmimeShitje(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
        ...
        public Rap_MagazinaGjendjaMeCmimeShitje(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        {
            ResourceManager rm = new ResourceManager("Resources.Strings", System.Reflection.Assembly.Load("App_GlobalResources"));
            xrLabel12.Text = rm.GetString("RaportGjendjaeMagazinesCmimeShitjeTitulli", ci);
            FiltratLabel.Text = rm.GetString("FiltratEmertimi", ci);
            xrTableCell4.Text = rm.GetString("labelKartela", ci);
            xrTableCell5.Text = rm.GetString("labelFilterAvancuarKodbari", ci);
