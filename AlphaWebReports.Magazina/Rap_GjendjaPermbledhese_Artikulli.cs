...
{
    public partial class Rap_GjendjaPermbledhese_Artikulli : DevExpress.XtraReports.UI.XtraReport
    {           
		public Rap_GjendjaPermbledhese_Artikulli(){InitializeComponent();} 
        int shifraPasPresjes = 0;
        public Rap_GjendjaPermbledhese_Artikulli(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_GjendjaPermbledhese_Artikulli(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell11.Text = rm.GetString("labelRaportGjendjaeMbartur", ci);
            xrTableCell12.Text = rm.GetString("labelRaportHyrje", ci);
            xrTableCell13.Text = rm.GetString("labelRaportDalje", ci);
            xrTableCell14.Text = rm.GetString("labelRaportGjendje", ci);
