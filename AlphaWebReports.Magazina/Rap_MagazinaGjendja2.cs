...
{
    public partial class Rap_MagazinaGjendja2 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_MagazinaGjendja2(){InitializeComponent();} 
        int formatNumri = 0;

        public Rap_MagazinaGjendja2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_MagazinaGjendja2(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
