...
{
    public partial class Rap_GjendjaMagDet : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_GjendjaMagDet(){InitializeComponent();} 
      
        public Rap_GjendjaMagDet(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_GjendjaMagDet(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell11.Text = rm.GetString("labelRaportDetajimi", ci);
            xrTableCell8.Text = rm.GetString("labelFilterAvancuarKodbari", ci);
            xrTableCell12.Text = rm.GetString("labelRaportLLogariInventar", ci);
            ...
            xrTableCell18.Text = rm.GetString("labelVlefta", ci);
