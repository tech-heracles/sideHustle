...
{
    public partial class Rap_MagazinaGjendjaSipasSerialeve : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_MagazinaGjendjaSipasSerialeve(){InitializeComponent();} 


        public Rap_MagazinaGjendjaSipasSerialeve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.IdRaporti, param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, param.IdGjuha, report)
        {

        }
        public Rap_MagazinaGjendjaSipasSerialeve(int idRaporti, CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, int idGjuha, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell16.Text = rm.GetString("labelNjesia", ci);
            xrTableCell14.Text = rm.GetString("labelRaportGjendjaeMeparshme", ci);
            xrTableCell32.Text = rm.GetString("labelRaportVlefta", ci);
            ...
            xrTableCell11.Text = rm.GetString("labelRaportSeriali", ci);
            xrTableCell29.Text = rm.GetString("labelRaportGjendje", ci);
            xrTableCell30.Text = rm.GetString("labelRaportKosto", ci);
