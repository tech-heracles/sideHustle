...
{
    public partial class Rap_GjendjaPermbledhese_Artikulli1 : DevExpress.XtraReports.UI.XtraReport
    {           
		public Rap_GjendjaPermbledhese_Artikulli1(){InitializeComponent();} 

        public Rap_GjendjaPermbledhese_Artikulli1(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_GjendjaPermbledhese_Artikulli1(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
