...
{
    public partial class Rap_MagazinaregjistriAnalitik_NrRend : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_MagazinaregjistriAnalitik_NrRend(){InitializeComponent();} 
        int shifraPasPresjes = 0;
        public Rap_MagazinaregjistriAnalitik_NrRend(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_MagazinaregjistriAnalitik_NrRend(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {   InitializeComponent();
        EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell11.Text = rm.GetString("labelFilterAvancuarDtRegjistrimi", ci);
            xrTableCell12.Text = rm.GetString("labelKartela", ci);
            xrLabel15.Text = rm.GetString("labelFilterAvancuarNrDok", ci);
            ...
            xrLabel81.Text = rm.GetString("labelSasiHyrje", ci);
