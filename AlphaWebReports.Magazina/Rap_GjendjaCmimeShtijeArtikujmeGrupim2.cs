...
{
    public partial class Rap_GjendjaCmimeShtijeArtikujmeGrupim2 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Rap_GjendjaCmimeShtijeArtikujmeGrupim2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_GjendjaCmimeShtijeArtikujmeGrupim2(CultureInfo ci, int idNdermarrje, int idViti, XtraReport report)
        {
            ...
            XRPivotGridField fieldGrupim2 = new XRPivotGridField("Grupim2", PivotArea.RowArea);
            fieldGrupim2.FieldName = "PERSHKRIMKODIFIKIMI2";
            fieldGrupim2.Caption = rm.GetString("labelGrupimDy", ci);
            ...
            cmimetPivotGrid.Fields.AddRange(new DevExpress.XtraReports.UI.PivotGrid.XRPivotGridField[] {fieldGrupim2, fieldKartela,fieldKodbari,fieldPartNUmber, fieldPershkrimArtikulli,
