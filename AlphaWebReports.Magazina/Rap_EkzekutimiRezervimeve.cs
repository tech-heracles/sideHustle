...
{
    public partial class Rap_EkzekutimiRezervimeve : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_EkzekutimiRezervimeve(){InitializeComponent();} 


        public Rap_EkzekutimiRezervimeve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, param.IdGjuha, report)
        {

        }

        public Rap_EkzekutimiRezervimeve(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, int idGjuha, DevExpress.XtraReports.UI.XtraReport raport)
        {
            ...
            parameter1.Value = raport.Parameters[3].Value;
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel14.Text = rm.GetString("lblRaportDokHyrjeRezervim", ci);
