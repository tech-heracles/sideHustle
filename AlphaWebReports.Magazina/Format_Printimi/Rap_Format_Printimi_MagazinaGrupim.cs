...
{
    public partial class Rap_Format_Printimi_MagazinaGrupim : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Format_Printimi_MagazinaGrupim(){InitializeComponent();} 
        
        public Rap_Format_Printimi_MagazinaGrupim(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_Format_Printimi_MagazinaGrupim(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
