...
{
    public partial class Rap_Format_Printimi_MagazinaModel14 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Format_Printimi_MagazinaModel14(){InitializeComponent();} 

        public Rap_Format_Printimi_MagazinaModel14(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }

        public Rap_Format_Printimi_MagazinaModel14(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel26.Text = rm.GetString("labelMagazinaDestinacion", ci);
