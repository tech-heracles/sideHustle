...
{
    public partial class Rap_FatureShoqerimiFiskalizimi : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShoqerimiFiskalizimi(){InitializeComponent();} 
        public Rap_FatureShoqerimiFiskalizimi(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShoqerimiFiskalizimi(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
