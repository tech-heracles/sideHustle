...
{
    public partial class Rap_Format_Printimi_Model11 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Format_Printimi_Model11(){InitializeComponent();}
        public Rap_Format_Printimi_Model11(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_Format_Printimi_Model11(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
