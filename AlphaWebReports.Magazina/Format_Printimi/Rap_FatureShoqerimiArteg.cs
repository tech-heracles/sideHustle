...
{
    public partial class Rap_FatureShoqerimiArteg : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShoqerimiArteg(){InitializeComponent();} 
        public Rap_FatureShoqerimiArteg(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShoqerimiArteg(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
