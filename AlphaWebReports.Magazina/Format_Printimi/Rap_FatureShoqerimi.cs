...
{
    public partial class Rap_FatureShoqerimi : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShoqerimi(){InitializeComponent();} 
        public Rap_FatureShoqerimi(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShoqerimi(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
