...
{
    public partial class Rap_Format_Printimi_Magazina_Model_9 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Format_Printimi_Magazina_Model_9(){InitializeComponent();} 
        public Rap_Format_Printimi_Magazina_Model_9(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {
        }
        public Rap_Format_Printimi_Magazina_Model_9(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
