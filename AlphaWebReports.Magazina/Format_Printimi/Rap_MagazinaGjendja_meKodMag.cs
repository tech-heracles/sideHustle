...
{
    public partial class Rap_MagazinaGjendja_meKodMag : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_MagazinaGjendja_meKodMag(){InitializeComponent();} 
        int formatNumri = 0;
      
        private bool teGrupuar = false;
        public Rap_MagazinaGjendja_meKodMag(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_MagazinaGjendja_meKodMag(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel77.Text= rm.GetString("filterMagazina", ci);
        }
    }
}
