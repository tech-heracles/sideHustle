...
{
    public partial class Rap_Format_Printimi_Magazina_RefUD : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Format_Printimi_Magazina_RefUD(){InitializeComponent();} 
        public Rap_Format_Printimi_Magazina_RefUD(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {
        }
        public Rap_Format_Printimi_Magazina_RefUD(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel37.Text = rm.GetString("lblRaportReferuar", ci) + " UD";
