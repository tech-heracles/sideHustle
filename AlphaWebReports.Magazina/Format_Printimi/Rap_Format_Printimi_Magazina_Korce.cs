...
{
    public partial class Rap_Format_Printimi_Magazina_Korce : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Format_Printimi_Magazina_Korce(){InitializeComponent();} 

        public Rap_Format_Printimi_Magazina_Korce(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_Format_Printimi_Magazina_Korce(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
