...
{
    public partial class Rap_Format_Printimi_MagazinaModel5 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Format_Printimi_MagazinaModel5(){InitializeComponent();} 
        private int nrRendor = 0;
        public Rap_Format_Printimi_MagazinaModel5(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_Format_Printimi_MagazinaModel5(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        {
            nrRendor++;
            xrLabel16.Text = nrRendor.ToString();
        }
    }
}
