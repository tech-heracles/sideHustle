...
{
    public partial class Rap_FatureShoqerimi_Vodafone : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureShoqerimi_Vodafone(){InitializeComponent();} 
        public Rap_FatureShoqerimi_Vodafone(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureShoqerimi_Vodafone(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel31.Text = rm.GetString("RptFatShoqVodafoneLlojiAmballazhit", ci);
            xrLabel22.Text = rm.GetString("RptFatShoqVodafoneNrKoli", ci);
            xrLabel35.Text = rm.GetString("RptFatShoqVodafoneTranspTeTrete", ci);
            xrLabel23.Text = rm.GetString("RptFatShoqVodafoneEmriShoqerise", ci);
            xrLabel26.Text = rm.GetString("RptFatShoqVodafoneAdresa", ci);
            xrLabel32.Text = rm.GetString("RptFatShoqVodafoneNipt2", ci);

            label4.Text = rm.GetString("RptFatShoqVodafoneNisesi", ci);
            label5.Text = rm.GetString("RptFatShoqVodafoneTransportuesi", ci);
            label6.Text = rm.GetString("RptFatShoqVodafonePritesi", ci);
            label7.Text = rm.GetString("RptFatShoqVodafoneEmerMbiemerNenShkrim", ci);
            label8.Text = rm.GetString("RptFatShoqVodafoneEmerMbiemerNenShkrim", ci);
            label9.Text = rm.GetString("RptFatShoqVodafoneEmerMbiemerNenShkrim", ci);
