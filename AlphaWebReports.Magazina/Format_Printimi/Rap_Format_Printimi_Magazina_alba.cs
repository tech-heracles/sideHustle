...
{
    public partial class Rap_Format_Printimi_Magazina_alba : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Format_Printimi_Magazina_alba(){InitializeComponent();} 
        public Rap_Format_Printimi_Magazina_alba(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_Format_Printimi_Magazina_alba(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
         EmrateLabelave(ci);
        }
