...
{
    public partial class Rap_KonvertimetMeMagazinen : DevExpress.XtraReports.UI.XtraReport,  IUpdateDetailMeDyId
    {
        ...
        public Rap_KonvertimetMeMagazinen()
        {
            InitializeComponent();
        }
        public Rap_KonvertimetMeMagazinen(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KonvertimetMeMagazinen(CultureInfo ci, int idNdermarja, int idViti, int Idperdorues, XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void xrLabel32_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (GetCurrentColumnValue("IDKOKAM") != System.DBNull.Value && GetCurrentColumnValue("IDKOKAM") != null)
            {
                ...
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + kokaID + ";" + artID + ";konvertimeMagazine')";
