...
{
    public partial class Rap_KartelaArtikulliMagazinaDetajime : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KartelaArtikulliMagazinaDetajime(){InitializeComponent();} 
        public Rap_KartelaArtikulliMagazinaDetajime(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaArtikulliMagazinaDetajime(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel17.Text = rm.GetString("RaportKartelaArtikullitDetajimeTitulli", ci);
