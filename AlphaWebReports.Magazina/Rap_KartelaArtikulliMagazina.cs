...
{
    public partial class Rap_KartelaArtikulliMagazina : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KartelaArtikulliMagazina(){InitializeComponent();} 
        public Rap_KartelaArtikulliMagazina(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaArtikulliMagazina(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);                
        }
