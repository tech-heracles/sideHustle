...
{
    public partial class Rap_MagazinaRegjistriPermbledhes : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_MagazinaRegjistriPermbledhes(){InitializeComponent();} 
        public Rap_MagazinaRegjistriPermbledhes(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }

        public Rap_MagazinaRegjistriPermbledhes(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
            ...
            parameter18.Value = idPerdoruesi;
            parameter19.Value = idViti;
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel82.Text = rm.GetString("labelNjesiVartese", ci);
        }
    }
}
