...
{
    public partial class Rap_ArtikujGjendjaKodiDoganor : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ArtikujGjendjaKodiDoganor(){InitializeComponent();} 
        public Rap_ArtikujGjendjaKodiDoganor(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ArtikujGjendjaKodiDoganor(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
