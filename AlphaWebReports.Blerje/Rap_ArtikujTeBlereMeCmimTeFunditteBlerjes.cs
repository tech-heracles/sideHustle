...
{
    public partial class Rap_ArtikujTeBlereMeCmimTeFunditteBlerjes : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ArtikujTeBlereMeCmimTeFunditteBlerjes(){InitializeComponent();} 

        public Rap_ArtikujTeBlereMeCmimTeFunditteBlerjes(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        public Rap_ArtikujTeBlereMeCmimTeFunditteBlerjes(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {         
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell9.Text = rm.GetString("labelCmimiifundit", ci);
