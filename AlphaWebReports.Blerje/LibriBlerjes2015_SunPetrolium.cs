...
{
    public partial class LibriBlerjes2015_SunPetrolium : DevExpress.XtraReports.UI.XtraReport
    {
		public LibriBlerjes2015_SunPetrolium(){InitializeComponent();} 
       
        double maxblerjeperjashtuar = 0;
        double shumatotale = 0;


        public LibriBlerjes2015_SunPetrolium(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public LibriBlerjes2015_SunPetrolium(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi,
