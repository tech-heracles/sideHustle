...
{
    public partial class Rap_BlerjeRegjistriAnalitik_meDetajime : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_BlerjeRegjistriAnalitik_meDetajime(){InitializeComponent();} 
        int shifraPasPresjes = 0;

        public Rap_BlerjeRegjistriAnalitik_meDetajime(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_BlerjeRegjistriAnalitik_meDetajime(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
            ...
            parameter20.Value = raport.Parameters[23].Value;
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
           ResourceManager rm = new ResourceManager("Resources.Strings",
            ...
            xrLabel99.Text = rm.GetString("labelCmimi", ci);
            xrLabel22.Text = rm.GetString("labelRaportiPershkrimi", ci);
            xrLabel105.Text = rm.GetString("lblDetajim1", ci);
            xrLabel21.Text = rm.GetString("lblDetajim2", ci);
