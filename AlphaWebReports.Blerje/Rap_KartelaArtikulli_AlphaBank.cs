...
{
    public partial class Rap_KartelaArtikulli_AlphaBank : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KartelaArtikulli_AlphaBank(){InitializeComponent();} 
      
        public Rap_KartelaArtikulli_AlphaBank(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaArtikulli_AlphaBank(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
          ResourceManager  rm = new ResourceManager("Resources.Strings",
            ...
            xrLabel22.Text = rm.GetString("lblRaportDtValute", ci);
