...
{
    public partial class Rap_FormatPrintimiModelDetajime : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatPrintimiModelDetajime(){InitializeComponent();} 
        public Rap_FormatPrintimiModelDetajime(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FormatPrintimiModelDetajime(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel1.Text = rm.GetString("labelFatura", ci);
