...
{
    public partial class Rap_FatureBlerjeMeArtikuj : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureBlerjeMeArtikuj(){InitializeComponent();} 
        public Rap_FatureBlerjeMeArtikuj(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }

        public Rap_FatureBlerjeMeArtikuj(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
