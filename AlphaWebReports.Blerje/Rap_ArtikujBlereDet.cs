...
{
    public partial class Rap_ArtikujBlereDet : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ArtikujBlereDet(){InitializeComponent();} 
      

        public Rap_ArtikujBlereDet(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ArtikujBlereDet(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
           ResourceManager rm = new ResourceManager("Resources.Strings",
            ...
            xrLabel13.Text = rm.GetString("RaportArtikujTeBlereMeDetajimeTitulli", ci);
