...
namespace AlphaWebReports.RaportetDs.Blerje
{
    ...
    public partial class Rap_BlerjeSipasSasiveKrahasuese : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_BlerjeSipasSasiveKrahasuese(){InitializeComponent();} 

        
		public Rap_BlerjeSipasSasiveKrahasuese(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
		this(param.Ci,param.IdNdermarrje,param.IdPerdoruesi,param.GuidString,param.IdRaporti,param.IdGjuha,param.Vjen,param.IdViti,param.IdSubRaporti,report)
		{
            ...
            public Rap_BlerjeSipasSasiveKrahasuese(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, DevExpress.XtraReports.UI.XtraReport raport) {
            InitializeComponent();
            EmrateLabelave(ci);
