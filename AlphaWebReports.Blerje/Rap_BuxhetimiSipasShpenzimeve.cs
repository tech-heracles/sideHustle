...
{
    public partial class Rap_BuxhetimiSipasShpenzimeve : DevExpress.XtraReports.UI.XtraReport, IUpdateDetail
    {
        ...
        public Rap_BuxhetimiSipasShpenzimeve() {
            InitializeComponent();
        }
        
        public Rap_BuxhetimiSipasShpenzimeve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_BuxhetimiSipasShpenzimeve(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            parameter1.Value = raport.Parameters[6].Value;
            parameter2.Value = raport.Parameters[10].Value;
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("lblRaportiBuxhetimitSipasShpenzimeve", ci);
        ...
        private void xrTableCell19_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (GetCurrentColumnValue("IDPRINDIFILLESTAR") != System.DBNull.Value && GetCurrentColumnValue("IDPRINDIFILLESTAR") != null)
            {
                ...
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + nrdok + ";Detail;Rap_BuxhetimiSipasShpenzimeve')";
