...
{
    public partial class Rap_KartelaArtikulli_Format2 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KartelaArtikulli_Format2(){InitializeComponent();} 
        int shifraPasPresjes = 0;

        public Rap_KartelaArtikulli_Format2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_KartelaArtikulli_Format2(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void caktoFormatinENumrave()
        {
            ...
            xrLabel32.XlsxFormatString = xrLabel33.XlsxFormatString = xrLabel36.XlsxFormatString = xrLabel37.XlsxFormatString = xrLabel39.XlsxFormatString = xrLabel40.XlsxFormatString = xrLabel41.XlsxFormatString = xrLabel42.XlsxFormatString
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
          ResourceManager  rm = new ResourceManager("Resources.Strings",
            ...
            xrLabel17.Text = rm.GetString("RaportKartelaArtikullitTitulli", ci)+" (format 2)";
            ...
            xrLabel3.Text = rm.GetString("labelCmimiPaTVSHMeZbritje", ci);
            xrLabel4.Text = rm.GetString("labelVleraPaTvshMeZbritje", ci);
            xrLabel5.Text = rm.GetString("labelTVSH", ci);
            xrLabel6.Text = rm.GetString("labelVleraMeTvshMeZbritje", ci);
