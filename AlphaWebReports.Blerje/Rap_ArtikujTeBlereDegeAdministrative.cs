...
{
    public partial class Rap_ArtikujTeBlereDegeAdministrative : DevExpress.XtraReports.UI.XtraReport,  IUpdateDetail
    {
		public Rap_ArtikujTeBlereDegeAdministrative(){InitializeComponent();} 
        ...
        public Rap_ArtikujTeBlereDegeAdministrative(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi, param.IdRaporti, param.IdViti, report)
        {

        }
        public Rap_ArtikujTeBlereDegeAdministrative(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, int idRaporti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel13.Text = rm.GetString("RaportArtikujTeBlereDegeAdministrative", ci);
        ...
        private void xrLabel67_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (this.GetCurrentColumnValue("dega") != null)
            {
                ...
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + dega + ";GroupHeader1;artikujTeBlereDegeAdministrative')";
