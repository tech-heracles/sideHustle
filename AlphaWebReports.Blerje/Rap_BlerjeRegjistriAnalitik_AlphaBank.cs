...
{
    public partial class Rap_BlerjeRegjistriAnalitik_AlphaBank : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_BlerjeRegjistriAnalitik_AlphaBank(){InitializeComponent();} 
       
        public Rap_BlerjeRegjistriAnalitik_AlphaBank(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_BlerjeRegjistriAnalitik_AlphaBank(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
           ResourceManager rm = new ResourceManager("Resources.Strings",
            ...
            ZbritjaAnalitike.Text = rm.GetString("lblZbrAnalitike", ci);
            VleftaPaTVSH.Text = rm.GetString("labelVleftapaTVSH", ci);
            ZbritjaTotale.Text = rm.GetString("lblZbrTotale", ci);
