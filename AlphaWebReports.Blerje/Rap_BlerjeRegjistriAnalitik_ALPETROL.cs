...
{
    public partial class Rap_BlerjeRegjistriAnalitik_ALPETROL : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_BlerjeRegjistriAnalitik_ALPETROL(){InitializeComponent();} 
        int shifraPasPresjes = 0;
        int count = 0;

        public Rap_BlerjeRegjistriAnalitik_ALPETROL(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_BlerjeRegjistriAnalitik_ALPETROL(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void caktoFormatinENumrave()
        {
            ...
            xrTableCell6.XlsxFormatString = xrTableCell7.XlsxFormatString = xrTableCell8.XlsxFormatString = xrTableCell11.XlsxFormatString 
                ...
                = xrTableCell9.XlsxFormatString = xrTableCell10.XlsxFormatString
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
           ResourceManager rm = new ResourceManager("Resources.Strings",
            ...
            ZbritjaAnalitikePerqind.Text = rm.GetString("labelZbritjeAnalitike", ci);
            ...
            Kodbari.Text = rm.GetString("labelFilterAvancuarKodbari", ci);
        }
