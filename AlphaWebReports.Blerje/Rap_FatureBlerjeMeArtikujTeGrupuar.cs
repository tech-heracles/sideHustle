...
{
    public partial class Rap_FatureBlerjeMeArtikujTeGrupuar : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureBlerjeMeArtikujTeGrupuar(){InitializeComponent();} 
        public Rap_FatureBlerjeMeArtikujTeGrupuar(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdPerdoruesi)
        {

        }
        public Rap_FatureBlerjeMeArtikujTeGrupuar(CultureInfo ci, int idNdermarrje, int idPerdoruesi)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
