...
{
    public partial class Rap_FormatBlerjePaArtikuj : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FormatBlerjePaArtikuj(){InitializeComponent();} 
        public Rap_FormatBlerjePaArtikuj(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje)
        {

        }
        public Rap_FormatBlerjePaArtikuj(CultureInfo ci, int idNdermarrje)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell2.Text = rm.GetString("labelRaportiShenime", ci);
