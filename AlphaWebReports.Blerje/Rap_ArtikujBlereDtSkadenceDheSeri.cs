...
{
    public partial class Rap_ArtikujBlereDtSkadenceDheSeri : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ArtikujBlereDtSkadenceDheSeri(){InitializeComponent();} 

        public Rap_ArtikujBlereDtSkadenceDheSeri(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ArtikujBlereDtSkadenceDheSeri(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel13.Text = rm.GetString("labelArtikujteblereDateSkadenceSeri", ci);
