...
{
    public partial class Rap_FleteDoganoreImport : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FleteDoganoreImport(){InitializeComponent();} 

        private CultureInfo ci;
        public Rap_FleteDoganoreImport(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_FleteDoganoreImport(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            this.ci = ci;
            InitializeComponent();
            EmrateLabelave(ci);
