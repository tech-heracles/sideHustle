...
{
    public partial class LibriBlerjes2015 : DevExpress.XtraReports.UI.XtraReport
    {
		public LibriBlerjes2015(){InitializeComponent();} 
       
        double maxblerjeperjashtuar = 0;
        double shumatotale = 0;


        public LibriBlerjes2015(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public LibriBlerjes2015(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi,
