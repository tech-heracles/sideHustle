...
{
    public partial class Rap_BlerjeRegjistriAnalitikDEKOLL : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_BlerjeRegjistriAnalitikDEKOLL(){InitializeComponent();} 
  
       
       
     
        public Rap_BlerjeRegjistriAnalitikDEKOLL(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_BlerjeRegjistriAnalitikDEKOLL(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
           ResourceManager rm = new ResourceManager("Resources.Strings",
            ...
            Pershkrimi.Text = rm.GetString("filterRaportPershkrimi", ci);
            ...
            xrTableCell22.Text = rm.GetString("filterMonedha", ci);
            Lloji.Text = rm.GetString("labelRaportiLloji", ci);
            Shenime.Text = rm.GetString("labelRaportiShenime", ci);
            xrTableCell14.Text = rm.GetString("filterRaportPershkrimi", ci);
         
        }

        private void xrLabel95_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (GetCurrentColumnValue("IDLLOJVEPRIMI") != null)
            {
                switch(GetCurrentColumnValue("IDLLOJVEPRIMI").ToString())
                {
                    case "1":
                        xrLabel95.Text = "Artikull";
                        break;
                    case "3":
                        xrLabel95.Text = "Llogari";
                        break;
                    case "2":
                        xrLabel95.Text = "Makro";
                        break;
                    default:
                        break;
                }
