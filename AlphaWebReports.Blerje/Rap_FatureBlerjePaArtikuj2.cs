...
{
    public partial class Rap_FatureBlerjePaArtikuj2 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_FatureBlerjePaArtikuj2(){InitializeComponent();} 
        public Rap_FatureBlerjePaArtikuj2(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje)
        {

        }
        public Rap_FatureBlerjePaArtikuj2(CultureInfo ci, int idNdermarrje)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell2.Text = rm.GetString("labelRaportSubjektBleres", ci) + ":";
            xrTableCell10.Text = rm.GetString("labelRaportSubjektShites", ci) + ":";
            ...
            xrLabel44.Text = rm.GetString("lblRaportDegaAdmin", ci);
            xrLabel46.Text = rm.GetString("labelRaportiPershkrimi", ci);
        }
    }
}
