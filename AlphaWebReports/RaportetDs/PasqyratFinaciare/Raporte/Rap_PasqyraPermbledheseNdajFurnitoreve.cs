...
{
    public partial class Rap_PasqyraPermbledheseNdajFurnitoreve : DevExpress.XtraReports.UI.XtraReport, IUpdateDetailKPF

    {
        public Rap_PasqyraPermbledheseNdajFurnitoreve(){InitializeComponent();} 
        bool hapurgjitha = false;
        public Rap_PasqyraPermbledheseNdajFurnitoreve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
        ...
        private void lblKPF_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + catid + ";Detail;pasqyrePermbledheseFurnitore')";
                if (!SkippedDetailBands.Contains(catid))
                    if (hapurgjitha)
                        label.Text = "-";
                    else label.Text = "+";
        ...
        private void lblPrindi1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + catid + ";KPF;pasqyrePermbledheseFurnitore')";
                if (!SkippedDetailKPF.Contains(catid))
                    if (hapurgjitha)
                        label.Text = "-";
                    else label.Text = "+";
