...
{
    public partial class Rap_PasqyraAktiviteteve : DevExpress.XtraReports.UI.XtraReport, IUpdateDetailKPF
    {
        int formatNumri = 0;
        bool hapurgjitha = false;
        
        private int rritshuma = 0;
        public Rap_PasqyraAktiviteteve()
        {
            InitializeComponent();
        }
        public Rap_PasqyraAktiviteteve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_PasqyraAktiviteteve(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
    ...
    string[] shkronjevogel = { "", "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t" };
        ...
        {
            string catid = GetCurrentColumnValue("kodikpf") != null
                   ? GetCurrentColumnValue("kodikpf").ToString()
                   : string.Empty;
            string catid2 = GetCurrentColumnValue("PERSHKRIMIZERIT") != null
        ...
        {
            string catid = GetCurrentColumnValue("PERSHKRIMIZERIT") != null
                ? GetCurrentColumnValue("PERSHKRIMIZERIT").ToString()
                : string.Empty;
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("labelPasqyraAktiviteteve", ci);
        ...
        private void xrTableCell37_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                xrTableCell37.Text = ((xrTableCell37.Text) + 1).ToString();
                rritshuma = 1;
            }
        }
        ...
        private void xrTableCell36_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + catid + ";KPF;pashOjf')";
                if (!SkippedDetailKPF.Contains(catid))
                    if (hapurgjitha)
                        label.Text = "-";
                    else label.Text = "+";
        ...
        private void xrTableCell26_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + catid + ";Detail;pashOjf')";
                if (!SkippedDetailBands.Contains(catid))
                    if (hapurgjitha)
                        label.Text = "-";
                    else label.Text = "+";
