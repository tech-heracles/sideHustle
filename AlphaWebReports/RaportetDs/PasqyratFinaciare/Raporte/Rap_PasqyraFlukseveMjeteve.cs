...
{
    public partial class Rap_PasqyraFlukseveMjeteve : DevExpress.XtraReports.UI.XtraReport, IUpdateDetailKPF
    {
		public Rap_PasqyraFlukseveMjeteve(){InitializeComponent();} 
        bool hapurgjitha = false;
        
        CultureInfo ci;
        public Rap_PasqyraFlukseveMjeteve(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_PasqyraFlukseveMjeteve(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            this.ci = ci;
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("labelPasqyraFlukseveMjeteve", ci);
        ...
        private void xrTableCell6_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + catid + ";KPF;cashFlowOjf')";
                if (!SkippedDetailKPF.Contains(catid))
                    if (hapurgjitha)
                        label.Text = "-";
                    else label.Text = "+";
        ...
        private void xrTableCell36_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (GetCurrentColumnValue("KODIKPF") != null)
            {
                ...
                {
                    label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + catid + ";Detail;cashFlowOjf')";
                    if (!SkippedDetailBands.Contains(catid))
                        if (hapurgjitha)
                            label.Text = "-";
                        else label.Text = "+";
