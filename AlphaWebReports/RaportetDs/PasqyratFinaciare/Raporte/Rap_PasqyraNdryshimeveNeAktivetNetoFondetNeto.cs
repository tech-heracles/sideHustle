...
{
    public partial class Rap_PasqyraNdryshimeveNeAktivetNetoFondetNeto : DevExpress.XtraReports.UI.XtraReport, IUpdateDetailKPF
    {
        public Rap_PasqyraNdryshimeveNeAktivetNetoFondetNeto() { InitializeComponent(); }
        bool hapurgjitha = false;
        public Rap_PasqyraNdryshimeveNeAktivetNetoFondetNeto(ParametraRaporti param, DevExpress.XtraReports.UI.XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_PasqyraNdryshimeveNeAktivetNetoFondetNeto(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("RaportiPasqyraENdryshimeveNeAktivetNetoFondetNetoTitulli", ci);
            FiltratLabel.Text = rm.GetString("FiltratEmertimi", ci);
            xrLabel7.Text = rm.GetString("labelLogoIMB", ci);
            xrLabel1.Text = rm.GetString("labelRaportiNr", ci) + " " + rm.GetString("labelRaportRreshti", ci);
            xrLabel107.Text = rm.GetString("labelRaportiReference", ci);
            xrLabel19.Text = rm.GetString("labelRaportiEmertimi", ci).ToUpper();
            xrLabel20.Text = rm.GetString("labelRaportiFondeBazeDheGranteKapitale", ci);
            xrLabel23.Text = rm.GetString("labelRaportiRezerva", ci);
            xrLabel2.Text = rm.GetString("labelRaportiFondeTeTjeraTeVetat", ci);
            xrLabel16.Text = rm.GetString("labelRaportiRezultatetEMbarturaTepriceDeficit", ci);
            xrLabel21.Text = rm.GetString("labelRaportiRezultatetEUshtrimitTepriceDeficit", ci);
            xrLabel22.Text = rm.GetString("labelGjithsej", ci).ToUpper() + " " + rm.GetString("labelRaportiAktiveNetoFondeNeto", ci);
        ...
        private void lblKPF_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                label.NavigateUrl = "javascript:window.parent.ASPxCallbackPanel1.PerformCallback('" + catid + ";Detail;RapPasqyraNdryshimeveNeAktivetNetoFondetNeto')";
                if (!SkippedDetailBands.Contains(catid))
                    if (hapurgjitha)
                        label.Text = "-";
                    else label.Text = "+";
        ...
        private void lblPrindi1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                label.NavigateUrl = "javascript:window.parent.ASPxCallbackPanel1.PerformCallback('" + catid + ";KPF;RapPasqyraNdryshimeveNeAktivetNetoFondetNeto')";
                if (!SkippedDetailKPF.Contains(catid))
                    if (hapurgjitha)
                        label.Text = "-";
                    else label.Text = "+";
