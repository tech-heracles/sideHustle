...
{
    public partial class Rap_Bilanci : DevExpress.XtraReports.UI.XtraReport, IUpdateDetailKPF
    {
        public Rap_Bilanci()
        {
            InitializeComponent();
        ...
        CultureInfo ci;
        public Rap_Bilanci(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, report)
        {

        }
        int shifraPasPresjes = 0;
        public Rap_Bilanci(CultureInfo ci, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
            this.ci = ci;
...
xrTableCell41.Summary.FormatString = "{0:n" + shifraPasPresjes + "}";
    ...
    private Hashtable skippedDetailBands;
        ...
        private void xrTableCell77_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            else xrTableCell77.Text = rm.GetString("labelRaportiKapitali", ci);
        }
        ...
        private void xrTableCell85_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            else xrTableCell85.Text = rm.GetString("labelRaportiKapitali", ci);
        }
