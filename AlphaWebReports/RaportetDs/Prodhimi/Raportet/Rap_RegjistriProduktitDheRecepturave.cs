...
{
    public partial class Rap_RegjistriProduktitDheRecepturave : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_RegjistriProduktitDheRecepturave(){InitializeComponent();}
        
        private decimal sasiaplan, sasiakt, dif = 0;
        public Rap_RegjistriProduktitDheRecepturave(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.IdGjuha, param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }
        public Rap_RegjistriProduktitDheRecepturave(int idGjuha,CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
            switch (idGjuha)
        ...
        private void Rap_RegjistriProduktitDheRecepturave_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
