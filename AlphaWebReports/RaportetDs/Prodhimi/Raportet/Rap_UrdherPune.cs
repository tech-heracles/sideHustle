...
{
    public partial class Rap_UrdherPune : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_UrdherPune(){InitializeComponent();} 
        public Rap_UrdherPune(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_UrdherPune(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);            
        }
