...
{
    public partial class Rap_PlanifikimAnalitikAnoria : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_PlanifikimAnalitikAnoria(){InitializeComponent();}

        
        public Rap_PlanifikimAnalitikAnoria(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.IdGjuha, param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, param.ScopeID, report)
        {

        }
        public Rap_PlanifikimAnalitikAnoria(int idGjuha, CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, string scopeID, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel23.Text = rm.GetString("labelRaportGjatesi", ci);
            xrLabel24.Text = rm.GetString("labelRaportGjeresi", ci);
        }

        private void Rap_PlanifikimAnalitikAnoria_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
