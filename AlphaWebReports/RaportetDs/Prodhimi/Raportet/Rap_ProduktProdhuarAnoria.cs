...
{
    public partial class Rap_ProduktProdhuarAnoria : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_ProduktProdhuarAnoria(){InitializeComponent();}
        
        public Rap_ProduktProdhuarAnoria(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, report)
        {

        }
        public Rap_ProduktProdhuarAnoria(CultureInfo ci, int idNdermarrje, int idViti, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel25.Text=rm.GetString("labelRaportGjatesi",ci);
            xrLabel26.Text = rm.GetString("labelRaportGjeresi", ci);
           
        }

        private void Rap_ProduktProdhuarAnoria_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
