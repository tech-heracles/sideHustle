...
{
    public partial class Rap_Analiza_QendraKosto : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Analiza_QendraKosto(){InitializeComponent();} 

        private void Rap_Analiza_QendraKosto_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {

        }
        public Rap_Analiza_QendraKosto(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, param.ScopeID, report)
        {

        }
        public Rap_Analiza_QendraKosto(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, string scopeID, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel12.Text = rm.GetString("RaportiAnalizaQendresSeKostosTitulli", ci);
            FiltratLabel.Text = rm.GetString("FiltratEmertimi", ci);

            xrTableCell16.Text = rm.GetString("labelRaportiLloji", ci);
            xrTableCell18.Text = rm.GetString("labelDate", ci);
            xrTableCell19.Text = rm.GetString("labelPershkrimDok", ci);
            xrTableCell22.Text = rm.GetString("labelVleraMonQK", ci);
            xrTableCell12.Text = rm.GetString("labelRaportiDebi", ci);
            xrTableCell13.Text = rm.GetString("labelRaportiKredi", ci);
            xrTableCell23.Text = rm.GetString("labelKursi", ci);
            xrTableCell24.Text = rm.GetString("labelVleftaNeMonBaze", ci);
            ...
            xrTableCell17.Text = rm.GetString("lblRaportiDokumentiNr", ci);
