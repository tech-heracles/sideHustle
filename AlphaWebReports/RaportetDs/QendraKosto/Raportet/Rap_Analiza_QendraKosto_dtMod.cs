...
{
    public partial class Rap_Analiza_QendraKosto_dtMod : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_Analiza_QendraKosto_dtMod(){InitializeComponent();} 

        private void Rap_Analiza_QendraKosto_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {

        }
        public Rap_Analiza_QendraKosto_dtMod(AlphaWebReports.Common.ParametraRaporti param, XtraReport report):
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi,param.ScopeID, report)
        {

        }

        public Rap_Analiza_QendraKosto_dtMod(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi,string scopeID, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrTableCell5.Text = rm.GetString("labelPershkrimDok", ci);
            xrTableCell8.Text = rm.GetString("labelVleraMonQK", ci);
            xrTableCell17.Text = rm.GetString("labelRaportiDebi", ci);
            xrTableCell18.Text = rm.GetString("labelRaportiKredi", ci);
            xrTableCell9.Text = rm.GetString("labelKursi", ci);
            xrTableCell10.Text = rm.GetString("labelVleftaNeMonBaze", ci);
