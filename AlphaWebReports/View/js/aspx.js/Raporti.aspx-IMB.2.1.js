...
function Init() {
    ...
    if (RaportiEmerReal === "ditari" || RaportiEmerReal === "RptKartelaLlogarive")
    ...
    if (result != "" || result != "undefined") {
        ...
        for (i = 0; i < filertrupikontrolle.length; i++) {
            ...
            if (val.toString() == "radDtTakimi") {
                try {
                    var n = radDtTakimi.GetItemCount();
                    for (j = 0; j < n; j++) {
...
function ButtonClickedArkaBanka(editor) {
    ...
    switch (idmod) {
        case "6"://BANKA
            ...
            if (RaportiEmerReal == 'ditariPermbledhesVeprimeArkeBanke' || RaportiEmerReal == "gjendjaPermbledheseArkeBankeMonedheKerkuar")
        ...
        case "2"://ARKA
            ...
            if (RaportiEmerReal == "ArketimetOrare" || RaportiEmerReal == "pagesaDealer" || RaportiEmerReal == "listeArketimeAnullime" ||
                ...
                RaportiEmerReal == "arketimeDitore")
...
function ButtonClickedQendra1() {
    myButtonClickLupa.LupaUniversal_Click('Zgjidhni qendra', 'LupaQendraKostoPrind.aspx?vjenNga=Raporti', '900', '600');
}

function ButtonClickedQendra2() {
    myButtonClickLupa.LupaUniversal_Click('Zgjidhni qendra', 'LupaQendraKosto.aspx?vjenNga=Raporti1&idPrindi=' + (btnQenderKosto2.GetValue() == null ? 0 : btnQenderKosto2.GetValue()), '900', '600');
}
...
function ButtonClickedQenderKosto(editor) {
    ...
    var heightLupa = '600';
    editorGlobal = editor;
    var contentUrl = 'LupaQendraKosto.aspx?vjenNga=raporti';
    if (RaportiEmerReal == "analizeQendraKostosh" || RaportiEmerReal == "bilanciQendraKosto"
        ...
        || RaportiEmerReal == "RezultatiQendraveTeKostosMeZeraDheNenzera" || RaportiEmerReal == 'RezultatiQendraveTeKostosMeZera')

        contentUrl = 'LupaQendraKostoPlote.aspx?vjenNga=raporti';
    myButtonClickLupa.LupaUniversal_Click(headerText, contentUrl, widthLupa, heightLupa);
}
...
function ButtonClickedPikeShitjeFurnizim(editor) {
    ...
    var contentUrl;
    switch (RaportiEmerReal) {
        case "shitjepermbledhese": case "regjistriAnalitikShitje": case "artikujTeShitur": case "liber_shitje": case "marzhiShitjeve":
        case "grafikMarzhiShitje": case "kerkeseOfertePorosiFaturaShitje": case "artikujTeShiturAutorizime": case "regjistriPermbledhesShitjeAutorizime":
        case "regjistriAnalitikShitjeAutorizime": case "shitjeKlienteSipasMakinave": case "marzhiShitjeveSipasKlienteve": case "MarzhiShitjeveSipasArtikujveDheKlienteve":
        case "marzhiShitjeveMagazina": case "evidencaShitjeve": case "marzhiShitjeveSipasMagazinaveFormat2": case "artikujTePashitur":
        case "artikujTeShiturGrupe": case "regjistriAnalitikShitjeDetajime": case "marzhiShitjesNjesiPerberese": case "marzhiShitjeveMagazineNjesiPerberese":
        case "marzhiShitjeveMagazineNjesiPerberese": case "marzhiShitjevePerberesit": case "ShitjetSipasSasiveKrahasuese": case "marzhiShitjeveTollona":
        case "marzhiShitjeveDetajimArtikujsh":
            contentUrl = 'LupaPikeShitjeFurnizimi.aspx?shitjeblerje=Shitje&vjenNgaRaporti=true';
            break;
        case "regjistriPermbledhesBlerje": case "regjistriAnalitikBlerje": case "liber_blerje": case "kartelaArtikullitBlerje": case "fletaKontabel":
        case "blerjeMbi500Euro": case "kontratatIMB": case "regjisterAnalitikBlerjeFormat2": case "liber_blerje2015": case "liber_blerje2015Kosove":
        case "konvertimiKontrataBlerje": case "kartelaArtikullitFormat2Blerje": case "ShitjetSipasSasiveKrahasuese": case "marzhiShitjeveTollona":
        case "marzhiShitjeveDetajimArtikujsh":
...
function ButtonClickedGrupimArt3(editor) {
    ...
    if (Utils.getUrlVar('idmod') != 'undefined' && Utils.getUrlVar('idmod') == '21') {
        var contentUrl = 'LupaKodifikimArtikulli.aspx?llojartikulli=true&llojkodifikimi=3';
    } else {
        var contentUrl = 'LupaKodifikimArtikulli.aspx?llojkodifikimi=3';
    }
    var widthLupa = '750';
    var heightLupa = '600';
    identifikuesPerPopupKodifikimin = "raportGrupim";
...
$(document).ready(function () {
    $(document).keydown(function (event) {
        if (event.which == 13 || event.keyCode == 13) hapRaportin();
    });
...
function renditFiltra() {
    ...
    if (RaportiEmerReal == "gjendjaLlogarive" || RaportiEmerReal == "gjendjaPermbledheseArkeBankeMonedheKerkuar") {
        radDtDok.SetSelectedIndex(1);
        radDtDok.SetEnabled(false);
...
function lidhes_valueChanged(s, e, filterVeprim, filter) {
    if (s.GetText() == ' ') {
        ...
        if ((filterVeprim.name.indexOf('cmbVeprimi1GrupPKF') != -1 || filterVeprim.name.indexOf('cmbVeprimi2GrupPKF') != -1 || filterVeprim.name.indexOf('cmbVeprimi3GrupPKF') != -1) &&
            (RaportiEmerReal == "shitjepermbledhese" || RaportiEmerReal == "maturimiAnalitikKF" || RaportiEmerReal == "regjistriAnalitikShitje"
                || RaportiEmerReal == "artikujTeShitur" || RaportiEmerReal == "karteleKlienti" || RaportiEmerReal == "MaturimiFaturaveTeKlienteve" || RaportiEmerReal == "kartelaArtikullitShitje" || RaportiEmerReal == "artikujShiturKlienteVartes"
...
function filter2_Init(sender, event, lidhes) {
    ...
    if (RaportiEmerReal.toLowerCase().indexOf('marzhiShitje') != -1)
    ...
    for (i in idKontrollet) {
        ...
        switch (idKontrollet[i].IdTipiKontrollit) {
            ...
            case 2:
                ...
                else if (idKontrollet[i].KodKontrolli.search('cmbVeprimAdrKlient1') != -1 && ((RaportiEmerReal == "analitikShitje") || (RaportiEmerReal == "maturimiAnalitikKF")))
                ...
                else if (idKontrollet[i].KodKontrolli == 'cmbFormatNumri' && RaportiEmerReal != "bilancikontabelformat2" && RaportiEmerReal != "liber_shitje2015" && RaportiEmerReal != "LibriShitjeveVodafone")
                    Utils.ktheKontroll(idKontrollet[i].KodKontrolli).SetSelectedIndex(2);
            ...
            case 3:
                if (idKontrollet[i].KodKontrolli == 'txtNgaRegj' && RaportiEmerReal == "logePerKartelePunonjesi") {
                ...
                else if (idKontrollet[i].KodKontrolli == 'txtNgaPeriudheMaturimi' && ((RaportiEmerReal == "maturimiAnalitikKF") || (RaportiEmerReal == "maturimiFurnitoreveShaga") || (RaportiEmerReal == "situacionKlienteshMaturime"))) {

                    Utils.ktheKontroll(idKontrollet[i].KodKontrolli).SetEnabled(true);
                }
                else if (idKontrollet[i].KodKontrolli == 'txtDeriPeriudheMaturimi' && ((RaportiEmerReal == "maturimiAnalitikKF") || (RaportiEmerReal == "maturimiFurnitoreveShaga") || (RaportiEmerReal == "situacionKlienteshMaturime"))) {
                    ...
                    Utils.ktheKontroll(idKontrollet[i].KodKontrolli).SetDate(new Date(1900, 01, 01));
                    Utils.ktheKontroll(idKontrollet[i].KodKontrolli).SetEnabled(true);
                }
...
function vendosVlereDefaultFiltriNeBazeRaporti() {
    if (RaportiEmerReal == "Depreciation") {
        ...
        txtNgaDok.SetEnabled(true);
        txtDeriDok.SetEnabled(false);
    } else if (RaportiEmerReal == "gjendjaLlogarive" || RaportiEmerReal == "gjendjaPermbledheseArkeBankeMonedheKerkuar") {
    ...
    } else if (RaportiEmerReal == "gjendjaPermbledhurEArkes" || RaportiEmerReal == "gjendjaPermbledhurEBankes" || RaportiEmerReal == "gjendjaMagazine" || RaportiEmerReal == "gjendjeArtikujsh") {
        cmbGjendjeArt.SetSelectedIndex(1);
    } else if (RaportiEmerReal.toLowerCase().indexOf('marzhiShitje') != -1)
        vendosVleraDefaultKlasaArtikullit();

    else if (RaportiEmerReal == "dokumentaKonvertuar") {
        vendosVleraDefaultStatusKonvertuar();
    }
    else if (RaportiEmerReal == "artikujShiturDegeAdm") {
...
function onInitDetajuar() {
    if (RaportiEmerReal == "buxhetimeSipasUrdherPagesave" || RaportiEmerReal == "buxhetimiSipasShpenzimeve" || RaportiEmerReal == "artikujShiturDegeAdm")
        cbDetajuar.SetChecked(true);
}
