(function ($) {
    ...
    $.widget("custom.imblist", {
        ...
        _krijoMenu: function (selektorMenu) {
            ...
            var kerkoInput = $("<input/>", { type: "text", placeholder: (pageState.idGjuha == 0 ? "Kerko" : "Search"), class: "form-control input-sm imb-liste-kerko" });
            var kerkoButton = $("<button></button>", { type: "button", class: "btn btn-default btn-sm" }).append($("<span></span>", { class: "glyphicon glyphicon-search" }));
