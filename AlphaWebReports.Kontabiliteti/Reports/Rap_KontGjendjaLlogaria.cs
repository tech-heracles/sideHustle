...
{
    public partial class Rap_KontGjendjaLlogaria : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_KontGjendjaLlogaria(){InitializeComponent();} 
        ...
        public Rap_KontGjendjaLlogaria(ParametraRaporti param, XtraReport report):
        ...
        public Rap_KontGjendjaLlogaria(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti,string scopeID, DevExpress.XtraReports.UI.XtraReport raport)
        {
        ...
        private void Rap_KontGjendjaLlogaria_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
