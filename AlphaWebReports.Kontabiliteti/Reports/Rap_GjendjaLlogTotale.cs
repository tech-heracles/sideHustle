...
{
    public partial class Rap_GjendjaLlogTotale : DevExpress.XtraReports.UI.XtraReport,   IUpdateDetail
    {
		public Rap_GjendjaLlogTotale(){InitializeComponent();} 
        ...
        public Rap_GjendjaLlogTotale(CultureInfo ci, int idNdermarrje, int idPerdoruesi, String guidString, int idRaporti, int idGjuha, String vjen, int idViti, int idSubRaporti, string scopeID, DevExpress.XtraReports.UI.XtraReport raport)
        {
            ...
            xrLabel39.Text = raport.Parameters[12].Description;
        ...
        private void xrLabel5_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            else
            {
                ...
                label.Target = "_self"; label.NavigateUrl = "javascript:window.ASPxCallbackPanel1.PerformCallback('" + catid + ";Detail;gjendjaLlogarive;V')";
        ...
        private void xrLabel34_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            xrLabel34.NavigateUrl = "javascript:window.myFaqeCelje.hapFaqeNeTabTeRi('RaportiShpejte.aspx?scopeID=" + parametraRaporti.ScopeID + "&guidString=" + parametraRaporti.GuidString + "&idraporti=" + parametraRaporti.IdSubRaporti + "&filterNumerLlogarie=" + GetCurrentColumnValue("NRLLOGARI") + "&printo=0&Sesioni=true')";
                xrLabel34.Target = "_self";
        ...
        private void Rap_GjendjaLlogTotale_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
