...
namespace AlphaWebReports.Kontabiliteti.Reports
{
    public partial class Rap_KartelaLlogariveMeKunderparti : DevExpress.XtraReports.UI.XtraReport
    {
        public Rap_KartelaLlogariveMeKunderparti()
        {
         
        }

        public Rap_KartelaLlogariveMeKunderparti(AlphaWebReports.Common.ParametraRaporti param, XtraReport report) :
            this(param.Ci, param.IdNdermarrje, param.IdViti, param.IdPerdoruesi, report)
        {

        }

        public Rap_KartelaLlogariveMeKunderparti(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi, DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
        }
        ...
        private void EmrateLabelave(CultureInfo ci)
        {
            ...
            xrLabel17.Text = rm.GetString("RaportKartelaLlogariveMeKunderpartiTitulli", ci);
            FiltratLabel.Text = rm.GetString("FiltratEmertimi", ci); 
            xrTableCell7.Text = rm.GetString("labelNrRef", ci);
            xrTableCell10.Text = rm.GetString("labFilterDateRegjistrimielNrRef", ci);   
            xrTableCell8.Text = rm.GetString("labelRaportiLloji", ci);   
            xrTableCell11.Text = rm.GetString("labelRaportiDtDok", ci);  
            xrTableCell9.Text = rm.GetString("labelRaportiNrDok", ci);   
