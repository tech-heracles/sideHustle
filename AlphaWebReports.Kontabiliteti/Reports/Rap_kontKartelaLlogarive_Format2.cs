...
{
    public partial class Rap_kontKartelaLlogarive_Format2 : DevExpress.XtraReports.UI.XtraReport
    {
		public Rap_kontKartelaLlogarive_Format2(){InitializeComponent();} 
        ...
        public Rap_kontKartelaLlogarive_Format2(CultureInfo ci, int idNdermarrje, int idViti, int idPerdoruesi,string scopeID ,DevExpress.XtraReports.UI.XtraReport raport)
        {
            InitializeComponent();
            EmrateLabelave(ci);
...
private void GroupHeader1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        ...
        private void xrLabel36_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                xrLabel36.Text = String.Format("{0:#,#.00}", vleraProgresive);
                vleraProgresive = 0;
            }
           else 
                xrLabel36.Text = "0.00";
        ...
        private void xrLabel37_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (vleraProgresive < 0)
            {
                xrLabel37.Text = String.Format("{0:#,#.00}", Math.Abs(vleraProgresive));
                vleraProgresive = 0;
            }
        ...
        private void Rap_kontKartelaLlogarive_Format2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
